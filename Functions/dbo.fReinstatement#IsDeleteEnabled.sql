...
GO
CREATE FUNCTION [dbo].[fReinstatement#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fReinstatement#IsDeleteEnabled
...
select top (10)
   x.ReinstatementSID
  ,dbo.fReinstatement#IsDeleteEnabled(x.ReinstatementSID) IsDeleteEnabled
from
  dbo.Reinstatement x
order by
  newid()
	...
	begin
		...
		(
			...
			from
				dbo.Reinstatement x
			where
				x.ReinstatementSID = @ReinstatementSID
