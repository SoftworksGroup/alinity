...
GO
CREATE FUNCTION [sf].[fDataSourceApplicationPage#Check]
	(
	 @DataSourceApplicationPageSID int
	,@DataSourceSID                int
	,@ApplicationPageSID           int
	,@DataSourceApplicationPageXID varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : sf.fDataSourceApplicationPage#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'DataSourceApplicationPage','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
