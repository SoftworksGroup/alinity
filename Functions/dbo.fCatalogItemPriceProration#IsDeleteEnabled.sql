...
GO
CREATE FUNCTION [dbo].[fCatalogItemPriceProration#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fCatalogItemPriceProration#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fCatalogItemPriceProration#IsDeleteEnabled(x.CatalogItemPriceProrationSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.CatalogItemPriceProration x
			where
				x.CatalogItemPriceProrationSID = @CatalogItemPriceProrationSID
