...
CREATE FUNCTION [sf].[fApplicationReport#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fApplicationReport#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fApplicationReport#IsDeleteEnabled(x.ApplicationReportSID) IsDeleteEnabled
from
...
begin
	...
	begin
		...
		(
			select
				  count(x01.PersonDocSID)
				+ count(x02.ApplicationPageReportSID)
			from
				sf.ApplicationReport     x00
			left outer join
				  (select top (1) x.PersonDocSID, x.ApplicationReportSID from dbo.PersonDoc x where isnull(x.ApplicationReportSID, -1) = @ApplicationReportSID) x01 on x00.ApplicationReportSID =  x01.ApplicationReportSID
			left outer join
				  (select top (1) x.ApplicationPageReportSID, x.ApplicationReportSID from sf.ApplicationPageReport x where x.ApplicationReportSID = @ApplicationReportSID) x02 on x00.ApplicationReportSID =  x02.ApplicationReportSID
			where
				x00.ApplicationReportSID = @ApplicationReportSID
	...
	begin
		...
		(
			...
			from
				sf.ApplicationReport x
			where
				x.ApplicationReportSID = @ApplicationReportSID
