...
GO
CREATE FUNCTION [dbo].[fPersonGroupDoc#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fPersonGroupDoc#IsDeleteEnabled
...
select top (10)
   x.PersonGroupDocSID
  ,dbo.fPersonGroupDoc#IsDeleteEnabled(x.PersonGroupDocSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.PersonGroupDoc x
			where
				x.PersonGroupDocSID = @PersonGroupDocSID
