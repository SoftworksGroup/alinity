...
GO
CREATE FUNCTION [dbo].[fRegistrantRenewalResponse#Check]
	(
	 @RegistrantRenewalResponseSID int
	,@RegistrantRenewalSID         int
	,@FormOwnerSID                 int
	,@RegistrantRenewalResponseXID varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantRenewalResponse#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'dbo',N'RegistrantRenewalResponse','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
	...
	begin
		...
		(
			...
			where
				r.SchemaName = 'ext'
			and
				r.RoutineName = 'fRegistrantRenewalResponse#Check'
		)
		begin
		
			select @errorText = ext.fRegistrantRenewalResponse#Check
				(
				 @RegistrantRenewalResponseSID
				,@RegistrantRenewalSID
				,@FormOwnerSID
