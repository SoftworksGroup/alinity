...
CREATE FUNCTION [sf].[fApplicationEntity#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fApplicationEntity#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fApplicationEntity#IsDeleteEnabled(x.ApplicationEntitySID) IsDeleteEnabled
from
