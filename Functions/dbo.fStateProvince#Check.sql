...
GO
CREATE FUNCTION [dbo].[fStateProvince#Check]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fStateProvince#Check
...
begin
	...
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'dbo',N'StateProvince','ValueIsRequired.ISONumber') = @ON and @ISONumber is null
	begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'dbo',N'StateProvince','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
	...
	begin
		...
		(
			...
			where
				r.SchemaName = 'ext'
			and
				r.RoutineName = 'fStateProvince#Check'
		)
		begin
		
			select @errorText = ext.fStateProvince#Check
				(
				 @StateProvinceSID
				,@StateProvinceName
				,@StateProvinceCode
