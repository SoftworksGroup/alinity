...
GO
CREATE FUNCTION [stg].[fRegistrantExamProfile#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : stg.fRegistrantExamProfile#IsDeleteEnabled
...
select top (10)
  ...
  ,stg.fRegistrantExamProfile#IsDeleteEnabled(x.RegistrantExamProfileSID) IsDeleteEnabled
from
