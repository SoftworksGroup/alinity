...
GO
CREATE FUNCTION [sf].[fQueryCategory#Check]
	(
	 @QueryCategorySID   int
	,@QueryCategoryLabel nvarchar(35)
	,@QueryCategoryCode  varchar(30)
	,@DisplayOrder       int
	,@IsActive           bit
	,@IsDefault          bit
	,@QueryCategoryXID   varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : sf.fQueryCategory#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'QueryCategory','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
