...
CREATE FUNCTION [sf].[fPersonOtherName#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fPersonOtherName#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fPersonOtherName#IsDeleteEnabled(x.PersonOtherNameSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				sf.PersonOtherName x
			where
				x.PersonOtherNameSID = @PersonOtherNameSID
