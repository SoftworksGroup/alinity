...
GO
CREATE FUNCTION [dbo].[fRegistrationChangeStatus#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrationChangeStatus#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrationChangeStatus#IsDeleteEnabled(x.RegistrationChangeStatusSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.RegistrationChangeStatus x
			where
				x.RegistrationChangeStatusSID = @RegistrationChangeStatusSID
