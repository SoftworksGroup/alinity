...
GO
CREATE FUNCTION [dbo].[fRequirementStatus#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRequirementStatus#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRequirementStatus#IsDeleteEnabled(x.RequirementStatusSID) IsDeleteEnabled
from
