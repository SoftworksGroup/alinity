...
GO
CREATE FUNCTION [dbo].[fAuditTypeForm#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fAuditTypeForm#IsDeleteEnabled
...
select top (10)
   x.AuditTypeFormSID
  ,dbo.fAuditTypeForm#IsDeleteEnabled(x.AuditTypeFormSID) IsDeleteEnabled
from
  dbo.AuditTypeForm x
order by
  newid()
	...
	begin
		...
		(
			...
			from
				dbo.AuditTypeForm x
			where
				x.AuditTypeFormSID = @AuditTypeFormSID
