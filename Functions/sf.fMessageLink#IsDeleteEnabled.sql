...
CREATE FUNCTION [sf].[fMessageLink#IsDeleteEnabled]
	(
	@MessageLinkSID int
	)
returns bit
as
/*********************************************************************************************************************************
ScalarF : sf.fMessageLink#IsDeleteEnabled
...
select top (10)
   x.MessageLinkSID
  ,sf.fMessageLink#IsDeleteEnabled(x.MessageLinkSID) IsDeleteEnabled
from
  sf.MessageLink x
order by
  newid()
