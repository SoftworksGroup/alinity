...
CREATE FUNCTION [sf].[fExportFile#IsDeleteEnabled]
	(
	@ExportFileSID int
	)
returns bit
as
/*********************************************************************************************************************************
ScalarF : sf.fExportFile#IsDeleteEnabled
...
select top (10)
   x.ExportFileSID
  ,sf.fExportFile#IsDeleteEnabled(x.ExportFileSID) IsDeleteEnabled
from
  sf.ExportFile x
order by
  newid()
