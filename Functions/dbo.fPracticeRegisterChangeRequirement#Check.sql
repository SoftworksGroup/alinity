...
GO
CREATE FUNCTION [dbo].[fPracticeRegisterChangeRequirement#Check]
	(
	...
	,@PracticeRegisterChangeRequirementXID varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fPracticeRegisterChangeRequirement#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'dbo',N'PracticeRegisterChangeRequirement','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
	...
	begin
		...
		(
			...
			where
				r.SchemaName = 'ext'
			and
				r.RoutineName = 'fPracticeRegisterChangeRequirement#Check'
		)
		begin
		
			select @errorText = ext.fPracticeRegisterChangeRequirement#Check
				(
				 @PracticeRegisterChangeRequirementSID
				,@PracticeRegisterChangeSID
				,@RegistrationRequirementSID
