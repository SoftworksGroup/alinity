...
GO
CREATE FUNCTION [sf].[fMessageStatus#Check]
	(
	 @MessageStatusSID   int
	,@MessageStatusSCD   varchar(10)
	,@MessageStatusLabel nvarchar(35)
	,@IsClosedStatus     bit
	,@IsActive           bit
	,@IsDefault          bit
	,@MessageStatusXID   varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : sf.fMessageStatus#Check
...
------------------------------ ----------------------------------------------------------------------------------------------------
$AutoRules | Tim Edlund        MBR.SystemCodeFormat.MessageStatusSCD The "%1" must be uppercase and not contain spaces or any punct
...
begin
	...
	if @errorMessageSCD is null and @MessageStatusSCD is not null and (sf.fIsStringContentValid(@MessageStatusSCD, N'abcdefghijklmnopqrstuvwxyz0123456789:.+-') = @OFF
	or upper(@MessageStatusSCD) <> @MessageStatusSCD collate Latin1_General_CS_AI)										-- use case sensitive collation to check if uppercase
	begin
		set @errorMessageSCD    = 'MBR.SystemCodeFormat.MessageStatusSCD'
		set @columnNames        = N'MessageStatusSCD'
		set @defaultMessageText = N'The "%1" must be uppercase and not contain spaces or any punctuation other than periods.'
		set @arg1               = N'Message Status System Code'
	end
	--!</Rule>
	...
	begin
		...
		set @arg1               = N'message status'
	end
	--!</Rule>
	
	--!<Rule Author="?Template | Mar 2019" Updates="None">
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'MessageStatus','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
