...
GO
CREATE FUNCTION [sf].[fApplicationPageReport#Check]
	(
	 @ApplicationPageReportSID int
	,@ApplicationPageSID       int
	,@ApplicationReportSID     int
	,@ApplicationPageReportXID varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : sf.fApplicationPageReport#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'ApplicationPageReport','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
