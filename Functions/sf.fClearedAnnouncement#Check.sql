...
GO
CREATE FUNCTION [sf].[fClearedAnnouncement#Check]
	(
	 @ClearedAnnouncementSID int
	,@AnnouncementSID        int
	,@ApplicationUserSID     int
	,@ClearedAnnouncementXID varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : sf.fClearedAnnouncement#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'ClearedAnnouncement','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
