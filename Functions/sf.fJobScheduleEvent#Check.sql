...
GO
CREATE FUNCTION [sf].[fJobScheduleEvent#Check]
	(
	 @JobScheduleEventSID int
	,@EventName           nvarchar(35)
	,@JobScheduleEventXID varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : sf.fJobScheduleEvent#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'JobScheduleEvent','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
