...
GO
CREATE FUNCTION [dbo].[fAgeRangeType#Check]
	(
	 @AgeRangeTypeSID    int
	,@AgeRangeTypeLabel  nvarchar(35)
	,@AgeRangeTypeCode   varchar(15)
	,@IsDefault          bit
	,@AgeRangeTypeXID    varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fAgeRangeType#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'dbo',N'AgeRangeType','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
	...
	begin
		...
		(
			...
			where
				r.SchemaName = 'ext'
			and
				r.RoutineName = 'fAgeRangeType#Check'
		)
		begin
		
			select @errorText = ext.fAgeRangeType#Check
				(
				 @AgeRangeTypeSID
				,@AgeRangeTypeLabel
				,@AgeRangeTypeCode
