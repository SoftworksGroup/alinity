...
GO
CREATE FUNCTION [sf].[fAnnouncementApplicationGrant#Check]
	(
	 @AnnouncementApplicationGrantSID int
	,@AnnouncementSID                 int
	,@ApplicationGrantSID             int
	,@AnnouncementApplicationGrantXID varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : sf.fAnnouncementApplicationGrant#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'AnnouncementApplicationGrant','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
