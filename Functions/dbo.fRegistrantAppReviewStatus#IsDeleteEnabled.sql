...
GO
CREATE FUNCTION [dbo].[fRegistrantAppReviewStatus#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantAppReviewStatus#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrantAppReviewStatus#IsDeleteEnabled(x.RegistrantAppReviewStatusSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.RegistrantAppReviewStatus x
			where
				x.RegistrantAppReviewStatusSID = @RegistrantAppReviewStatusSID
