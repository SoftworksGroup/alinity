...
GO
CREATE FUNCTION [dbo].[fRegistrationScheduleYear#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrationScheduleYear#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrationScheduleYear#IsDeleteEnabled(x.RegistrationScheduleYearSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.RegistrationScheduleYear x
			where
				x.RegistrationScheduleYearSID = @RegistrationScheduleYearSID
