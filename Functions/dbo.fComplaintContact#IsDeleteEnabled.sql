...
GO
CREATE FUNCTION [dbo].[fComplaintContact#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fComplaintContact#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fComplaintContact#IsDeleteEnabled(x.ComplaintContactSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.ComplaintContact x
			where
				x.ComplaintContactSID = @ComplaintContactSID
