...
GO
CREATE FUNCTION [sf].[fTextTemplate#Check]
	(
	 @TextTemplateSID           int
	,@TextTemplateLabel         nvarchar(35)
	,@PriorityLevel             tinyint
	,@Body                      nvarchar(1600)
	,@IsApplicationUserRequired bit
	,@LinkExpiryHours           int
	,@ApplicationEntitySID      int
	,@TextTemplateXID           varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : sf.fTextTemplate#Check
...
begin
	...
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'sf',N'TextTemplate','ValueIsRequired.ApplicationEntitySID') = @ON and @ApplicationEntitySID is null
	begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'TextTemplate','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
