...
GO
CREATE FUNCTION [dbo].[fRegistrantAudit#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantAudit#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrantAudit#IsDeleteEnabled(x.RegistrantAuditSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.RegistrantAudit x
			where
				x.RegistrantAuditSID = @RegistrantAuditSID			) <> sf.fApplicationUserSession#UserName() set @isDeleteEnabled = sf.fIsGranted('ADMIN.BASE')
