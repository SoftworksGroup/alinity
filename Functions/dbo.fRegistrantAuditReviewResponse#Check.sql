...
GO
CREATE FUNCTION [dbo].[fRegistrantAuditReviewResponse#Check]
	(
	 @RegistrantAuditReviewResponseSID int
	,@RegistrantAuditReviewSID         int
	,@FormOwnerSID                     int
	,@RegistrantAuditReviewResponseXID varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantAuditReviewResponse#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'dbo',N'RegistrantAuditReviewResponse','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
	...
	begin
		...
		(
			...
			where
				r.SchemaName = 'ext'
			and
				r.RoutineName = 'fRegistrantAuditReviewResponse#Check'
		)
		begin
		
			select @errorText = ext.fRegistrantAuditReviewResponse#Check
				(
				 @RegistrantAuditReviewResponseSID
				,@RegistrantAuditReviewSID
				,@FormOwnerSID
