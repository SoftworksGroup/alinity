...
GO
CREATE FUNCTION [dbo].[fPracticeRegisterForm#Check]
	(
	 @PracticeRegisterFormSID int
	,@PracticeRegisterSID     int
	,@FormSID                 int
	,@PracticeRegisterFormXID varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fPracticeRegisterForm#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'dbo',N'PracticeRegisterForm','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
	...
	begin
		...
		(
			...
			where
				r.SchemaName = 'ext'
			and
				r.RoutineName = 'fPracticeRegisterForm#Check'
		)
		begin
		
			select @errorText = ext.fPracticeRegisterForm#Check
				(
				 @PracticeRegisterFormSID
				,@PracticeRegisterSID
				,@FormSID
