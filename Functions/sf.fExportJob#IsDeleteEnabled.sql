...
CREATE FUNCTION [sf].[fExportJob#IsDeleteEnabled]
	(
	@ExportJobSID int
	)
returns bit
as
/*********************************************************************************************************************************
ScalarF : sf.fExportJob#IsDeleteEnabled
...
select top (10)
   x.ExportJobSID
  ,sf.fExportJob#IsDeleteEnabled(x.ExportJobSID) IsDeleteEnabled
from
  sf.ExportJob x
order by
  newid()
