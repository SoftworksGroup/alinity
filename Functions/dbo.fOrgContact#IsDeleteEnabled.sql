...
GO
CREATE FUNCTION [dbo].[fOrgContact#IsDeleteEnabled]
	(
	@OrgContactSID int
	)
returns bit
as
/*********************************************************************************************************************************
ScalarF : dbo.fOrgContact#IsDeleteEnabled
...
select top (10)
   x.OrgContactSID
  ,dbo.fOrgContact#IsDeleteEnabled(x.OrgContactSID) IsDeleteEnabled
from
  dbo.OrgContact x
order by
  newid()
