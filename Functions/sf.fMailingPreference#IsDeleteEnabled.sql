...
CREATE FUNCTION [sf].[fMailingPreference#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fMailingPreference#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fMailingPreference#IsDeleteEnabled(x.MailingPreferenceSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				sf.MailingPreference x
			where
				x.MailingPreferenceSID = @MailingPreferenceSID
