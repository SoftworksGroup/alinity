...
GO
CREATE FUNCTION [sf].[fEmailMessageAttachment#Check]
	(
	 @EmailMessageAttachmentSID int
	,@EmailMessageSID           int
	,@DocumentTitle             nvarchar(75)
	,@FileTypeSID               int
	,@FileTypeSCD               varchar(8)
	,@EmailMessageAttachmentXID varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : sf.fEmailMessageAttachment#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'EmailMessageAttachment','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
