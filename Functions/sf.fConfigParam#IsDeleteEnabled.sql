...
CREATE FUNCTION [sf].[fConfigParam#IsDeleteEnabled]
	(
	@ConfigParamSID int
	)
returns bit
as
/*********************************************************************************************************************************
ScalarF : sf.fConfigParam#IsDeleteEnabled
...
select top (10)
   x.ConfigParamSID
  ,sf.fConfigParam#IsDeleteEnabled(x.ConfigParamSID) IsDeleteEnabled
from
  sf.ConfigParam x
order by
  newid()
