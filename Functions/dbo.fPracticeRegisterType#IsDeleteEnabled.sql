...
GO
CREATE FUNCTION [dbo].[fPracticeRegisterType#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fPracticeRegisterType#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fPracticeRegisterType#IsDeleteEnabled(x.PracticeRegisterTypeSID) IsDeleteEnabled
from
