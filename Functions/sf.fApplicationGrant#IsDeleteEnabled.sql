...
CREATE FUNCTION [sf].[fApplicationGrant#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fApplicationGrant#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fApplicationGrant#IsDeleteEnabled(x.ApplicationGrantSID) IsDeleteEnabled
from
