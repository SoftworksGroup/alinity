...
GO
CREATE FUNCTION [sf].[fEmailSender#Check]
	(
	 @EmailSenderSID     int
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'EmailSender','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
