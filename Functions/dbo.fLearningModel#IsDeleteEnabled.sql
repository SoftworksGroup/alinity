...
GO
CREATE FUNCTION [dbo].[fLearningModel#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fLearningModel#IsDeleteEnabled
...
select top (10)
   x.LearningModelSID
  ,dbo.fLearningModel#IsDeleteEnabled(x.LearningModelSID) IsDeleteEnabled
from
  dbo.LearningModel x
order by
  newid()
