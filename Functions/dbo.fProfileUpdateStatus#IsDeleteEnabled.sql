...
GO
CREATE FUNCTION [dbo].[fProfileUpdateStatus#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fProfileUpdateStatus#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fProfileUpdateStatus#IsDeleteEnabled(x.ProfileUpdateStatusSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.ProfileUpdateStatus x
			where
				x.ProfileUpdateStatusSID = @ProfileUpdateStatusSID
