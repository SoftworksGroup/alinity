...
GO
CREATE FUNCTION [dbo].[fCatalogItemPrice#Check]
	(
	 @CatalogItemPriceSID int
	,@CatalogItemSID      int
	,@Price               decimal(11,2)
	,@EffectiveTime       datetime
	,@CatalogItemPriceXID varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fCatalogItemPrice#Check
...
begin
	...
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'dbo',N'CatalogItemPrice','BackDatingLimit.EffectiveTime') = @ON
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'dbo',N'CatalogItemPrice','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
	...
	begin
		...
		(
			...
			where
				r.SchemaName = 'ext'
			and
				r.RoutineName = 'fCatalogItemPrice#Check'
		)
		begin
		
			select @errorText = ext.fCatalogItemPrice#Check
				(
				 @CatalogItemPriceSID
				,@CatalogItemSID
				,@Price
