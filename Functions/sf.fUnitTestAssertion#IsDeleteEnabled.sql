...
CREATE FUNCTION [sf].[fUnitTestAssertion#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fUnitTestAssertion#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fUnitTestAssertion#IsDeleteEnabled(x.UnitTestAssertionSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				sf.UnitTestAssertion x
			where
				x.UnitTestAssertionSID = @UnitTestAssertionSID
