...
GO
CREATE FUNCTION [dbo].[fRegistrantLearningPlanResponse#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantLearningPlanResponse#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrantLearningPlanResponse#IsDeleteEnabled(x.RegistrantLearningPlanResponseSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.RegistrantLearningPlanResponse x
			where
				x.RegistrantLearningPlanResponseSID = @RegistrantLearningPlanResponseSID
