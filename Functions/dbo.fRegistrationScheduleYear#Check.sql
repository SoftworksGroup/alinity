...
GO
CREATE FUNCTION [dbo].[fRegistrationScheduleYear#Check]
	(
	 @RegistrationScheduleYearSID       int
	,@RegistrationScheduleSID           int
	,@RegistrationYear                  smallint
	,@YearStartTime                     datetime
	,@YearEndTime                       datetime
	,@RenewalVerificationOpenTime       datetime
	,@RenewalGeneralOpenTime            datetime
	,@RenewalLateFeeStartTime           datetime
	,@RenewalEndTime                    datetime
	,@ReinstatementVerificationOpenTime datetime
	,@ReinstatementGeneralOpenTime      datetime
	,@ReinstatementEndTime              datetime
	,@CECollectionStartTime             datetime
	,@CECollectionEndTime               datetime
	,@PAPBlockStartTime                 datetime
	,@PAPBlockEndTime                   datetime
	,@RegistrationScheduleYearXID       varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrationScheduleYear#Check
...
Tim Edlund | Aug 2017          MBR.DateSequenceInvalid.RenewalVerificationOpenTime (see source for message text)
Tim Edlund | Sep 2017          MBR.DateSequenceInvalid.RenewalGeneralOpenTime (see source for message text)
Tim Edlund | Sep 2017          MBR.DateSequenceInvalid.RenewalLateFeeStart (see source for message text)
Tim Edlund | Aug 2017          MBR.DateSequenceInvalid.ReinstatementVerificationOpenTime (see source for message text)
Tim Edlund | Sep 2017          MBR.DateSequenceInvalid.ReinstatementLateFeeStart (see source for message text)
Tim Edlund | Oct 2017          MBR.RegistrationYear.RegistrationYear (see source for message text)
...
select
	...
	,dbo.fRegistrationScheduleYear#Check
		(
		 RegistrationScheduleYearSID
...
begin
	...
	--!<Rule Author="Tim Edlund | Aug 2017" Updates="None">
	if @errorMessageSCD is null and @RenewalVerificationOpenTime > @RenewalGeneralOpenTime
	begin
		set @errorMessageSCD    = 'MBR.DateSequenceInvalid.RenewalVerificationOpenTime'
		set @columnNames        = N'RenewalVerificationOpenTime,RenewalGeneralOpenTime'
		set @defaultMessageText = N'The "%1" must be before the "%2".'
		set @arg1               = N'Renewal Verification Start'
		set @arg2               = N'Renewal General Start'
	end
	--!</Rule>
	
	--!<Rule Author="Tim Edlund | Sep 2017" Updates="None">
	if @errorMessageSCD is null and @RenewalGeneralOpenTime > @RenewalLateFeeStartTime
	begin
		set @errorMessageSCD    = 'MBR.DateSequenceInvalid.RenewalGeneralOpenTime'
		set @columnNames        = N'RenewalGeneralOpenTime,RenewalLateFeeStartTime'
		set @defaultMessageText = N'The "%1" must be before the "%2".'
		set @arg1               = N'Renewal General Start'
		set @arg2               = N'Renewal Late Fee Start'
	end
	--!</Rule>
	
	--!<Rule Author="Tim Edlund | Sep 2017" Updates="None">
	if @errorMessageSCD is null and @RenewalLateFeeStartTime > @RenewalEndTime
	begin
		set @errorMessageSCD    = 'MBR.DateSequenceInvalid.RenewalLateFeeStart'
		set @columnNames        = N'RenewalLateFeeStartTime,RenewalEndTime'
		set @defaultMessageText = N'The "%1" must be before the "%2".'
		set @arg1               = N'Renewal Late Fee Start'
		set @arg2               = N'Renewal End'
	end
	--!</Rule>
	
	--!<Rule Author="Tim Edlund | Aug 2017" Updates="None">
	if @errorMessageSCD is null and @ReinstatementVerificationOpenTime > @ReinstatementGeneralOpenTime
	begin
		set @errorMessageSCD    = 'MBR.DateSequenceInvalid.ReinstatementVerificationOpenTime'
		set @columnNames        = N'ReinstatementVerificationOpenTime,ReinstatementGeneralOpenTime'
		set @defaultMessageText = N'The "%1" must be before the "%2".'
		set @arg1               = N'Reinstatement Verification Start'
		set @arg2               = N'Reinstatement General Start'
	end
	--!</Rule>
	
	--!<Rule Author="Tim Edlund | Sep 2017" Updates="None">
	if @errorMessageSCD is null and @ReinstatementGeneralOpenTime > @ReinstatementEndTime
	begin
		set @errorMessageSCD    = 'MBR.DateSequenceInvalid.ReinstatementLateFeeStart'
		set @columnNames = N'ReinstatementGeneralOpenTime,ReinstatementEndTime'
		set @defaultMessageText = N'The "%1" must be before the "%2".'
		set @arg1               = N'Reinstatement General Start'
		set @arg2               = N'Reinstatement End'
	end
	--!</Rule>
	
	--!<Rule Author="Tim Edlund | Oct 2017" Updates="None">
	if @errorMessageSCD is null and cast(year(@YearEndTime) as smallint) <> @RegistrationYear
	begin
		set @errorMessageSCD      = 'MBR.RegistrationYear.RegistrationYear'
		set @columnNames          = N'RegistrationYear'
		set @defaultMessageText   = N'The registration year must be set to the year in the year ENDING date.'
	end
	--!</Rule>
	
	--!<Rule Author="?Template | Mar 2019" Updates="None">
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'dbo',N'RegistrationScheduleYear','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
	...
	begin
		...
		(
			...
			where
				r.SchemaName = 'ext'
			and
				r.RoutineName = 'fRegistrationScheduleYear#Check'
		)
		begin
		
			select @errorText = ext.fRegistrationScheduleYear#Check
				(
				 @RegistrationScheduleYearSID
				,@RegistrationScheduleSID
				,@RegistrationYear
