...
GO
CREATE FUNCTION [dbo].[fRecommendationGroup#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRecommendationGroup#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRecommendationGroup#IsDeleteEnabled(x.RecommendationGroupSID) IsDeleteEnabled
from
