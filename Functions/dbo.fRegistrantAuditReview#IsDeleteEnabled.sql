...
GO
CREATE FUNCTION [dbo].[fRegistrantAuditReview#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantAuditReview#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrantAuditReview#IsDeleteEnabled(x.RegistrantAuditReviewSID) IsDeleteEnabled
from
