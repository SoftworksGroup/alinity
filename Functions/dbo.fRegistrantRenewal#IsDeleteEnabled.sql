...
GO
CREATE FUNCTION [dbo].[fRegistrantRenewal#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantRenewal#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrantRenewal#IsDeleteEnabled(x.RegistrantRenewalSID) IsDeleteEnabled
from
