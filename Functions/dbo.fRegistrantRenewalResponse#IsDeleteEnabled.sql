...
GO
CREATE FUNCTION [dbo].[fRegistrantRenewalResponse#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantRenewalResponse#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrantRenewalResponse#IsDeleteEnabled(x.RegistrantRenewalResponseSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.RegistrantRenewalResponse x
			where
				x.RegistrantRenewalResponseSID = @RegistrantRenewalResponseSID
