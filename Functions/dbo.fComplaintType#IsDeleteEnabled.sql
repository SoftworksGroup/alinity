...
GO
CREATE FUNCTION [dbo].[fComplaintType#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fComplaintType#IsDeleteEnabled
...
select top (10)
   x.ComplaintTypeSID
  ,dbo.fComplaintType#IsDeleteEnabled(x.ComplaintTypeSID) IsDeleteEnabled
from
  dbo.ComplaintType x
order by
  newid()
...
begin
	...
	if (select x.IsDefault from dbo.ComplaintType x where x.ComplaintTypeSID = @ComplaintTypeSID) = @ON set @isDeleteEnabled = @OFF	-- default records cannot be deleted
	...
	begin
		...
		(
			...
			from
				dbo.ComplaintType x00
			left outer join
				  (select top (1) x.ComplaintSID, x.ComplaintTypeSID from dbo.Complaint x where x.ComplaintTypeSID = @ComplaintTypeSID) x01 on x00.ComplaintTypeSID =  x01.ComplaintTypeSID
			where
				x00.ComplaintTypeSID = @ComplaintTypeSID
	...
	begin
		...
		(
			...
			from
				dbo.ComplaintType x
			where
				x.ComplaintTypeSID = @ComplaintTypeSID
