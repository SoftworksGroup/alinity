...
GO
CREATE FUNCTION [sf].[fEmailTemplate#Check]
	(
	 @EmailTemplateSID          int
	,@EmailTemplateLabel        nvarchar(35)
...
as
/*********************************************************************************************************************************
ScalarF : sf.fEmailTemplate#Check
...
begin
	...
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'sf',N'EmailTemplate','ValueIsRequired.ApplicationEntitySID') = @ON and @ApplicationEntitySID is null
	begin
	...
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'sf',N'EmailTemplate','ValueIsRequired.ApplicationGrantSID') = @ON and @ApplicationGrantSID is null
	begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'EmailTemplate','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
