...
CREATE FUNCTION [sf].[fCrossWalkPair#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fCrossWalkPair#IsDeleteEnabled
...
select top (10)
   x.CrossWalkPairSID
  ,sf.fCrossWalkPair#IsDeleteEnabled(x.CrossWalkPairSID) IsDeleteEnabled
from
  sf.CrossWalkPair x
order by
  newid()
	...
	begin
		...
		(
			...
			from
				sf.CrossWalkPair x
			where
				x.CrossWalkPairSID = @CrossWalkPairSID
