...
GO
CREATE FUNCTION [dbo].[fRegistrationRequirement#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrationRequirement#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrationRequirement#IsDeleteEnabled(x.RegistrationRequirementSID) IsDeleteEnabled
from
...
begin
	...
	begin
		...
		(
			select
				  count(x01.PracticeRegisterChangeRequirementSID)
				+ count(x02.RegistrationChangeRequirementSID)
			from
				dbo.RegistrationRequirement           x00
			left outer join
				  (select top (1) x.PracticeRegisterChangeRequirementSID, x.RegistrationRequirementSID from dbo.PracticeRegisterChangeRequirement x where x.RegistrationRequirementSID = @RegistrationRequirementSID) x01 on x00.RegistrationRequirementSID =  x01.RegistrationRequirementSID
			left outer join
				  (select top (1) x.RegistrationChangeRequirementSID, x.RegistrationRequirementSID from dbo.RegistrationChangeRequirement x where x.RegistrationRequirementSID = @RegistrationRequirementSID) x02 on x00.RegistrationRequirementSID =  x02.RegistrationRequirementSID
			where
				x00.RegistrationRequirementSID = @RegistrationRequirementSID
	...
	begin
		...
		(
			...
			from
				dbo.RegistrationRequirement x
			where
				x.RegistrationRequirementSID = @RegistrationRequirementSID
