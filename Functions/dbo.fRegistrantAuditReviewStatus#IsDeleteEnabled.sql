...
GO
CREATE FUNCTION [dbo].[fRegistrantAuditReviewStatus#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantAuditReviewStatus#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrantAuditReviewStatus#IsDeleteEnabled(x.RegistrantAuditReviewStatusSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.RegistrantAuditReviewStatus x
			where
				x.RegistrantAuditReviewStatusSID = @RegistrantAuditReviewStatusSID
