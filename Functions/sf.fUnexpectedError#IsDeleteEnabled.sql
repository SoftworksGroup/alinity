...
CREATE FUNCTION [sf].[fUnexpectedError#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fUnexpectedError#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fUnexpectedError#IsDeleteEnabled(x.UnexpectedErrorSID) IsDeleteEnabled
from
