...
GO
CREATE FUNCTION [sf].[fMessage#Check]
	(
	 @MessageSID            int
	,@MessageSCD            varchar(128)
	,@MessageName           nvarchar(100)
	,@MessageText           nvarchar(1000)
	,@MessageTextUpdateTime datetimeoffset(7)
	,@DefaultText           nvarchar(1000)
	,@DefaultTextUpdateTime datetimeoffset(7)
	,@MessageXID            varchar(150)
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'Message','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
