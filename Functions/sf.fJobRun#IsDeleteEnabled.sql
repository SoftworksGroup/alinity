...
CREATE FUNCTION [sf].[fJobRun#IsDeleteEnabled]
	(
	@JobRunSID int
	)
returns bit
as
/*********************************************************************************************************************************
ScalarF : sf.fJobRun#IsDeleteEnabled
...
select top (10)
   x.JobRunSID
  ,sf.fJobRun#IsDeleteEnabled(x.JobRunSID) IsDeleteEnabled
from
  sf.JobRun x
order by
  newid()
