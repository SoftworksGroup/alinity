...
CREATE FUNCTION [sf].[fApplicationPageReport#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fApplicationPageReport#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fApplicationPageReport#IsDeleteEnabled(x.ApplicationPageReportSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				sf.ApplicationPageReport x
			where
				x.ApplicationPageReportSID = @ApplicationPageReportSID
