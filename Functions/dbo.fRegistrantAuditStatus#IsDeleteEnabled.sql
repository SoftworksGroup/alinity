...
GO
CREATE FUNCTION [dbo].[fRegistrantAuditStatus#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantAuditStatus#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrantAuditStatus#IsDeleteEnabled(x.RegistrantAuditStatusSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.RegistrantAuditStatus x
			where
				x.RegistrantAuditStatusSID = @RegistrantAuditStatusSID
