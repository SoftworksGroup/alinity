...
GO
CREATE FUNCTION [dbo].[fRegistrantAppReview#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantAppReview#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrantAppReview#IsDeleteEnabled(x.RegistrantAppReviewSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.RegistrantAppReview x
			where
				x.RegistrantAppReviewSID = @RegistrantAppReviewSID
