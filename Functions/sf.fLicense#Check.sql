...
GO
CREATE FUNCTION [sf].[fLicense#Check]
	(
	 @LicenseSID         int
	,@LicenseXID         varchar(150)
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'License','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
