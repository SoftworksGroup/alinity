...
GO
CREATE FUNCTION [sf].[fUnitType#Check]
	(
	 @UnitTypeSID        int
	,@UnitTypeLabel      nvarchar(35)
	,@IsDefault          bit
	,@IsActive           bit
	,@UnitTypeXID        varchar(150)
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'UnitType','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
