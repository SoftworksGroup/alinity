...
CREATE FUNCTION [sf].[fAltLanguage#IsDeleteEnabled]
	(
	@AltLanguageSID int
	)
returns bit
as
/*********************************************************************************************************************************
ScalarF : sf.fAltLanguage#IsDeleteEnabled
...
select top (10)
   x.AltLanguageSID
  ,sf.fAltLanguage#IsDeleteEnabled(x.AltLanguageSID) IsDeleteEnabled
from
  sf.AltLanguage x
order by
  newid()
	...
	begin
		...
		(
			...
			from
				sf.AltLanguage x
			where
				x.AltLanguageSID = @AltLanguageSID
