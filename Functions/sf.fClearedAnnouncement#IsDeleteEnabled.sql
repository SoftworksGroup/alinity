...
CREATE FUNCTION [sf].[fClearedAnnouncement#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fClearedAnnouncement#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fClearedAnnouncement#IsDeleteEnabled(x.ClearedAnnouncementSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				sf.ClearedAnnouncement x
			where
				x.ClearedAnnouncementSID = @ClearedAnnouncementSID
