...
GO
CREATE FUNCTION [dbo].[fPracticeRegisterCatalogItem#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fPracticeRegisterCatalogItem#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fPracticeRegisterCatalogItem#IsDeleteEnabled(x.PracticeRegisterCatalogItemSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.PracticeRegisterCatalogItem x
			where
				x.PracticeRegisterCatalogItemSID = @PracticeRegisterCatalogItemSID
