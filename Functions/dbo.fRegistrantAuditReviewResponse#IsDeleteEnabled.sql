...
GO
CREATE FUNCTION [dbo].[fRegistrantAuditReviewResponse#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantAuditReviewResponse#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrantAuditReviewResponse#IsDeleteEnabled(x.RegistrantAuditReviewResponseSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.RegistrantAuditReviewResponse x
			where
				x.RegistrantAuditReviewResponseSID = @RegistrantAuditReviewResponseSID
