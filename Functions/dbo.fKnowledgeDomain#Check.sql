...
GO
CREATE FUNCTION [dbo].[fKnowledgeDomain#Check]
	(
	 @KnowledgeDomainSID   int
	,@KnowledgeDomainLabel nvarchar(35)
	,@IsDefault            bit
	,@IsActive             bit
	,@KnowledgeDomainXID   varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fKnowledgeDomain#Check
...
begin
	...
	begin
		...
		set @arg1               = N'knowledge domain'
	end
	--!</Rule>
	
	--!<Rule Author="?Template | Mar 2019" Updates="None">
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'dbo',N'KnowledgeDomain','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
	...
	begin
		...
		(
			...
			where
				r.SchemaName = 'ext'
			and
				r.RoutineName = 'fKnowledgeDomain#Check'
		)
		begin
		
			select @errorText = ext.fKnowledgeDomain#Check
				(
				 @KnowledgeDomainSID
				,@KnowledgeDomainLabel
				,@IsDefault
