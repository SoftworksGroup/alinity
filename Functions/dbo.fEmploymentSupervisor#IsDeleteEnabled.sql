...
GO
CREATE FUNCTION [dbo].[fEmploymentSupervisor#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fEmploymentSupervisor#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fEmploymentSupervisor#IsDeleteEnabled(x.EmploymentSupervisorSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.EmploymentSupervisor x
			where
				x.EmploymentSupervisorSID = @EmploymentSupervisorSID
