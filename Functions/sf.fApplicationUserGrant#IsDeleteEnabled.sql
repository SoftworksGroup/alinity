...
CREATE FUNCTION [sf].[fApplicationUserGrant#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fApplicationUserGrant#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fApplicationUserGrant#IsDeleteEnabled(x.ApplicationUserGrantSID) IsDeleteEnabled
from
...
begin
	...
	--! <PostCheck>
	-- Tim Edlund | Apr 2015
	-- Always block if there are audit records for the user, otherwise
	...
	(
		...
		join
			sf.ApplicationUserSession aus		on aug.ApplicationUserSID = aus.ApplicationUserSID
		join
			sf.RecordAudit						ra		on aus.ApplicationUserSessionSID = ra.ApplicationUserSessionSID
		where
