...
GO
CREATE FUNCTION [sf].[fApplicationPage#Check]
	(
	 @ApplicationPageSID   int
	,@ApplicationPageLabel nvarchar(35)
	,@ApplicationPageURI   varchar(150)
	,@ApplicationRoute     varchar(150)
	,@IsSearchPage         bit
	,@ApplicationEntitySID int
	,@ApplicationPageXID   varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : sf.fApplicationPage#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'ApplicationPage','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
