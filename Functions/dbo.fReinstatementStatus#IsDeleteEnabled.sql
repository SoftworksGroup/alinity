...
GO
CREATE FUNCTION [dbo].[fReinstatementStatus#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fReinstatementStatus#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fReinstatementStatus#IsDeleteEnabled(x.ReinstatementStatusSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.ReinstatementStatus x
			where
				x.ReinstatementStatusSID = @ReinstatementStatusSID
