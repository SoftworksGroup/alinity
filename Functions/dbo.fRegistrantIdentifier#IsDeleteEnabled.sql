...
GO
CREATE FUNCTION [dbo].[fRegistrantIdentifier#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantIdentifier#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrantIdentifier#IsDeleteEnabled(x.RegistrantIdentifierSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.RegistrantIdentifier x
			where
				x.RegistrantIdentifierSID = @RegistrantIdentifierSID
