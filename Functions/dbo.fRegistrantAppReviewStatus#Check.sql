...
GO
CREATE FUNCTION [dbo].[fRegistrantAppReviewStatus#Check]
	(
	 @RegistrantAppReviewStatusSID int
	,@RegistrantAppReviewSID       int
	,@FormStatusSID                int
	,@RegistrantAppReviewStatusXID varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantAppReviewStatus#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'dbo',N'RegistrantAppReviewStatus','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
	...
	begin
		...
		(
			...
			where
				r.SchemaName = 'ext'
			and
				r.RoutineName = 'fRegistrantAppReviewStatus#Check'
		)
		begin
		
			select @errorText = ext.fRegistrantAppReviewStatus#Check
				(
				 @RegistrantAppReviewStatusSID
				,@RegistrantAppReviewSID
				,@FormStatusSID
