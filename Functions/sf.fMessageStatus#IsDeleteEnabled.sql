...
CREATE FUNCTION [sf].[fMessageStatus#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fMessageStatus#IsDeleteEnabled
...
select top (10)
   x.MessageStatusSID
  ,sf.fMessageStatus#IsDeleteEnabled(x.MessageStatusSID) IsDeleteEnabled
from
  sf.MessageStatus x
order by
  newid()
