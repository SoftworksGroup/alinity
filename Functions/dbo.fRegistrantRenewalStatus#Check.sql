...
GO
CREATE FUNCTION [dbo].[fRegistrantRenewalStatus#Check]
	(
	 @RegistrantRenewalStatusSID int
	,@RegistrantRenewalSID       int
	,@FormStatusSID              int
	,@RegistrantRenewalStatusXID varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantRenewalStatus#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'dbo',N'RegistrantRenewalStatus','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
	...
	begin
		...
		(
			...
			where
				r.SchemaName = 'ext'
			and
				r.RoutineName = 'fRegistrantRenewalStatus#Check'
		)
		begin
		
			select @errorText = ext.fRegistrantRenewalStatus#Check
				(
				 @RegistrantRenewalStatusSID
				,@RegistrantRenewalSID
				,@FormStatusSID
