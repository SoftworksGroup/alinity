...
GO
CREATE FUNCTION [dbo].[fComplaintProcessEvent#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fComplaintProcessEvent#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fComplaintProcessEvent#IsDeleteEnabled(x.ComplaintProcessEventSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.ComplaintProcessEvent x
			where
				x.ComplaintProcessEventSID = @ComplaintProcessEventSID
