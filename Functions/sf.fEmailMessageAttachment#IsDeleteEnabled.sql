...
CREATE FUNCTION [sf].[fEmailMessageAttachment#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fEmailMessageAttachment#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fEmailMessageAttachment#IsDeleteEnabled(x.EmailMessageAttachmentSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				sf.EmailMessageAttachment x
			where
				x.EmailMessageAttachmentSID = @EmailMessageAttachmentSID
