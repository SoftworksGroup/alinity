...
GO
CREATE FUNCTION [stg].[fRegistrantExamProfile#Check]
	(
	 @RegistrantExamProfileSID int
	,@ImportFileSID            int
	...
	,@ExamSID                  int
	,@ExamOfferingSID          int
	,@RegistrantExamProfileXID varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : stg.fRegistrantExamProfile#Check
...
$AutoRules | Tim Edlund        ValueIsRequired.ExamIdentifier A value for "%1" is required.
...
$AutoRules | Tim Edlund        ValueIsRequired.ExamSID A value for "%1" is required.
$AutoRules | Tim Edlund        ValueIsRequired.ExamTime A value for "%1" is required.
...
select
	...
	,FirstName
	,LastName
	,stg.fRegistrantExamProfile#Check
		(
		 RegistrantExamProfileSID
		,ImportFileSID
		,ProcessingStatusSID
...
begin
	...
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'stg',N'RegistrantExamProfile','ValueIsRequired.AssignedLocation') = @ON and @AssignedLocation is null
	begin
	...
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'stg',N'RegistrantExamProfile','ValueIsRequired.BirthDate') = @ON and @BirthDate is null
	begin
	...
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'stg',N'RegistrantExamProfile','ValueIsRequired.EmailAddress') = @ON and @EmailAddress is null
	begin
	...
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'stg',N'RegistrantExamProfile','ValueIsRequired.ExamDate') = @ON and @ExamDate is null
	begin
	...
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'stg',N'RegistrantExamProfile','ValueIsRequired.ExamIdentifier') = @ON and @ExamIdentifier is null
	begin
		set @errorMessageSCD    = 'ValueIsRequired.ExamIdentifier'
		set @columnNames        = N'ExamIdentifier'
		set @defaultMessageText = N'A value for "%1" is required.'
		set @arg1               = N'Exam Identifier'
	end
	--!</Rule>
	
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'stg',N'RegistrantExamProfile','ValueIsRequired.ExamOfferingSID') = @ON and @ExamOfferingSID is null
	begin
	...
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'stg',N'RegistrantExamProfile','ValueIsRequired.ExamReference') = @ON and @ExamReference is null
	begin
	...
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'stg',N'RegistrantExamProfile','ValueIsRequired.ExamResultDate') = @ON and @ExamResultDate is null
	begin
	...
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'stg',N'RegistrantExamProfile','ValueIsRequired.ExamSID') = @ON and @ExamSID is null
	begin
		set @errorMessageSCD    = 'ValueIsRequired.ExamSID'
		set @columnNames        = N'ExamSID'
		set @defaultMessageText = N'A value for "%1" is required.'
		set @arg1               = N'Exam'
	end
	--!</Rule>
	...
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'stg',N'RegistrantExamProfile','ValueIsRequired.ExamTime') = @ON and @ExamTime is null
	begin
		set @errorMessageSCD    = 'ValueIsRequired.ExamTime'
		set @columnNames        = N'ExamTime'
		set @defaultMessageText = N'A value for "%1" is required.'
		set @arg1               = N'Exam Time'
	end
	--!</Rule>
	
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'stg',N'RegistrantExamProfile','ValueIsRequired.FirstName') = @ON and @FirstName is null
	begin
	...
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'stg',N'RegistrantExamProfile','ValueIsRequired.LastName') = @ON and @LastName is null
	begin
	...
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'stg',N'RegistrantExamProfile','ValueIsRequired.OrgLabel') = @ON and @OrgLabel is null
	begin
	...
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'stg',N'RegistrantExamProfile','ValueIsRequired.OrgSID') = @ON and @OrgSID is null
	begin
	...
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'stg',N'RegistrantExamProfile','ValueIsRequired.PassingScore') = @ON and @PassingScore is null
	begin
	...
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'stg',N'RegistrantExamProfile','ValueIsRequired.PersonSID') = @ON and @PersonSID is null
	begin
	...
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'stg',N'RegistrantExamProfile','ValueIsRequired.RegistrantNo') = @ON and @RegistrantNo is null
	begin
	...
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'stg',N'RegistrantExamProfile','ValueIsRequired.RegistrantSID') = @ON and @RegistrantSID is null
	begin
	...
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'stg',N'RegistrantExamProfile','ValueIsRequired.Score') = @ON and @Score is null
	begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'stg',N'RegistrantExamProfile','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
	...
	begin
		...
		(
			...
			where
				r.SchemaName = 'ext'
			and
				r.RoutineName = 'stg#fRegistrantExamProfile#Check'
		)
		begin
		
			select @errorText = ext.stg#fRegistrantExamProfile#Check
				(
				 @RegistrantExamProfileSID
				,@ImportFileSID
				,@ProcessingStatusSID
