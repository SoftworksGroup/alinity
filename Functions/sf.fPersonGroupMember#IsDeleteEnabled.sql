...
CREATE FUNCTION [sf].[fPersonGroupMember#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fPersonGroupMember#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fPersonGroupMember#IsDeleteEnabled(x.PersonGroupMemberSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				sf.PersonGroupMember x
			where
				x.PersonGroupMemberSID = @PersonGroupMemberSID
