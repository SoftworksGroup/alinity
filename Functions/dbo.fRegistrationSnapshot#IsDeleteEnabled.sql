...
GO
CREATE FUNCTION [dbo].[fRegistrationSnapshot#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrationSnapshot#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrationSnapshot#IsDeleteEnabled(x.RegistrationSnapshotSID) IsDeleteEnabled
from
