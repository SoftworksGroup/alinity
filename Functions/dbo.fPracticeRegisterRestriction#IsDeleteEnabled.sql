...
GO
CREATE FUNCTION [dbo].[fPracticeRegisterRestriction#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fPracticeRegisterRestriction#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fPracticeRegisterRestriction#IsDeleteEnabled(x.PracticeRegisterRestrictionSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.PracticeRegisterRestriction x
			where
				x.PracticeRegisterRestrictionSID = @PracticeRegisterRestrictionSID
