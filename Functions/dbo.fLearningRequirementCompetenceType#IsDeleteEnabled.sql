...
GO
CREATE FUNCTION [dbo].[fLearningRequirementCompetenceType#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fLearningRequirementCompetenceType#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fLearningRequirementCompetenceType#IsDeleteEnabled(x.LearningRequirementCompetenceTypeSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.LearningRequirementCompetenceType x
			where
				x.LearningRequirementCompetenceTypeSID = @LearningRequirementCompetenceTypeSID
