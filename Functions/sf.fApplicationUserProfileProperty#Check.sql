...
GO
CREATE FUNCTION [sf].[fApplicationUserProfileProperty#Check]
	(
	 @ApplicationUserProfilePropertySID int
	,@ApplicationUserSID                int
	,@PropertyName                      varchar(100)
	,@ApplicationUserProfilePropertyXID varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : sf.fApplicationUserProfileProperty#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'ApplicationUserProfileProperty','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
