...
GO
CREATE FUNCTION [dbo].[fPracticeArea#Check]
	(
	 @PracticeAreaSID         int
	,@PracticeAreaName        nvarchar(50)
	,@PracticeAreaCode        varchar(20)
	,@PracticeAreaCategory    nvarchar(65)
	,@IsPracticeScopeRequired bit
	,@IsDefault               bit
	,@IsActive                bit
	,@PracticeAreaXID         varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fPracticeArea#Check
...
$AutoRules | Tim Edlund        ValueIsRequired.PracticeAreaCategory A value for "%1" is required.
...
begin
	...
	begin
		...
		set @arg1               = N'practice area'
	end
	--!</Rule>
	
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'dbo',N'PracticeArea','ValueIsRequired.PracticeAreaCategory') = @ON and @PracticeAreaCategory is null
	begin
		set @errorMessageSCD    = 'ValueIsRequired.PracticeAreaCategory'
		set @columnNames        = N'PracticeAreaCategory'
		set @defaultMessageText = N'A value for "%1" is required.'
		set @arg1               = N'Practice Area Category'
	end
	--!</Rule>
	
	--!<Rule Author="?Template | Mar 2019" Updates="None">
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'dbo',N'PracticeArea','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
	...
	begin
		...
		(
			...
			where
				r.SchemaName = 'ext'
			and
				r.RoutineName = 'fPracticeArea#Check'
		)
		begin
		
			select @errorText = ext.fPracticeArea#Check
				(
				 @PracticeAreaSID
				,@PracticeAreaName
				,@PracticeAreaCode
