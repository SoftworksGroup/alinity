...
GO
CREATE FUNCTION [stg].[fCredentialProfile#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : stg.fCredentialProfile#IsDeleteEnabled
...
select top (10)
  ...
  ,stg.fCredentialProfile#IsDeleteEnabled(x.CredentialProfileSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				stg.CredentialProfile x
			where
				x.CredentialProfileSID = @CredentialProfileSID
