...
CREATE FUNCTION [sf].[fImportFile#IsDeleteEnabled]
	(
	@ImportFileSID int
	)
returns bit
as
/*********************************************************************************************************************************
ScalarF : sf.fImportFile#IsDeleteEnabled
...
select top (10)
   x.ImportFileSID
  ,sf.fImportFile#IsDeleteEnabled(x.ImportFileSID) IsDeleteEnabled
from
  sf.ImportFile x
order by
  newid()
