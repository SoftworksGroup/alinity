...
GO
CREATE FUNCTION [dbo].[fRegistrantRenewalStatus#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantRenewalStatus#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrantRenewalStatus#IsDeleteEnabled(x.RegistrantRenewalStatusSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.RegistrantRenewalStatus x
			where
				x.RegistrantRenewalStatusSID = @RegistrantRenewalStatusSID
