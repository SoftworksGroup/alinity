...
CREATE FUNCTION [sf].[fDataSourceApplicationPage#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fDataSourceApplicationPage#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fDataSourceApplicationPage#IsDeleteEnabled(x.DataSourceApplicationPageSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				sf.DataSourceApplicationPage x
			where
				x.DataSourceApplicationPageSID = @DataSourceApplicationPageSID
