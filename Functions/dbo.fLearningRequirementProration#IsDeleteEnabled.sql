...
GO
CREATE FUNCTION [dbo].[fLearningRequirementProration#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fLearningRequirementProration#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fLearningRequirementProration#IsDeleteEnabled(x.LearningRequirementProrationSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.LearningRequirementProration x
			where
				x.LearningRequirementProrationSID = @LearningRequirementProrationSID
