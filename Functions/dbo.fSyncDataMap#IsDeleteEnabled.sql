...
GO
CREATE FUNCTION [dbo].[fSyncDataMap#IsDeleteEnabled]
	(
	@SyncDataMapSID int
	)
returns bit
as
/*********************************************************************************************************************************
ScalarF : dbo.fSyncDataMap#IsDeleteEnabled
...
select top (10)
   x.SyncDataMapSID
  ,dbo.fSyncDataMap#IsDeleteEnabled(x.SyncDataMapSID) IsDeleteEnabled
from
  dbo.SyncDataMap x
order by
  newid()
	...
	begin
		...
		(
			...
			from
				dbo.SyncDataMap x
			where
				x.SyncDataMapSID = @SyncDataMapSID
