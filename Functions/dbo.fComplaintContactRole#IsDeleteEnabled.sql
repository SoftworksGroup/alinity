...
GO
CREATE FUNCTION [dbo].[fComplaintContactRole#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fComplaintContactRole#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fComplaintContactRole#IsDeleteEnabled(x.ComplaintContactRoleSID) IsDeleteEnabled
from
