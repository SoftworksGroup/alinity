...
GO
CREATE FUNCTION [dbo].[fRegistrationChangeRequirement#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrationChangeRequirement#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrationChangeRequirement#IsDeleteEnabled(x.RegistrationChangeRequirementSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.RegistrationChangeRequirement x
			where
				x.RegistrationChangeRequirementSID = @RegistrationChangeRequirementSID
