...
GO
CREATE FUNCTION [dbo].[fReinstatementResponse#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fReinstatementResponse#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fReinstatementResponse#IsDeleteEnabled(x.ReinstatementResponseSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.ReinstatementResponse x
			where
				x.ReinstatementResponseSID = @ReinstatementResponseSID
