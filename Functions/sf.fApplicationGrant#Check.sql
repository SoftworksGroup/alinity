...
GO
CREATE FUNCTION [sf].[fApplicationGrant#Check]
	(
	 @ApplicationGrantSID  int
	,@ApplicationGrantSCD  varchar(30)
	,@ApplicationGrantName nvarchar(150)
	,@IsDefault            bit
	,@ApplicationGrantXID  varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : sf.fApplicationGrant#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'ApplicationGrant','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
