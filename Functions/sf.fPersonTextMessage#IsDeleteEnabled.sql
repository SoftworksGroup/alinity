...
CREATE FUNCTION [sf].[fPersonTextMessage#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fPersonTextMessage#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fPersonTextMessage#IsDeleteEnabled(x.PersonTextMessageSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				sf.PersonTextMessage x
			where
				x.PersonTextMessageSID = @PersonTextMessageSID
