...
GO
CREATE FUNCTION [dbo].[fRegistrantLanguage#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantLanguage#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrantLanguage#IsDeleteEnabled(x.RegistrantLanguageSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.RegistrantLanguage x
			where
				x.RegistrantLanguageSID = @RegistrantLanguageSID
