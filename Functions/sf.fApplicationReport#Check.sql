...
GO
CREATE FUNCTION [sf].[fApplicationReport#Check]
	(
	 @ApplicationReportSID  int
	,@ApplicationReportName nvarchar(65)
	,@IconFillColor         char(9)
	,@DisplayRank           tinyint
	,@IsCustom              bit
	,@ApplicationReportXID  varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : sf.fApplicationReport#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'ApplicationReport','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
