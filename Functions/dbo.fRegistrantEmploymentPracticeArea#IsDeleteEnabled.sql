...
GO
CREATE FUNCTION [dbo].[fRegistrantEmploymentPracticeArea#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantEmploymentPracticeArea#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrantEmploymentPracticeArea#IsDeleteEnabled(x.RegistrantEmploymentPracticeAreaSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.RegistrantEmploymentPracticeArea x
			where
				x.RegistrantEmploymentPracticeAreaSID = @RegistrantEmploymentPracticeAreaSID
