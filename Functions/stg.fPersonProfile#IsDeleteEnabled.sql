...
GO
CREATE FUNCTION [stg].[fPersonProfile#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : stg.fPersonProfile#IsDeleteEnabled
...
select top (10)
   x.PersonProfileSID
  ,stg.fPersonProfile#IsDeleteEnabled(x.PersonProfileSID) IsDeleteEnabled
from
  stg.PersonProfile x
order by
  newid()
	...
	begin
		...
		(
			...
			from
				stg.PersonProfile x
			where
				x.PersonProfileSID = @PersonProfileSID
