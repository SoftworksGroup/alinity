...
GO
CREATE FUNCTION [sf].[fTextSender#Check]
	(
	 @TextSenderSID      int
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'TextSender','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
