...
GO
CREATE FUNCTION [dbo].[fComplaintEventType#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fComplaintEventType#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fComplaintEventType#IsDeleteEnabled(x.ComplaintEventTypeSID) IsDeleteEnabled
from
