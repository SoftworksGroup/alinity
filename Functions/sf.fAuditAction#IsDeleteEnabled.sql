...
CREATE FUNCTION [sf].[fAuditAction#IsDeleteEnabled]
	(
	@AuditActionSID int
	)
returns bit
as
/*********************************************************************************************************************************
ScalarF : sf.fAuditAction#IsDeleteEnabled
...
select top (10)
   x.AuditActionSID
  ,sf.fAuditAction#IsDeleteEnabled(x.AuditActionSID) IsDeleteEnabled
from
  sf.AuditAction x
order by
  newid()
