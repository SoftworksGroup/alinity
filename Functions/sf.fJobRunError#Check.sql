...
GO
CREATE FUNCTION [sf].[fJobRunError#Check]
	(
	 @JobRunErrorSID     int
	,@JobRunSID          int
	,@MessageText        nvarchar(4000)
	,@DataSource         nvarchar(257)
	,@RecordKey          varchar(50)
	,@JobRunErrorXID     varchar(150)
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'JobRunError','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
