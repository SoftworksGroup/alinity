...
GO
CREATE FUNCTION [dbo].[fComplaintProcessEvent#Check]
	(
	 @ComplaintProcessEventSID int
	,@ComplaintProcessSID      int
	,@ComplaintEventTypeSID    int
	,@Description              nvarchar(500)
	,@Sequence                 decimal(5,1)
	,@TargetDurationDays       smallint
	,@ComplaintProcessEventXID varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fComplaintProcessEvent#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'dbo',N'ComplaintProcessEvent','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
	...
	begin
		...
		(
			...
			where
				r.SchemaName = 'ext'
			and
				r.RoutineName = 'fComplaintProcessEvent#Check'
		)
		begin
		
			select @errorText = ext.fComplaintProcessEvent#Check
				(
				 @ComplaintProcessEventSID
				,@ComplaintProcessSID
				,@ComplaintEventTypeSID
