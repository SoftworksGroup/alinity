...
GO
CREATE FUNCTION [sf].[fEmailTemplateAttachment#Check]
	(
	 @EmailTemplateAttachmentSID int
	,@EmailTemplateSID           int
	,@DocumentTitle              nvarchar(75)
	,@FileTypeSID                int
	,@FileTypeSCD                varchar(8)
	,@EmailTemplateAttachmentXID varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : sf.fEmailTemplateAttachment#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'EmailTemplateAttachment','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
