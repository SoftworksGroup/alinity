...
GO
CREATE FUNCTION [dbo].[fPracticeRegisterChangeRequirement#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fPracticeRegisterChangeRequirement#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fPracticeRegisterChangeRequirement#IsDeleteEnabled(x.PracticeRegisterChangeRequirementSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.PracticeRegisterChangeRequirement x
			where
				x.PracticeRegisterChangeRequirementSID = @PracticeRegisterChangeRequirementSID
