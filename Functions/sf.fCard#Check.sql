...
GO
CREATE FUNCTION [sf].[fCard#Check]
	(
	 @CardSID               int
	,@CardTypeSID           int
	,@CardLabel             nvarchar(35)
	,@CardContext           varchar(25)
	,@CSSDefinition         varchar(150)
	,@IsActive              bit
	,@CardXID               varchar(150)
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'Card','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
