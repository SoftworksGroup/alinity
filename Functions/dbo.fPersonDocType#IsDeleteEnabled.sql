...
GO
CREATE FUNCTION [dbo].[fPersonDocType#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fPersonDocType#IsDeleteEnabled
...
select top (10)
   x.PersonDocTypeSID
  ,dbo.fPersonDocType#IsDeleteEnabled(x.PersonDocTypeSID) IsDeleteEnabled
from
  dbo.PersonDocType x
order by
  newid()
