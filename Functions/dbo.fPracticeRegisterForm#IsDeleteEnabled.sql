...
GO
CREATE FUNCTION [dbo].[fPracticeRegisterForm#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fPracticeRegisterForm#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fPracticeRegisterForm#IsDeleteEnabled(x.PracticeRegisterFormSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.PracticeRegisterForm x
			where
				x.PracticeRegisterFormSID = @PracticeRegisterFormSID
