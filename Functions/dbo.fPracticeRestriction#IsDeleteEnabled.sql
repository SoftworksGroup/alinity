...
GO
CREATE FUNCTION [dbo].[fPracticeRestriction#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fPracticeRestriction#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fPracticeRestriction#IsDeleteEnabled(x.PracticeRestrictionSID) IsDeleteEnabled
from
...
begin
	...
	begin
		...
		(
			select
				  count(x01.PracticeRegisterRestrictionSID)
				+ count(x02.RegistrantPracticeRestrictionSID)
			from
				dbo.PracticeRestriction           x00
			left outer join
				  (select top (1) x.PracticeRegisterRestrictionSID, x.PracticeRestrictionSID from dbo.PracticeRegisterRestriction x where x.PracticeRestrictionSID = @PracticeRestrictionSID) x01 on x00.PracticeRestrictionSID =  x01.PracticeRestrictionSID
			left outer join
				  (select top (1) x.RegistrantPracticeRestrictionSID, x.PracticeRestrictionSID from dbo.RegistrantPracticeRestriction x where x.PracticeRestrictionSID = @PracticeRestrictionSID) x02 on x00.PracticeRestrictionSID =  x02.PracticeRestrictionSID
			where
				x00.PracticeRestrictionSID = @PracticeRestrictionSID
	...
	begin
		...
		(
			...
			from
				dbo.PracticeRestriction x
			where
				x.PracticeRestrictionSID = @PracticeRestrictionSID
