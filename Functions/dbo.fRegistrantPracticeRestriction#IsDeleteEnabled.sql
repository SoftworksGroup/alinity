...
GO
CREATE FUNCTION [dbo].[fRegistrantPracticeRestriction#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantPracticeRestriction#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrantPracticeRestriction#IsDeleteEnabled(x.RegistrantPracticeRestrictionSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.RegistrantPracticeRestriction x
			where
				x.RegistrantPracticeRestrictionSID = @RegistrantPracticeRestrictionSID
