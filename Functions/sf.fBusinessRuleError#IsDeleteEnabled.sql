...
CREATE FUNCTION [sf].[fBusinessRuleError#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fBusinessRuleError#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fBusinessRuleError#IsDeleteEnabled(x.BusinessRuleErrorSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				sf.BusinessRuleError x
			where
				x.BusinessRuleErrorSID = @BusinessRuleErrorSID
