...
GO
CREATE FUNCTION [sf].[fApplicationPageHelp#Check]
	(
	 @ApplicationPageHelpSID int
	,@ApplicationPageSID     int
	,@ApplicationPageHelpID  varchar(100)
	,@StepSequence           int
	,@ApplicationPageHelpXID varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : sf.fApplicationPageHelp#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'ApplicationPageHelp','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
