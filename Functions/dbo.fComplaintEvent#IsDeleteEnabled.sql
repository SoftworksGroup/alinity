...
GO
CREATE FUNCTION [dbo].[fComplaintEvent#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fComplaintEvent#IsDeleteEnabled
...
select top (10)
   x.ComplaintEventSID
  ,dbo.fComplaintEvent#IsDeleteEnabled(x.ComplaintEventSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.ComplaintEvent x
			where
				x.ComplaintEventSID = @ComplaintEventSID
