...
GO
CREATE FUNCTION [sf].[fApplicationEntity#Check]
	(
	 @ApplicationEntitySID  int
	,@ApplicationEntitySCD  varchar(50)
	,@ApplicationEntityName nvarchar(50)
	,@IsMergeDataSource     bit
	,@ApplicationEntityXID  varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : sf.fApplicationEntity#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'ApplicationEntity','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
