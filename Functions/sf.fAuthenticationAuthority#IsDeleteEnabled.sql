...
CREATE FUNCTION [sf].[fAuthenticationAuthority#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fAuthenticationAuthority#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fAuthenticationAuthority#IsDeleteEnabled(x.AuthenticationAuthoritySID) IsDeleteEnabled
from
