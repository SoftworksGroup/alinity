...
CREATE FUNCTION [sf].[fApplicationPage#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fApplicationPage#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fApplicationPage#IsDeleteEnabled(x.ApplicationPageSID) IsDeleteEnabled
from
