...
CREATE FUNCTION [sf].[fJobScheduleEvent#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fJobScheduleEvent#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fJobScheduleEvent#IsDeleteEnabled(x.JobScheduleEventSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				sf.JobScheduleEvent x
			where
				x.JobScheduleEventSID = @JobScheduleEventSID
