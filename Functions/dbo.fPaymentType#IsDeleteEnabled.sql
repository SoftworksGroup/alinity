...
GO
CREATE FUNCTION [dbo].[fPaymentType#IsDeleteEnabled]
	(
	@PaymentTypeSID int
	)
returns bit
as
/*********************************************************************************************************************************
ScalarF : dbo.fPaymentType#IsDeleteEnabled
...
select top (10)
   x.PaymentTypeSID
  ,dbo.fPaymentType#IsDeleteEnabled(x.PaymentTypeSID) IsDeleteEnabled
from
  dbo.PaymentType x
order by
  newid()
