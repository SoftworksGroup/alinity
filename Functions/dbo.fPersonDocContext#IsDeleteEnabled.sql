...
GO
CREATE FUNCTION [dbo].[fPersonDocContext#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fPersonDocContext#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fPersonDocContext#IsDeleteEnabled(x.PersonDocContextSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.PersonDocContext x
			where
				x.PersonDocContextSID = @PersonDocContextSID
