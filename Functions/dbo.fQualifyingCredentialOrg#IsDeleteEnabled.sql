...
GO
CREATE FUNCTION [dbo].[fQualifyingCredentialOrg#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fQualifyingCredentialOrg#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fQualifyingCredentialOrg#IsDeleteEnabled(x.QualifyingCredentialOrgSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.QualifyingCredentialOrg x
			where
				x.QualifyingCredentialOrgSID = @QualifyingCredentialOrgSID
