...
GO
CREATE FUNCTION [dbo].[fRegistrantAppReviewResponse#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantAppReviewResponse#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrantAppReviewResponse#IsDeleteEnabled(x.RegistrantAppReviewResponseSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.RegistrantAppReviewResponse x
			where
				x.RegistrantAppReviewResponseSID = @RegistrantAppReviewResponseSID
