...
GO
CREATE FUNCTION [dbo].[fPracticeRegisterSection#Check]
	(
	...
	,@IsActive                     bit
	,@PracticeRegisterSectionXID   varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fPracticeRegisterSection#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'dbo',N'PracticeRegisterSection','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
	...
	begin
		...
		(
			...
			where
				r.SchemaName = 'ext'
			and
				r.RoutineName = 'fPracticeRegisterSection#Check'
		)
		begin
		
			select @errorText = ext.fPracticeRegisterSection#Check
				(
				 @PracticeRegisterSectionSID
				,@PracticeRegisterSID
				,@PracticeRegisterSectionLabel
