...
GO
CREATE FUNCTION [dbo].[fRegistrantAppResponse#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantAppResponse#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrantAppResponse#IsDeleteEnabled(x.RegistrantAppResponseSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.RegistrantAppResponse x
			where
				x.RegistrantAppResponseSID = @RegistrantAppResponseSID
