...
GO
CREATE FUNCTION [dbo].[fRegistrantInactivePeriod#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantInactivePeriod#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrantInactivePeriod#IsDeleteEnabled(x.RegistrantInactivePeriodSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.RegistrantInactivePeriod x
			where
				x.RegistrantInactivePeriodSID = @RegistrantInactivePeriodSID
