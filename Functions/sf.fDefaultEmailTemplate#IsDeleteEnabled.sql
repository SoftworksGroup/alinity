...
CREATE FUNCTION [sf].[fDefaultEmailTemplate#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fDefaultEmailTemplate#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fDefaultEmailTemplate#IsDeleteEnabled(x.DefaultEmailTemplateSID) IsDeleteEnabled
from
