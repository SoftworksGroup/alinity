...
GO
CREATE FUNCTION [dbo].[fPersonNoteContext#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fPersonNoteContext#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fPersonNoteContext#IsDeleteEnabled(x.PersonNoteContextSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.PersonNoteContext x
			where
				x.PersonNoteContextSID = @PersonNoteContextSID
