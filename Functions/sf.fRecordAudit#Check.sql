...
GO
CREATE FUNCTION [sf].[fRecordAudit#Check]
	(
	 @RecordAuditSID            int
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'RecordAudit','?SomeMessageCode.ColumnName') = 1						-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
