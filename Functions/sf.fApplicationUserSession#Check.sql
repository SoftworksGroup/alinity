...
GO
CREATE FUNCTION [sf].[fApplicationUserSession#Check]
	(
	 @ApplicationUserSessionSID int
	,@ApplicationUserSID        int
	,@IsActive                  bit
	,@IPAddress                 varchar(45)
	,@ApplicationUserSessionXID varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : sf.fApplicationUserSession#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'ApplicationUserSession','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
