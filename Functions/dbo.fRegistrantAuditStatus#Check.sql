...
GO
CREATE FUNCTION [dbo].[fRegistrantAuditStatus#Check]
	(
	 @RegistrantAuditStatusSID int
	,@RegistrantAuditSID       int
	,@FormStatusSID            int
	,@RegistrantAuditStatusXID varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantAuditStatus#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'dbo',N'RegistrantAuditStatus','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
	...
	begin
		...
		(
			...
			where
				r.SchemaName = 'ext'
			and
				r.RoutineName = 'fRegistrantAuditStatus#Check'
		)
		begin
		
			select @errorText = ext.fRegistrantAuditStatus#Check
				(
				 @RegistrantAuditStatusSID
				,@RegistrantAuditSID
				,@FormStatusSID
