...
CREATE FUNCTION [sf].[fControlType#IsDeleteEnabled]
	(
	@ControlTypeSID int
	)
returns bit
as
/*********************************************************************************************************************************
ScalarF : sf.fControlType#IsDeleteEnabled
...
select top (10)
   x.ControlTypeSID
  ,sf.fControlType#IsDeleteEnabled(x.ControlTypeSID) IsDeleteEnabled
from
  sf.ControlType x
order by
  newid()
