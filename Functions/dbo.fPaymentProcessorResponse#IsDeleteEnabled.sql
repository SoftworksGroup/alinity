...
GO
CREATE FUNCTION [dbo].[fPaymentProcessorResponse#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fPaymentProcessorResponse#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fPaymentProcessorResponse#IsDeleteEnabled(x.PaymentProcessorResponseSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.PaymentProcessorResponse x
			where
				x.PaymentProcessorResponseSID = @PaymentProcessorResponseSID
