...
GO
CREATE FUNCTION [dbo].[fProfileUpdateResponse#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fProfileUpdateResponse#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fProfileUpdateResponse#IsDeleteEnabled(x.ProfileUpdateResponseSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.ProfileUpdateResponse x
			where
				x.ProfileUpdateResponseSID = @ProfileUpdateResponseSID
