...
CREATE FUNCTION [sf].[fApplicationUserProfileProperty#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fApplicationUserProfileProperty#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fApplicationUserProfileProperty#IsDeleteEnabled(x.ApplicationUserProfilePropertySID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				sf.ApplicationUserProfileProperty x
			where
				x.ApplicationUserProfilePropertySID = @ApplicationUserProfilePropertySID
