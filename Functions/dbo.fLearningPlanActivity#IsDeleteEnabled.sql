...
GO
CREATE FUNCTION [dbo].[fLearningPlanActivity#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fLearningPlanActivity#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fLearningPlanActivity#IsDeleteEnabled(x.LearningPlanActivitySID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.LearningPlanActivity x
			where
				x.LearningPlanActivitySID = @LearningPlanActivitySID
