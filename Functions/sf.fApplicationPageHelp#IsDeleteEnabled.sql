...
CREATE FUNCTION [sf].[fApplicationPageHelp#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fApplicationPageHelp#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fApplicationPageHelp#IsDeleteEnabled(x.ApplicationPageHelpSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				sf.ApplicationPageHelp x
			where
				x.ApplicationPageHelpSID = @ApplicationPageHelpSID
