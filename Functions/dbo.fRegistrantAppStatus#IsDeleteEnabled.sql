...
GO
CREATE FUNCTION [dbo].[fRegistrantAppStatus#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantAppStatus#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrantAppStatus#IsDeleteEnabled(x.RegistrantAppStatusSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.RegistrantAppStatus x
			where
				x.RegistrantAppStatusSID = @RegistrantAppStatusSID
