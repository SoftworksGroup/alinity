...
GO
CREATE FUNCTION [dbo].[fTaxConfiguration#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fTaxConfiguration#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fTaxConfiguration#IsDeleteEnabled(x.TaxConfigurationSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.TaxConfiguration x
			where
				x.TaxConfigurationSID = @TaxConfigurationSID
