...
GO
CREATE FUNCTION [dbo].[fProfileUpdateResponse#Check]
	(
	 @ProfileUpdateResponseSID int
	,@ProfileUpdateSID         int
	,@FormOwnerSID             int
	,@ProfileUpdateResponseXID varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fProfileUpdateResponse#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'dbo',N'ProfileUpdateResponse','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
	...
	begin
		...
		(
			...
			where
				r.SchemaName = 'ext'
			and
				r.RoutineName = 'fProfileUpdateResponse#Check'
		)
		begin
		
			select @errorText = ext.fProfileUpdateResponse#Check
				(
				 @ProfileUpdateResponseSID
				,@ProfileUpdateSID
				,@FormOwnerSID
