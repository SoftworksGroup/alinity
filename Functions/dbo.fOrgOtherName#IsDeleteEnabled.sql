...
GO
CREATE FUNCTION [dbo].[fOrgOtherName#IsDeleteEnabled]
	(
	@OrgOtherNameSID int
	)
returns bit
as
/*********************************************************************************************************************************
ScalarF : dbo.fOrgOtherName#IsDeleteEnabled
...
select top (10)
   x.OrgOtherNameSID
  ,dbo.fOrgOtherName#IsDeleteEnabled(x.OrgOtherNameSID) IsDeleteEnabled
from
  dbo.OrgOtherName x
order by
  newid()
	...
	begin
		...
		(
			...
			from
				dbo.OrgOtherName x
			where
				x.OrgOtherNameSID = @OrgOtherNameSID
