...
CREATE FUNCTION [sf].[fPersonMailingPreference#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fPersonMailingPreference#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fPersonMailingPreference#IsDeleteEnabled(x.PersonMailingPreferenceSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				sf.PersonMailingPreference x
			where
				x.PersonMailingPreferenceSID = @PersonMailingPreferenceSID
