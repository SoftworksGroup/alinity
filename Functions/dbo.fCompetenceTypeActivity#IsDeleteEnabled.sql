...
GO
CREATE FUNCTION [dbo].[fCompetenceTypeActivity#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fCompetenceTypeActivity#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fCompetenceTypeActivity#IsDeleteEnabled(x.CompetenceTypeActivitySID) IsDeleteEnabled
from
...
begin
	...
	begin
		...
		(
			...
			from
				dbo.CompetenceTypeActivity x00
			left outer join
				  (select top (1) x.LearningPlanActivitySID, x.CompetenceTypeActivitySID from dbo.LearningPlanActivity x where x.CompetenceTypeActivitySID = @CompetenceTypeActivitySID) x01 on x00.CompetenceTypeActivitySID =  x01.CompetenceTypeActivitySID
			where
				x00.CompetenceTypeActivitySID = @CompetenceTypeActivitySID
	...
	begin
		...
		(
			...
			from
				dbo.CompetenceTypeActivity x
			where
				x.CompetenceTypeActivitySID = @CompetenceTypeActivitySID
