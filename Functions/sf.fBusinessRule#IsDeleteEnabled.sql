...
CREATE FUNCTION [sf].[fBusinessRule#IsDeleteEnabled]
	(
	@BusinessRuleSID int
	)
returns bit
as
/*********************************************************************************************************************************
ScalarF : sf.fBusinessRule#IsDeleteEnabled
...
select top (10)
   x.BusinessRuleSID
  ,sf.fBusinessRule#IsDeleteEnabled(x.BusinessRuleSID) IsDeleteEnabled
from
  sf.BusinessRule x
order by
  newid()
...
begin
	...
	--! <PostCheck>
	set @isDeleteEnabled = @OFF																							-- block deletion of business rule records from the UI
	--! </PostCheck>
