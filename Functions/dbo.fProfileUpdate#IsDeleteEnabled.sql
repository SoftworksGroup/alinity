...
GO
CREATE FUNCTION [dbo].[fProfileUpdate#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fProfileUpdate#IsDeleteEnabled
...
select top (10)
   x.ProfileUpdateSID
  ,dbo.fProfileUpdate#IsDeleteEnabled(x.ProfileUpdateSID) IsDeleteEnabled
from
  dbo.ProfileUpdate x
order by
  newid()
