...
GO
CREATE FUNCTION [sf].[fNamePrefix#Check]
	(
	 @NamePrefixSID      int
	,@NamePrefixLabel    nvarchar(35)
	,@IsActive           bit
	,@NamePrefixXID      varchar(150)
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'NamePrefix','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
