...
GO
CREATE FUNCTION [dbo].[fPracticeScope#Check]
	(
	 @PracticeScopeSID   int
	,@PracticeScopeName  nvarchar(50)
	,@PracticeScopeCode  varchar(20)
	,@IsDefault          bit
	,@IsActive           bit
	,@PracticeScopeXID   varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fPracticeScope#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'dbo',N'PracticeScope','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
	...
	begin
		...
		(
			...
			where
				r.SchemaName = 'ext'
			and
				r.RoutineName = 'fPracticeScope#Check'
		)
		begin
		
			select @errorText = ext.fPracticeScope#Check
				(
				 @PracticeScopeSID
				,@PracticeScopeName
				,@PracticeScopeCode
