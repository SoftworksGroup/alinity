...
GO
CREATE FUNCTION [dbo].[fPaymentStatus#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fPaymentStatus#IsDeleteEnabled
...
select top (10)
   x.PaymentStatusSID
  ,dbo.fPaymentStatus#IsDeleteEnabled(x.PaymentStatusSID) IsDeleteEnabled
from
  dbo.PaymentStatus x
order by
  newid()
