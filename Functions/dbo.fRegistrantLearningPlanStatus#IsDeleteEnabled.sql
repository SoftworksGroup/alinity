...
GO
CREATE FUNCTION [dbo].[fRegistrantLearningPlanStatus#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantLearningPlanStatus#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrantLearningPlanStatus#IsDeleteEnabled(x.RegistrantLearningPlanStatusSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.RegistrantLearningPlanStatus x
			where
				x.RegistrantLearningPlanStatusSID = @RegistrantLearningPlanStatusSID
