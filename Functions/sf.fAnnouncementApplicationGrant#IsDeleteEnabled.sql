...
CREATE FUNCTION [sf].[fAnnouncementApplicationGrant#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fAnnouncementApplicationGrant#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fAnnouncementApplicationGrant#IsDeleteEnabled(x.AnnouncementApplicationGrantSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				sf.AnnouncementApplicationGrant x
			where
				x.AnnouncementApplicationGrantSID = @AnnouncementApplicationGrantSID
