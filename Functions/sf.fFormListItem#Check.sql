...
GO
CREATE FUNCTION [sf].[fFormListItem#Check]
	(
	 @FormListItemSID      int
	,@FormListSID          int
	,@FormListItemCode     varchar(15)
	,@FormListItemLabel    nvarchar(35)
	,@FormListItemSequence smallint
	,@ToolTip              nvarchar(500)
	,@IsActive             bit
	,@FormListItemXID      varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : sf.fFormListItem#Check
...
begin
	...
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'sf',N'FormListItem','ValueIsRequired.ToolTip') = @ON and @ToolTip is null
	begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'FormListItem','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
