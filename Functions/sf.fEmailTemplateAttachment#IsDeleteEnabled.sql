...
CREATE FUNCTION [sf].[fEmailTemplateAttachment#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fEmailTemplateAttachment#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fEmailTemplateAttachment#IsDeleteEnabled(x.EmailTemplateAttachmentSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				sf.EmailTemplateAttachment x
			where
				x.EmailTemplateAttachmentSID = @EmailTemplateAttachmentSID
