...
GO
CREATE FUNCTION [dbo].[fExamQuestionChoice#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fExamQuestionChoice#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fExamQuestionChoice#IsDeleteEnabled(x.ExamQuestionChoiceSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.ExamQuestionChoice x
			where
				x.ExamQuestionChoiceSID = @ExamQuestionChoiceSID
