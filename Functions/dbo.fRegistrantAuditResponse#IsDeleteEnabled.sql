...
GO
CREATE FUNCTION [dbo].[fRegistrantAuditResponse#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantAuditResponse#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrantAuditResponse#IsDeleteEnabled(x.RegistrantAuditResponseSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.RegistrantAuditResponse x
			where
				x.RegistrantAuditResponseSID = @RegistrantAuditResponseSID
