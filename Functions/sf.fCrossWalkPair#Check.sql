...
GO
CREATE FUNCTION [sf].[fCrossWalkPair#Check]
	(
	 @CrossWalkPairSID   int
	,@CrossWalkSID       int
	,@SourceValue        nvarchar(100)
	,@TargetValue        nvarchar(100)
	,@CrossWalkPairXID   varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : sf.fCrossWalkPair#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'CrossWalkPair','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
