...
GO
CREATE FUNCTION [sf].[fOtherNameType#Check]
	(
	 @OtherNameTypeSID   int
	,@OtherNameTypeLabel nvarchar(35)
	,@IsDefault          bit
	,@IsActive           bit
	,@OtherNameTypeXID   varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : sf.fOtherNameType#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'OtherNameType','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
