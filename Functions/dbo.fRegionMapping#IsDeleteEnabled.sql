...
GO
CREATE FUNCTION [dbo].[fRegionMapping#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegionMapping#IsDeleteEnabled
...
select top (10)
   x.RegionMappingSID
  ,dbo.fRegionMapping#IsDeleteEnabled(x.RegionMappingSID) IsDeleteEnabled
from
  dbo.RegionMapping x
order by
  newid()
	...
	begin
		...
		(
			...
			from
				dbo.RegionMapping x
			where
				x.RegionMappingSID = @RegionMappingSID
