...
GO
CREATE FUNCTION [dbo].[fRegistrationChangeStatus#Check]
	(
	 @RegistrationChangeStatusSID int
	,@RegistrationChangeSID       int
	,@FormStatusSID               int
	,@RegistrationChangeStatusXID varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrationChangeStatus#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'dbo',N'RegistrationChangeStatus','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
	...
	begin
		...
		(
			...
			where
				r.SchemaName = 'ext'
			and
				r.RoutineName = 'fRegistrationChangeStatus#Check'
		)
		begin
		
			select @errorText = ext.fRegistrationChangeStatus#Check
				(
				 @RegistrationChangeStatusSID
				,@RegistrationChangeSID
				,@FormStatusSID
