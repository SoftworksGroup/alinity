...
CREATE FUNCTION [sf].[fFormListItem#IsDeleteEnabled]
	(
	@FormListItemSID int
	)
returns bit
as
/*********************************************************************************************************************************
ScalarF : sf.fFormListItem#IsDeleteEnabled
...
select top (10)
   x.FormListItemSID
  ,sf.fFormListItem#IsDeleteEnabled(x.FormListItemSID) IsDeleteEnabled
from
  sf.FormListItem x
order by
  newid()
	...
	begin
		...
		(
			...
			from
				sf.FormListItem x
			where
				x.FormListItemSID = @FormListItemSID
