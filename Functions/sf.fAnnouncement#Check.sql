...
GO
CREATE FUNCTION [sf].[fAnnouncement#Check]
	(
	 @AnnouncementSID       int
	,@Title                 nvarchar(75)
	,@AnnouncementText      nvarchar(1000)
	,@EffectiveTime         datetime
	,@ExpiryTime            datetime
	,@AdditionalInfoPageURI varchar(150)
	,@IsLoginAlert          bit
	,@IsExtendedFormat      bit
	,@AnnouncementXID       varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : sf.fAnnouncement#Check
...
$AutoRules | Tim Edlund        ValueIsRequired.AdditionalInfoPageURI A value for "%1" is required.
...
begin
	...
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'sf',N'Announcement','ValueIsRequired.AdditionalInfoPageURI') = @ON and @AdditionalInfoPageURI is null
	begin
		set @errorMessageSCD    = 'ValueIsRequired.AdditionalInfoPageURI'
		set @columnNames        = N'AdditionalInfoPageURI'
		set @defaultMessageText = N'A value for "%1" is required.'
		set @arg1               = N'Additional Info Page URI'
	end
	--!</Rule>
	...
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'sf',N'Announcement','BackDatingLimit.EffectiveTime') = @ON
	...
	--!<Rule Author="$AutoRules | Tim Edlund">
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'sf',N'Announcement','FutureDatingLimit.ExpiryTime') = @ON
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'Announcement','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
