...
CREATE FUNCTION [sf].[fFormSubForm#IsDeleteEnabled]
	(
	@FormSubFormSID int
	)
returns bit
as
/*********************************************************************************************************************************
ScalarF : sf.fFormSubForm#IsDeleteEnabled
...
select top (10)
   x.FormSubFormSID
  ,sf.fFormSubForm#IsDeleteEnabled(x.FormSubFormSID) IsDeleteEnabled
from
  sf.FormSubForm x
order by
  newid()
	...
	begin
		...
		(
			...
			from
				sf.FormSubForm x
			where
				x.FormSubFormSID = @FormSubFormSID
