...
GO
CREATE FUNCTION [dbo].[fPersonDoc#ComplaintEventFolderXml]
(
...
as
/*********************************************************************************************************************************
Function	: Person Doc - ComplaintEvent Folder XML
	...
	<Test Name="All" Description="Return all Items">
		<SQLScript>
			<![CDATA[
				...
				select 
				 ...
				 ,p.LastName
				 ,p.FirstName
				 ,dbo.fPersonDoc#ComplaintEventFolderXml(p.PersonSID) ProfileUpdateFolderXML
				from
					sf.Person p;
		...
		<SQLScript>
			<![CDATA[
				...
				select 
				 @responseXML = dbo.fPersonDoc#ComplaintEventFolderXml(@complaintSID) 
...
exec sf.pUnitTest#Execute																								
			@ObjectName = N'dbo.fPersonDoc#ComplaintEventFolderXml'
		,	@DefaultTestOnly = 1
...
begin
	...
	return ( select
			...
			,dbo.fPersonDoc#ItemXml(r.PersonSID, 'dbo.ComplaintEvent', ce.ComplaintEventSID)
		from
