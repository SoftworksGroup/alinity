...
GO
CREATE FUNCTION [sf].[fFormList#Check]
	(
	 @FormListSID        int
	,@FormListCode       varchar(15)
	,@FormListLabel      nvarchar(35)
	,@ToolTip            nvarchar(500)
	,@FormListXID        varchar(150)
...
begin
	...
	if @errorMessageSCD is null and sf.fBusinessRuleIsEnforced(N'sf',N'FormList','ValueIsRequired.ToolTip') = @ON and @ToolTip is null
	begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'FormList','?SomeMessageCode.ColumnName') = 1	-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
