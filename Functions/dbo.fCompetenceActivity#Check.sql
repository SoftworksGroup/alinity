...
GO
CREATE FUNCTION [dbo].[fCompetenceActivity#Check]
	(
	 @CompetenceActivitySID   int
	,@CompetenceActivityLabel nvarchar(35)
	,@CompetenceActivityName  nvarchar(65)
	,@UnitValue               decimal(5,2)
	,@IsActive                bit
	,@CompetenceActivityXID   varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fCompetenceActivity#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'dbo',N'CompetenceActivity','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
	...
	begin
		...
		(
			...
			where
				r.SchemaName = 'ext'
			and
				r.RoutineName = 'fCompetenceActivity#Check'
		)
		begin
		
			select @errorText = ext.fCompetenceActivity#Check
				(
				 @CompetenceActivitySID
				,@CompetenceActivityLabel
				,@CompetenceActivityName
