...
GO
CREATE FUNCTION [dbo].[fExamQuestionReference#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fExamQuestionReference#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fExamQuestionReference#IsDeleteEnabled(x.ExamQuestionReferenceSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				dbo.ExamQuestionReference x
			where
				x.ExamQuestionReferenceSID = @ExamQuestionReferenceSID
