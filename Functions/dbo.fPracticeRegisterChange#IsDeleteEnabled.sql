...
GO
CREATE FUNCTION [dbo].[fPracticeRegisterChange#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fPracticeRegisterChange#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fPracticeRegisterChange#IsDeleteEnabled(x.PracticeRegisterChangeSID) IsDeleteEnabled
from
	...
	begin
		...
		(
			select
				...
				+ count(x02.PracticeRegisterChangeRequirementSID)
			from
				dbo.PracticeRegisterChange            x00
			left outer join
				  (select top (1) x.PracticeRegisterCatalogItemSID, x.PracticeRegisterChangeSID from dbo.PracticeRegisterCatalogItem x where isnull(x.PracticeRegisterChangeSID, -1) = @PracticeRegisterChangeSID) x01 on x00.PracticeRegisterChangeSID =  x01.PracticeRegisterChangeSID
			left outer join
				  (select top (1) x.PracticeRegisterChangeRequirementSID, x.PracticeRegisterChangeSID from dbo.PracticeRegisterChangeRequirement x where x.PracticeRegisterChangeSID = @PracticeRegisterChangeSID) x02 on x00.PracticeRegisterChangeSID =  x02.PracticeRegisterChangeSID
			where
				x00.PracticeRegisterChangeSID = @PracticeRegisterChangeSID
	...
	begin
		...
		(
			...
			from
				dbo.PracticeRegisterChange x
			where
				x.PracticeRegisterChangeSID = @PracticeRegisterChangeSID
