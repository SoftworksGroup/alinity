...
GO
CREATE FUNCTION [dbo].[fRegistrantLearningPlan#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantLearningPlan#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrantLearningPlan#IsDeleteEnabled(x.RegistrantLearningPlanSID) IsDeleteEnabled
from
