...
GO
CREATE FUNCTION [sf].[fCrossWalk#Check]
	(
	 @CrossWalkSID       int
	,@CrossWalkLabel     nvarchar(35)
	,@IsDefault          bit
	,@CrossWalkXID       varchar(150)
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'CrossWalk','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
