...
GO
CREATE FUNCTION [dbo].[fRegistrantInactiveReason#Check]
	(
	 @RegistrantInactiveReasonSID   int
	,@RegistrantInactiveReasonLabel nvarchar(35)
	,@IsActive                      bit
	,@RegistrantInactiveReasonXID   varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrantInactiveReason#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'dbo',N'RegistrantInactiveReason','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
	...
	begin
		...
		(
			...
			where
				r.SchemaName = 'ext'
			and
				r.RoutineName = 'fRegistrantInactiveReason#Check'
		)
		begin
		
			select @errorText = ext.fRegistrantInactiveReason#Check
				(
				 @RegistrantInactiveReasonSID
				,@RegistrantInactiveReasonLabel
				,@IsActive
