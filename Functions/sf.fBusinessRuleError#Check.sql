...
GO
CREATE FUNCTION [sf].[fBusinessRuleError#Check]
	(
	 @BusinessRuleErrorSID int
	,@BusinessRuleSID      int
	,@MessageText          nvarchar(4000)
	,@SourceSID            int
	,@SourceGUID           uniqueidentifier
	,@BusinessRuleErrorXID varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : sf.fBusinessRuleError#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'BusinessRuleError','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
