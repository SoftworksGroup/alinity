...
GO
CREATE FUNCTION [dbo].[fReasonGroup#IsDeleteEnabled]
	(
	@ReasonGroupSID int
	)
returns bit
as
/*********************************************************************************************************************************
ScalarF : dbo.fReasonGroup#IsDeleteEnabled
...
select top (10)
   x.ReasonGroupSID
  ,dbo.fReasonGroup#IsDeleteEnabled(x.ReasonGroupSID) IsDeleteEnabled
from
  dbo.ReasonGroup x
order by
  newid()
