...
GO
CREATE FUNCTION [dbo].[fEmploymentRole#Check]
	(
	 @EmploymentRoleSID  int
	,@EmploymentRoleName nvarchar(50)
	,@EmploymentRoleCode varchar(20)
	,@IsDefault          bit
	,@IsActive           bit
	,@EmploymentRoleXID  varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fEmploymentRole#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'dbo',N'EmploymentRole','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
	...
	begin
		...
		(
			...
			where
				r.SchemaName = 'ext'
			and
				r.RoutineName = 'fEmploymentRole#Check'
		)
		begin
		
			select @errorText = ext.fEmploymentRole#Check
				(
				 @EmploymentRoleSID
				,@EmploymentRoleName
				,@EmploymentRoleCode
