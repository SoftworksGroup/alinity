...
GO
CREATE FUNCTION [dbo].[fLearningRequirement#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fLearningRequirement#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fLearningRequirement#IsDeleteEnabled(x.LearningRequirementSID) IsDeleteEnabled
from
...
begin
	...
	begin
		...
		(
			select
				  count(x01.LearningRequirementCompetenceTypeSID)
				+ count(x02.LearningRequirementProrationSID)
			from
				dbo.LearningRequirement               x00
			left outer join
				  (select top (1) x.LearningRequirementCompetenceTypeSID, x.LearningRequirementSID from dbo.LearningRequirementCompetenceType x where x.LearningRequirementSID = @LearningRequirementSID) x01 on x00.LearningRequirementSID =  x01.LearningRequirementSID
			left outer join
				  (select top (1) x.LearningRequirementProrationSID, x.LearningRequirementSID from dbo.LearningRequirementProration x where x.LearningRequirementSID = @LearningRequirementSID) x02 on x00.LearningRequirementSID =  x02.LearningRequirementSID
			where
				x00.LearningRequirementSID = @LearningRequirementSID
	...
	begin
		...
		(
			...
			from
				dbo.LearningRequirement x
			where
				x.LearningRequirementSID = @LearningRequirementSID
