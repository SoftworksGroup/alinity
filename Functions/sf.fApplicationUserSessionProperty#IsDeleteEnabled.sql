...
CREATE FUNCTION [sf].[fApplicationUserSessionProperty#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : sf.fApplicationUserSessionProperty#IsDeleteEnabled
...
select top (10)
  ...
  ,sf.fApplicationUserSessionProperty#IsDeleteEnabled(x.ApplicationUserSessionPropertySID) IsDeleteEnabled
from
	...
	begin
		...
		(
			...
			from
				sf.ApplicationUserSessionProperty x
			where
				x.ApplicationUserSessionPropertySID = @ApplicationUserSessionPropertySID
