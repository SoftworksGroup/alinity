...
GO
CREATE FUNCTION [sf].[fMailingPreference#Check]
	(
	 @MailingPreferenceSID   int
	,@MailingPreferenceLabel nvarchar(35)
	,@IsAutoOptIn            bit
	,@IsActive               bit
	,@MailingPreferenceXID   varchar(150)
...
as
/*********************************************************************************************************************************
ScalarF : sf.fMailingPreference#Check
...
begin
	...
	if @errorMessageSCD is null --and sf.fBusinessRuleIsEnforced(N'sf',N'MailingPreference','?SomeMessageCode.ColumnName') = 1-- check if rule is ON - REMOVE for mandatory rules
	and 1 = 0
	begin
