...
GO
CREATE FUNCTION [dbo].[fRegistrationProfile#IsDeleteEnabled]
	(
...
as
/*********************************************************************************************************************************
ScalarF : dbo.fRegistrationProfile#IsDeleteEnabled
...
select top (10)
  ...
  ,dbo.fRegistrationProfile#IsDeleteEnabled(x.RegistrationProfileSID) IsDeleteEnabled
from
