...
GO
CREATE PROCEDURE [dbo].[pComplaintProcessEvent#Delete]
	 @ComplaintProcessEventSID    int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@ComplaintEventTypeSCD       varchar(20)       = null
	,@ComplaintEventTypeLabel     nvarchar(35)      = null
	,@ComplaintEventTypeIsDefault bit               = null
	,@ComplaintEventTypeRowGUID   uniqueidentifier  = null
	,@ComplaintProcessLabel       nvarchar(35)      = null
	,@ComplaintProcessIsDefault   bit               = null
	,@ParentComplaintProcessSID   int               = null
	,@ComplaintProcessRowGUID     uniqueidentifier  = null
	,@IsDeleteEnabled             bit               = null
	,@zContext                    xml               = null -- other values defining context for the delete (if any)
as
/*********************************************************************************************************************************
Procedure : dbo.pComplaintProcessEvent#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.ComplaintProcessEvent table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.ComplaintProcessEvent table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pComplaintProcessEvent procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.ComplaintProcessEvent x where x.ComplaintProcessEventSID = @ComplaintProcessEventSID
