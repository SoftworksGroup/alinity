...
GO
CREATE PROCEDURE [dbo].[pRegistrantIdentifier#Delete]
	 @RegistrantIdentifierSID        int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@IdentifierTypeIsDefault        bit               = null
	,@IdentifierTypeRowGUID          uniqueidentifier  = null
	,@PersonSID                      int               = null
...
as
/*********************************************************************************************************************************
Procedure : dbo.pRegistrantIdentifier#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.RegistrantIdentifier table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.RegistrantIdentifier table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pRegistrantIdentifier procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.RegistrantIdentifier x where x.RegistrantIdentifierSID = @RegistrantIdentifierSID
