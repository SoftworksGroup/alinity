...
GO
CREATE PROCEDURE [dbo].[pExamOffering#Delete]
	 @ExamOfferingSID                int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@ExamEffectiveTime              datetime          = null
	,@ExamExpiryTime                 datetime          = null
	...
	,@IsDetailedOffering             bit               = null
as
/*********************************************************************************************************************************
Procedure : dbo.pExamOffering#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.ExamOffering table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.ExamOffering table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pExamOffering procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.ExamOffering x where x.ExamOfferingSID = @ExamOfferingSID
