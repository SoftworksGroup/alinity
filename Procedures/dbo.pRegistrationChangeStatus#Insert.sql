...
GO
CREATE PROCEDURE [dbo].[pRegistrationChangeStatus#Insert]
	 @RegistrationChangeStatusSID int               = null output						-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : dbo.pRegistrationChangeStatus#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the dbo.RegistrationChangeStatus table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.RegistrationChangeStatus table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vRegistrationChangeStatus entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @RegistrationChangeStatusSID = null																	-- initialize output parameter
	...
	begin try
		...
		select
			...
			,@RegistrationChangeStatusSID = scope_identity()										-- capture key value of new row
