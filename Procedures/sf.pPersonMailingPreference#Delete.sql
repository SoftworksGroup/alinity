...
GO
CREATE PROCEDURE [sf].[pPersonMailingPreference#Delete]
	 @PersonMailingPreferenceSID int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@MailingPreferenceLabel     nvarchar(35)      = null
	,@IsAutoOptIn                bit               = null
	,@MailingPreferenceIsActive  bit               = null
	,@MailingPreferenceRowGUID   uniqueidentifier  = null
	,@GenderSID                  int               = null
...
as
/*********************************************************************************************************************************
Procedure : sf.pPersonMailingPreference#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.PersonMailingPreference table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.PersonMailingPreference table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pPersonMailingPreference procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.PersonMailingPreference x where x.PersonMailingPreferenceSID = @PersonMailingPreferenceSID
