...
GO
CREATE PROCEDURE [dbo].[pExamSection#Insert]
	 @ExamSectionSID            int               = null output							-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : dbo.pExamSection#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the dbo.ExamSection table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.ExamSection table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vExamSection entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @ExamSectionSID = null																							-- initialize output parameter
	...
	begin try
		...
		set @RandomQuestionCount = isnull(@RandomQuestionCount,(0))
		set @WeightPerQuestion = isnull(@WeightPerQuestion,(0))
		set @MinimumCorrect = isnull(@MinimumCorrect,(0))
		...
		select
			...
			,@ExamSectionSID = scope_identity()																	-- capture key value of new row
