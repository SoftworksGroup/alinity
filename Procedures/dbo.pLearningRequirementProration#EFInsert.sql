...
GO
CREATE PROCEDURE [dbo].[pLearningRequirementProration#EFInsert]
...
as
/*********************************************************************************************************************************
Procedure : dbo.pLearningRequirementProration#EFInsert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : Alternate call syntax for pLearningRequirementProration#Insert for use with MS Entity Framework (does not declare PK output parameter)
-----------------------------------------------------------------------------------------------------------------------------------
...
begin
	...
	begin try
		...
		exec @errorNo = dbo.pLearningRequirementProration#Insert
