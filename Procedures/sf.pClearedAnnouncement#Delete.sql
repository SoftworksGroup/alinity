...
GO
CREATE PROCEDURE [sf].[pClearedAnnouncement#Delete]
	 @ClearedAnnouncementSID           int               = null -- required! id of row to delete - must be set in custom logic if not passed
...
as
/*********************************************************************************************************************************
Procedure : sf.pClearedAnnouncement#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.ClearedAnnouncement table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.ClearedAnnouncement table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pClearedAnnouncement procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.ClearedAnnouncement x where x.ClearedAnnouncementSID = @ClearedAnnouncementSID
