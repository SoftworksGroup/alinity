...
GO
CREATE PROCEDURE [sf].[pControlType#Delete]
	 @ControlTypeSID     int               = null -- required! id of row to delete - must be set in custom logic if not passed
	,@UpdateUser         nvarchar(75)      = null -- set to current application user unless "SystemUser" passed
	,@RowStamp           timestamp         = null -- row time stamp - pass for preemptive check for overwrites
	,@ControlTypeSCD     varchar(15)       = null
...
as
/*********************************************************************************************************************************
Procedure : sf.pControlType#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.ControlType table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.ControlType table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pControlType procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.ControlType x where x.ControlTypeSID = @ControlTypeSID
