...
GO
CREATE PROCEDURE [dbo].[pCredential#Delete]
	 @CredentialSID           int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@CredentialTypeIsDefault bit               = null
	,@CredentialTypeIsActive  bit               = null
	,@CredentialTypeRowGUID   uniqueidentifier  = null
	,@IsDeleteEnabled         bit               = null
	,@zContext                xml               = null -- other values defining context for the delete (if any)
	,@IsQualifying            bit               = null
as
/*********************************************************************************************************************************
Procedure : dbo.pCredential#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.Credential table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.Credential table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pCredential procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.Credential x where x.CredentialSID = @CredentialSID
