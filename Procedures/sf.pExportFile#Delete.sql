...
GO
CREATE PROCEDURE [sf].[pExportFile#Delete]
	 @ExportFileSID       int               = null -- required! id of row to delete - must be set in custom logic if not passed
	,@UpdateUser          nvarchar(75)      = null -- set to current application user unless "SystemUser" passed
	,@RowStamp            timestamp         = null -- row time stamp - pass for preemptive check for overwrites
	,@ExportSourceGUID    uniqueidentifier  = null
	...
	,@FileFormatSCD       varchar(10)       = null
	,@FileFormatLabel     nvarchar(35)      = null
	,@FileFormatIsDefault bit               = null
	,@FileFormatRowGUID   uniqueidentifier  = null
	,@IsDeleteEnabled     bit               = null
	,@zContext            xml               = null -- other values defining context for the delete (if any)
	,@IsComplete          bit               = null
	,@IsInProcess         bit               = null
	,@MinutesInProcess    int               = null
	,@FileLength          bigint            = null
as
/*********************************************************************************************************************************
Procedure : sf.pExportFile#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.ExportFile table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.ExportFile table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pExportFile procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.ExportFile x where x.ExportFileSID = @ExportFileSID
