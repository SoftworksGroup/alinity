...
GO
CREATE PROCEDURE [sf].[pBusinessRuleError#EFInsert]
...
as
/*********************************************************************************************************************************
Procedure : sf.pBusinessRuleError#EFInsert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : Alternate call syntax for pBusinessRuleError#Insert for use with MS Entity Framework (does not declare PK output parameter)
-----------------------------------------------------------------------------------------------------------------------------------
...
begin
	...
	begin try
		...
		exec @errorNo = sf.pBusinessRuleError#Insert
