...
GO
CREATE PROCEDURE [dbo].[pPAPTransaction#Delete]
	 @PAPTransactionSID               int               = null -- required! id of row to delete - must be set in custom logic if not passed
	,@UpdateUser                      nvarchar(75)      = null -- set to current application user unless "SystemUser" passed
	,@RowStamp                        timestamp         = null -- row time stamp - pass for preemptive check for overwrites
	,@PAPBatchSID                     int               = null
	...
	,@PAPBatchRowGUID                 uniqueidentifier  = null
	,@PAPSubscriptionPersonSID        int               = null
	,@PAPSubscriptionInstitutionNo    varchar(3)        = null
	,@PAPSubscriptionTransitNo        varchar(5)        = null
	,@PAPSubscriptionAccountNo        varchar(15)       = null
	,@PAPSubscriptionWithdrawalAmount decimal(11,2)     = null
	,@EffectiveTime                   datetime          = null
	,@PAPSubscriptionCancelledTime    datetime          = null
	,@PAPSubscriptionRowGUID          uniqueidentifier  = null
	,@PaymentPersonSID                int               = null
...
as
/*********************************************************************************************************************************
Procedure : dbo.pPAPTransaction#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.PAPTransaction table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.PAPTransaction table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pPAPTransaction procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.PAPTransaction x where x.PAPTransactionSID = @PAPTransactionSID
