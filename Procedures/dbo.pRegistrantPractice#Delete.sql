...
GO
CREATE PROCEDURE [dbo].[pRegistrantPractice#Delete]
	 @RegistrantPracticeSID          int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@EmploymentStatusIsDefault      bit               = null
	,@IsEmploymentExpected           bit               = null
	,@EmploymentStatusIsActive       bit               = null
	,@EmploymentStatusRowGUID        uniqueidentifier  = null
	,@PersonSID                      int               = null
	...
	,@TotalJurisdictionHours         int               = null
as
/*********************************************************************************************************************************
Procedure : dbo.pRegistrantPractice#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.RegistrantPractice table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.RegistrantPractice table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pRegistrantPractice procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.RegistrantPractice x where x.RegistrantPracticeSID = @RegistrantPracticeSID
