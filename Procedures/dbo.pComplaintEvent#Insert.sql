...
GO
CREATE PROCEDURE [dbo].[pComplaintEvent#Insert]
	 @ComplaintEventSID           int               = null output						-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : dbo.pComplaintEvent#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the dbo.ComplaintEvent table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.ComplaintEvent table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vComplaintEvent entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @ComplaintEventSID = null																						-- initialize output parameter
	...
	begin try
		...
		select
			...
			,@ComplaintEventSID = scope_identity()															-- capture key value of new row
