...
GO
CREATE PROCEDURE [dbo].[pTax#Delete]
	 @TaxSID                int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@CurrentTaxRate        decimal(4,4)      = null
	,@CurrentGLAccountSID   int               = null
	,@CurrentGLAccountCode  varchar(50)       = null
	,@CurrentGLAccountLabel nvarchar(35)      = null
as
/*********************************************************************************************************************************
Procedure : dbo.pTax#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.Tax table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.Tax table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pTax procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.Tax x where x.TaxSID = @TaxSID
