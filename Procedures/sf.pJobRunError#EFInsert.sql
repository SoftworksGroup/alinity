...
GO
CREATE PROCEDURE [sf].[pJobRunError#EFInsert]
...
as
/*********************************************************************************************************************************
Procedure : sf.pJobRunError#EFInsert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : Alternate call syntax for pJobRunError#Insert for use with MS Entity Framework (does not declare PK output parameter)
-----------------------------------------------------------------------------------------------------------------------------------
...
begin
	...
	begin try
		...
		exec @errorNo = sf.pJobRunError#Insert
			 @JobRunSID               = @JobRunSID
