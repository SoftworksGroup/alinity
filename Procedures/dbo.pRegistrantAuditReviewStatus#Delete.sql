...
GO
CREATE PROCEDURE [dbo].[pRegistrantAuditReviewStatus#Delete]
	 @RegistrantAuditReviewStatusSID int               = null -- required! id of row to delete - must be set in custom logic if not passed
	,@UpdateUser                     nvarchar(75)      = null -- set to current application user unless "SystemUser" passed
	,@RowStamp                       timestamp         = null -- row time stamp - pass for preemptive check for overwrites
	,@RegistrantAuditReviewSID       int               = null
	...
	,@RegistrantAuditReviewRowGUID   uniqueidentifier  = null
	,@FormStatusSCD                  varchar(25)       = null
	,@FormStatusLabel                nvarchar(35)      = null
	,@IsFinal                        bit               = null
	,@FormStatusIsDefault            bit               = null
	,@FormStatusSequence             int               = null
	,@FormOwnerSID                   int               = null
	,@FormStatusRowGUID              uniqueidentifier  = null
	,@IsDeleteEnabled                bit               = null
	,@zContext                       xml               = null -- other values defining context for the delete (if any)
as
/*********************************************************************************************************************************
Procedure : dbo.pRegistrantAuditReviewStatus#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.RegistrantAuditReviewStatus table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.RegistrantAuditReviewStatus table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pRegistrantAuditReviewStatus procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.RegistrantAuditReviewStatus x where x.RegistrantAuditReviewStatusSID = @RegistrantAuditReviewStatusSID
