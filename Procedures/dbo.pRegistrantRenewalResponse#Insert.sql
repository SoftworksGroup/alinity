...
GO
CREATE PROCEDURE [dbo].[pRegistrantRenewalResponse#Insert]
	 @RegistrantRenewalResponseSID int               = null output					-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : dbo.pRegistrantRenewalResponse#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the dbo.RegistrantRenewalResponse table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.RegistrantRenewalResponse table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vRegistrantRenewalResponse entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @RegistrantRenewalResponseSID = null																-- initialize output parameter
	...
	begin try
		...
		select
			...
			,@RegistrantRenewalResponseSID = scope_identity()										-- capture key value of new row
