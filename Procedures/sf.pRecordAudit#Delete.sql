...
GO
CREATE PROCEDURE [sf].[pRecordAudit#Delete]
	 @RecordAuditSID                 int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@ApplicationUserSessionIsActive bit               = null
	,@IPAddress                      varchar(45)       = null
	,@ApplicationUserSessionRowGUID  uniqueidentifier  = null
	,@AuditActionSCD                 varchar(25)       = null
	,@AuditActionName                nvarchar(50)      = null
	,@AuditActionIsDefault           bit               = null
	,@AuditActionRowGUID             uniqueidentifier  = null
	...
	,@AuditTimeClientTZ              varchar(19)       = null
as
/*********************************************************************************************************************************
Procedure : sf.pRecordAudit#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.RecordAudit table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.RecordAudit table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pRecordAudit procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.RecordAudit x where x.RecordAuditSID = @RecordAuditSID
    ...
    -- the deletion option based on the value returned from the IsDeleteEnabled function
		-- in the #Ext view.
    set @IsDeleteEnabled = sf.fRecordAudit#IsDeleteEnabled(@RecordAuditSID)
