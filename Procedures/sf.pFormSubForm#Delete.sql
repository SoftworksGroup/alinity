...
GO
CREATE PROCEDURE [sf].[pFormSubForm#Delete]
	 @FormSubFormSID            int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@FormFormTypeSID           int               = null
	,@FormFormName              nvarchar(65)      = null
	,@FormFormLabel             nvarchar(35)      = null
	,@FormFormContext           varchar(25)       = null
	,@FormAuthorCredit          nvarchar(500)     = null
	,@FormIsActive              bit               = null
	,@FormApplicationUserSID    int               = null
	,@FormRowGUID               uniqueidentifier  = null
	,@FormSubFormTypeSID        int               = null
	,@FormSubFormName           nvarchar(65)      = null
	,@FormSubFormLabel          nvarchar(35)      = null
	,@FormSubFormContext        varchar(25)       = null
	,@FormSubAuthorCredit       nvarchar(500)     = null
	,@FormSubIsActive           bit               = null
	,@FormSubApplicationUserSID int               = null
	,@FormSubRowGUID            uniqueidentifier  = null
	,@IsDeleteEnabled           bit               = null
	,@zContext                  xml               = null -- other values defining context for the delete (if any)
as
/*********************************************************************************************************************************
Procedure : sf.pFormSubForm#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.FormSubForm table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.FormSubForm table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pFormSubForm procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.FormSubForm x where x.FormSubFormSID = @FormSubFormSID
