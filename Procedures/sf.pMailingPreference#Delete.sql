...
GO
CREATE PROCEDURE [sf].[pMailingPreference#Delete]
	 @MailingPreferenceSID   int               = null -- required! id of row to delete - must be set in custom logic if not passed
...
as
/*********************************************************************************************************************************
Procedure : sf.pMailingPreference#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.MailingPreference table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.MailingPreference table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pMailingPreference procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.MailingPreference x where x.MailingPreferenceSID = @MailingPreferenceSID
		...
		update																																-- set audit details on sf.PersonMailingPreference rows that will delete through CASCADE
