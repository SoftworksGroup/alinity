...
GO
CREATE PROCEDURE [stg].[pOrgProfile#Delete]
	 @OrgProfileSID             int               = null -- required! id of row to delete - must be set in custom logic if not passed
...
as
/*********************************************************************************************************************************
Procedure : stg.pOrgProfile#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the stg.OrgProfile table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the stg.OrgProfile table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pOrgProfile procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from stg.OrgProfile x where x.OrgProfileSID = @OrgProfileSID
