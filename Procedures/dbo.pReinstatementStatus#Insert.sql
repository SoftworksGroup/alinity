...
GO
CREATE PROCEDURE [dbo].[pReinstatementStatus#Insert]
	 @ReinstatementStatusSID     int               = null output						-- identity value assigned to the new record
	,@ReinstatementSID           int               = null										-- required! if not passed value must be set in custom logic prior to insert
	...
	,@ReinstatementRowGUID       uniqueidentifier  = null										-- not a base table column (default ignored)
...
as
/*********************************************************************************************************************************
Procedure : dbo.pReinstatementStatus#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the dbo.ReinstatementStatus table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.ReinstatementStatus table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vReinstatementStatus entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @ReinstatementStatusSID = null																			-- initialize output parameter
	...
	begin try
		...
		select
			...
			,@ReinstatementStatusSID = scope_identity()													-- capture key value of new row
