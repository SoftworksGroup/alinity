...
GO
CREATE PROCEDURE [dbo].[pRegistrantRenewal#Insert]
	 @RegistrantRenewalSID                   int               = null output-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : dbo.pRegistrantRenewal#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the dbo.RegistrantRenewal table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.RegistrantRenewal table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vRegistrantRenewal entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @RegistrantRenewalSID = null																				-- initialize output parameter
	...
	begin try
		...
		begin
			...
			exec sf.pMessage#Get
				...
				,@Arg1        = 'Renewal Form + Register (published)'
		...
		begin
			set @errorText = dbo.fRegistration#Pending(@RegistrationSID, 'RENEWAL');
		...
		select
			...
			,@RegistrantRenewalSID = scope_identity()														-- capture key value of new row
