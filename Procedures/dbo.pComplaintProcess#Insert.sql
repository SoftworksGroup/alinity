...
GO
CREATE PROCEDURE [dbo].[pComplaintProcess#Insert]
	 @ComplaintProcessSID       int               = null output							-- identity value assigned to the new record
	,@ComplaintProcessLabel     nvarchar(35)      = null										-- required! if not passed value must be set in custom logic prior to insert
...
as
/*********************************************************************************************************************************
Procedure : dbo.pComplaintProcess#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the dbo.ComplaintProcess table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.ComplaintProcess table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vComplaintProcess entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @ComplaintProcessSID = null																					-- initialize output parameter
	...
	begin try
		...
		begin
			...
			select @recordSID = x.ComplaintProcessSID from dbo.ComplaintProcess x where x.IsDefault = @ON
		...
		select
			...
			,@ComplaintProcessSID = scope_identity()														-- capture key value of new row
