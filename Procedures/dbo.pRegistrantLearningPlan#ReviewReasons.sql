...
GO
CREATE PROCEDURE dbo.pRegistrantLearningPlan#ReviewReasons
...
as
/*********************************************************************************************************************************
Sproc    : Registrant Learning Plan - Review Reasons
...
begin
	...
	exec dbo.pRegistrantLearningPlan#ReviewReasons
		 @RegistrantLearningPlanSID = -1
...
exec sf.pUnitTest#Execute
	@ObjectName = 'dbo.pRegistrantLearningPlan#ReviewReasons'
 ,@DefaultTestOnly = 1
------------------------------------------------------------------------------------------------------------------------------- */
...
begin
	...
	begin try
		...
		select
			--!<ColumnList DataSource="dbo.fRegistrantLearningPlan#ReviewReasons" Alias="rsn">
			 rsn.RegistrantLearningPlanSID
			,rsn.ReasonSID
			,rsn.ReasonGroupSID
			,rsn.ReasonName
			,rsn.ReasonCode
		...
		--!</ColumnList>
		from
			dbo.fRegistrantLearningPlan#ReviewReasons(@RegistrantLearningPlanSID, @RegistrationYear) rsn;
