...
GO
CREATE PROCEDURE [dbo].[pCatalogItemPrice#Delete]
	 @CatalogItemPriceSID          int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@CatalogItemPriceProrationSID int               = null
	,@CurrentPrice                 decimal(11,2)     = null
	,@IsProrated                   bit               = null
as
/*********************************************************************************************************************************
Procedure : dbo.pCatalogItemPrice#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.CatalogItemPrice table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.CatalogItemPrice table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pCatalogItemPrice procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.CatalogItemPrice x where x.CatalogItemPriceSID = @CatalogItemPriceSID
