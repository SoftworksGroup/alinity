...
GO
CREATE PROCEDURE [sf].[pAnnouncementApplicationGrant#Delete]
	 @AnnouncementApplicationGrantSID int               = null -- required! id of row to delete - must be set in custom logic if not passed
	,@UpdateUser                      nvarchar(75)      = null -- set to current application user unless "SystemUser" passed
	,@RowStamp                        timestamp         = null -- row time stamp - pass for preemptive check for overwrites
	,@AnnouncementSID                 int               = null
	...
	,@AnnouncementRowGUID             uniqueidentifier  = null
...
as
/*********************************************************************************************************************************
Procedure : sf.pAnnouncementApplicationGrant#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.AnnouncementApplicationGrant table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.AnnouncementApplicationGrant table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pAnnouncementApplicationGrant procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.AnnouncementApplicationGrant x where x.AnnouncementApplicationGrantSID = @AnnouncementApplicationGrantSID
