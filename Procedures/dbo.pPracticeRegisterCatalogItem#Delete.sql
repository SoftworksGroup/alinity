...
GO
CREATE PROCEDURE [dbo].[pPracticeRegisterCatalogItem#Delete]
	 @PracticeRegisterCatalogItemSID                   int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@CatalogItemEffectiveTime                         datetime          = null
	,@CatalogItemExpiryTime                            datetime          = null
	...
	,@PracticeRegisterIsDefault                        bit               = null
	,@IsDefaultInactivePractice                        bit               = null
	,@PracticeRegisterIsActive                         bit               = null
	,@PracticeRegisterRowGUID                          uniqueidentifier  = null
	,@PracticeRegisterChangePracticeRegisterSID        int               = null
	,@PracticeRegisterChangePracticeRegisterSectionSID int               = null
	,@PracticeRegisterChangeIsActive                   bit               = null
	,@ToolTip                                          nvarchar(500)     = null
	,@IsEnabledForRegistrant                           bit               = null
	,@PracticeRegisterChangeRowGUID                    uniqueidentifier  = null
	,@PracticeRegisterSectionPracticeRegisterSID       int               = null
...
as
/*********************************************************************************************************************************
Procedure : dbo.pPracticeRegisterCatalogItem#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.PracticeRegisterCatalogItem table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.PracticeRegisterCatalogItem table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pPracticeRegisterCatalogItem procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.PracticeRegisterCatalogItem x where x.PracticeRegisterCatalogItemSID = @PracticeRegisterCatalogItemSID
