...
GO
CREATE PROCEDURE [sf].[pTextTrigger#EFInsert]
...
as
/*********************************************************************************************************************************
Procedure : sf.pTextTrigger#EFInsert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : Alternate call syntax for pTextTrigger#Insert for use with MS Entity Framework (does not declare PK output parameter)
-----------------------------------------------------------------------------------------------------------------------------------
...
begin
	...
	begin try
		...
		exec @errorNo = sf.pTextTrigger#Insert
