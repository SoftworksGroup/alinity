...
GO
CREATE PROCEDURE [dbo].[pRegistrantAppResponse#Insert]
	 @RegistrantAppResponseSID   int               = null output						-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : dbo.pRegistrantAppResponse#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the dbo.RegistrantAppResponse table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.RegistrantAppResponse table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vRegistrantAppResponse entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @RegistrantAppResponseSID = null																		-- initialize output parameter
	...
	begin try
		...
		select
			...
			,@RegistrantAppResponseSID = scope_identity()												-- capture key value of new row
