...
GO
CREATE PROCEDURE [dbo].[pCatalogItemPriceProration#Delete]
	 @CatalogItemPriceProrationSID int               = null -- required! id of row to delete - must be set in custom logic if not passed
	,@UpdateUser                   nvarchar(75)      = null -- set to current application user unless "SystemUser" passed
	,@RowStamp                     timestamp         = null -- row time stamp - pass for preemptive check for overwrites
	,@CatalogItemPriceSID          int               = null
	...
	,@CatalogItemPricePrice        decimal(11,2)     = null
	,@EffectiveTime                datetime          = null
	,@CatalogItemPriceRowGUID      uniqueidentifier  = null
	,@IsDeleteEnabled              bit               = null
	,@zContext                     xml               = null -- other values defining context for the delete (if any)
	,@FiscalStartMonthDay          smallint          = null
as
/*********************************************************************************************************************************
Procedure : dbo.pCatalogItemPriceProration#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.CatalogItemPriceProration table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.CatalogItemPriceProration table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pCatalogItemPriceProration procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.CatalogItemPriceProration x where x.CatalogItemPriceProrationSID = @CatalogItemPriceProrationSID
