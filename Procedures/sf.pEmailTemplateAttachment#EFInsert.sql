...
GO
CREATE PROCEDURE [sf].[pEmailTemplateAttachment#EFInsert]
...
as
/*********************************************************************************************************************************
Procedure : sf.pEmailTemplateAttachment#EFInsert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : Alternate call syntax for pEmailTemplateAttachment#Insert for use with MS Entity Framework (does not declare PK output parameter)
-----------------------------------------------------------------------------------------------------------------------------------
...
begin
	...
	begin try
		...
		exec @errorNo = sf.pEmailTemplateAttachment#Insert
