...
GO
CREATE PROCEDURE [dbo].[pRegistrantLearningPlanStatus#Insert]
	 @RegistrantLearningPlanStatusSID int               = null output				-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : dbo.pRegistrantLearningPlanStatus#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the dbo.RegistrantLearningPlanStatus table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.RegistrantLearningPlanStatus table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vRegistrantLearningPlanStatus entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @RegistrantLearningPlanStatusSID = null															-- initialize output parameter
	...
	begin try
		...
		select
			...
			,@RegistrantLearningPlanStatusSID = scope_identity()								-- capture key value of new row
