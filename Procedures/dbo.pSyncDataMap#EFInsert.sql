...
GO
CREATE PROCEDURE [dbo].[pSyncDataMap#EFInsert]
...
as
/*********************************************************************************************************************************
Procedure : dbo.pSyncDataMap#EFInsert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : Alternate call syntax for pSyncDataMap#Insert for use with MS Entity Framework (does not declare PK output parameter)
-----------------------------------------------------------------------------------------------------------------------------------
...
begin
	...
	begin try
		...
		exec @errorNo = dbo.pSyncDataMap#Insert
