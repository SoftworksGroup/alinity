...
GO
CREATE PROCEDURE [dbo].[pExamQuestionReference#Insert]
	 @ExamQuestionReferenceSID int               = null output							-- identity value assigned to the new record
	,@ExamQuestionSID          int               = null											-- required! if not passed value must be set in custom logic prior to insert
	,@ReferenceTitle           nvarchar(125)     = null											-- required! if not passed value must be set in custom logic prior to insert
	,@ReferenceURL             varchar(250)      = null											-- required! if not passed value must be set in custom logic prior to insert
	...
	,@Sequence                 smallint          = null											-- not a base table column (default ignored)
...
as
/*********************************************************************************************************************************
Procedure : dbo.pExamQuestionReference#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the dbo.ExamQuestionReference table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.ExamQuestionReference table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vExamQuestionReference entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @ExamQuestionReferenceSID = null																		-- initialize output parameter
	...
	begin try
		...
		select
			...
			,@ExamQuestionReferenceSID = scope_identity()												-- capture key value of new row
