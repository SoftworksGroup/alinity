...
GO
CREATE PROCEDURE [sf].[pUnitTestAssertion#Delete]
	 @UnitTestAssertionSID int               = null -- required! id of row to delete - must be set in custom logic if not passed
	,@UpdateUser           nvarchar(75)      = null -- set to current application user unless "SystemUser" passed
	,@RowStamp             timestamp         = null -- row time stamp - pass for preemptive check for overwrites
	,@UnitTestSID          int               = null
	...
	,@UnitTestIsDefault    bit               = null
	,@UnitTestRowGUID      uniqueidentifier  = null
	,@IsDeleteEnabled      bit               = null
	,@zContext             xml               = null -- other values defining context for the delete (if any)
as
/*********************************************************************************************************************************
Procedure : sf.pUnitTestAssertion#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.UnitTestAssertion table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.UnitTestAssertion table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pUnitTestAssertion procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.UnitTestAssertion x where x.UnitTestAssertionSID = @UnitTestAssertionSID
