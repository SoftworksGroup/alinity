...
GO
CREATE PROCEDURE [dbo].[pTaxConfiguration#Delete]
	 @TaxConfigurationSID       int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@GLAccountIsActive         bit               = null
	,@GLAccountRowGUID          uniqueidentifier  = null
	,@TaxLabel                  nvarchar(35)      = null
	,@TaxSequence               tinyint           = null
	,@TaxRowGUID                uniqueidentifier  = null
	,@IsDeleteEnabled           bit               = null
	,@zContext                  xml               = null -- other values defining context for the delete (if any)
	,@ExpiryTime                datetime          = null
as
/*********************************************************************************************************************************
Procedure : dbo.pTaxConfiguration#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.TaxConfiguration table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.TaxConfiguration table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pTaxConfiguration procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.TaxConfiguration x where x.TaxConfigurationSID = @TaxConfigurationSID
