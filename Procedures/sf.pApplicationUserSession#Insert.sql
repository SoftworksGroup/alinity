...
GO
CREATE PROCEDURE [sf].[pApplicationUserSession#Insert]
	 @ApplicationUserSessionSID        int               = null output			-- identity value assigned to the new record
	,@ApplicationUserSID               int               = null							-- required! if not passed value must be set in custom logic prior to insert
	,@IsActive                         bit               = null							-- default: (1)
	,@IPAddress                        varchar(45)       = null							-- default: (0)
...
as
/*********************************************************************************************************************************
Procedure : sf.pApplicationUserSession#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the sf.ApplicationUserSession table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.ApplicationUserSession table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vApplicationUserSession entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @ApplicationUserSessionSID = null																		-- initialize output parameter
	...
	begin try
		...
		set @IPAddress = isnull(@IPAddress,(0))
		...
		select
			...
			,@ApplicationUserSessionSID = scope_identity()											-- capture key value of new row
