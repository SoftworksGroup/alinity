...
GO
CREATE PROCEDURE [dbo].[pPracticeRegister#Delete]
	 @PracticeRegisterSID                      int               = null -- required! id of row to delete - must be set in custom logic if not passed
	,@UpdateUser                               nvarchar(75)      = null -- set to current application user unless "SystemUser" passed
	,@RowStamp                                 timestamp         = null -- row time stamp - pass for preemptive check for overwrites
	,@PracticeRegisterTypeSID                  int               = null
	...
	,@PracticeRegisterTypeSCD                  varchar(15)       = null
	,@PracticeRegisterTypeLabel                nvarchar(35)      = null
	,@PracticeRegisterTypeCategory             nvarchar(65)      = null
	,@PracticeRegisterTypeIsDefault            bit               = null
	,@PracticeRegisterTypeIsActive             bit               = null
	,@PracticeRegisterTypeRowGUID              uniqueidentifier  = null
	,@RegistrationScheduleLabel                nvarchar(35)      = null
	,@RegistrationScheduleIsDefault            bit               = null
	,@RegistrationScheduleIsActive             bit               = null
	,@RegistrationScheduleRowGUID              uniqueidentifier  = null
	...
	,@RegistrantAppFormVersionSID              int               = null
	,@RegistrantAppVerificationFormVersionSID  int               = null
	,@RegistrantRenewalFormVersionSID          int               = null
	,@RegistrantRenewalReviewFormVersionSID    int               = null
	,@CompetenceReviewFormVersionSID           int               = null
	,@CompetenceReviewAssessmentFormVersionSID int               = null
	,@CurrentRegistrationYear                  smallint          = null
	,@CurrentRenewalYear                       smallint          = null
	,@CurrentReinstatementYear                 smallint          = null
	,@NextReinstatementYear                    smallint          = null
	,@IsCurrentUserVerifier                    bit               = null
	,@IsLearningModelApplied                   bit               = null
as
/*********************************************************************************************************************************
Procedure : dbo.pPracticeRegister#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.PracticeRegister table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.PracticeRegister table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pPracticeRegister procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.PracticeRegister x where x.PracticeRegisterSID = @PracticeRegisterSID
