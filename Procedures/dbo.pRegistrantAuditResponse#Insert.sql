...
GO
CREATE PROCEDURE [dbo].[pRegistrantAuditResponse#Insert]
	 @RegistrantAuditResponseSID int               = null output						-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : dbo.pRegistrantAuditResponse#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the dbo.RegistrantAuditResponse table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.RegistrantAuditResponse table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vRegistrantAuditResponse entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @RegistrantAuditResponseSID = null																	-- initialize output parameter
	...
	begin try
		...
		select
			...
			,@RegistrantAuditResponseSID = scope_identity()											-- capture key value of new row
