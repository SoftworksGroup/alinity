...
GO
CREATE PROCEDURE [sf].[pBusinessRule#Delete]
	 @BusinessRuleSID          int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@MessageRowGUID           uniqueidentifier  = null
	...
	,@IsNewStatusOn            bit               = null
	,@RuleStatusLabel          nvarchar(15)      = null
	,@DataStatusLabel          nvarchar(15)      = null
as
/*********************************************************************************************************************************
Procedure : sf.pBusinessRule#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.BusinessRule table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.BusinessRule table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pBusinessRule procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.BusinessRule x where x.BusinessRuleSID = @BusinessRuleSID
    ...
    -- the deletion option based on the value returned from the IsDeleteEnabled function
		-- in the #Ext view.
    set @IsDeleteEnabled = sf.fBusinessRule#IsDeleteEnabled(@BusinessRuleSID)
    ...
    --! </PreDelete>
		...
		update																																-- set audit details on sf.BusinessRuleError rows that will delete through CASCADE
