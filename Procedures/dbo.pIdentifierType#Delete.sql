...
GO
CREATE PROCEDURE [dbo].[pIdentifierType#Delete]
	 @IdentifierTypeSID              int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@OrgCitySID                     int               = null
	,@OrgCityName                    nvarchar(30)      = null
	,@OrgCountrySID                  int               = null
	,@OrgCountryName                 nvarchar(50)      = null
as
/*********************************************************************************************************************************
Procedure : dbo.pIdentifierType#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.IdentifierType table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.IdentifierType table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pIdentifierType procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.IdentifierType x where x.IdentifierTypeSID = @IdentifierTypeSID
