...
GO
CREATE PROCEDURE [sf].[pApplicationEntity#Delete]
	 @ApplicationEntitySID           int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@BaseTableSchemaName            nvarchar(128)     = null
	,@BaseTableName                  nvarchar(128)     = null
	,@BaseTableObjectID              int               = null
	,@BaseTableDescription           nvarchar(max)     = null
	,@TotalRows                      bigint            = null
	,@BusinessRuleErrorCount         int               = null
	,@PendingBusinessRuleCount       int               = null
	,@ClientBusinessRuleCount        int               = null
	,@MandatoryBusinessRuleCount     int               = null
	,@OptionalBusinessRuleCount      int               = null
	,@BusinessRuleCount              int               = null
	,@IsConstraintEnabled            bit               = null
	,@IsCheckFunctionDeployed        bit               = null
	,@IsExtCheckFunctionDeployed     bit               = null
	,@ExtendedFunctionName           nvarchar(257)     = null
	,@DataStatus                     char(1)           = null
	,@DataStatusLabel                nvarchar(15)      = null
	,@DataStatusNote                 nvarchar(150)     = null
	,@ReflectionApplicationEntitySCD varchar(8000)     = null
as
/*********************************************************************************************************************************
Procedure : sf.pApplicationEntity#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.ApplicationEntity table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.ApplicationEntity table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pApplicationEntity procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.ApplicationEntity x where x.ApplicationEntitySID = @ApplicationEntitySID
...
-- Ensure the row can be deleted. This error should not appear if the UI is enabling
    -- the deletion option based on the value returned from the IsDeleteEnabled function
		-- in the #Ext view.
    set @IsDeleteEnabled = sf.fApplicationEntity#IsDeleteEnabled(@ApplicationEntitySID)
   ...
   begin
      ...
      exec sf.pMessage#Get
        ...
        ,@MessageText   = @errorText output
        ,@DefaultText   = N'Deletion of this %1 record is not allowed because the table contains System Code.'
        ,@Arg1          = N'application entity'
