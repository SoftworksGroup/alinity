...
GO
CREATE PROCEDURE [dbo].[pRegistrantCredential#Delete]
	 @RegistrantCredentialSID        int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@FieldOfStudyName               nvarchar(50)      = null
	,@FieldOfStudyCode               varchar(20)       = null
	,@FieldOfStudyCategory           nvarchar(65)      = null
	,@FieldOfStudyIsDefault          bit               = null
	,@FieldOfStudyIsActive           bit               = null
	,@FieldOfStudyRowGUID            uniqueidentifier  = null
	,@PersonSID                      int               = null
...
as
/*********************************************************************************************************************************
Procedure : dbo.pRegistrantCredential#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.RegistrantCredential table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.RegistrantCredential table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pRegistrantCredential procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.RegistrantCredential x where x.RegistrantCredentialSID = @RegistrantCredentialSID
