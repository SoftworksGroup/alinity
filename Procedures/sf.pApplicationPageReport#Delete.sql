...
GO
CREATE PROCEDURE [sf].[pApplicationPageReport#Delete]
	 @ApplicationPageReportSID int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@ApplicationReportName    nvarchar(65)      = null
	,@IconFillColor            char(9)           = null
	,@DisplayRank              tinyint           = null
	,@IsCustom                 bit               = null
	,@ApplicationReportRowGUID uniqueidentifier  = null
	,@IsDeleteEnabled          bit               = null
	,@zContext                 xml               = null -- other values defining context for the delete (if any)
as
/*********************************************************************************************************************************
Procedure : sf.pApplicationPageReport#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.ApplicationPageReport table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.ApplicationPageReport table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pApplicationPageReport procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.ApplicationPageReport x where x.ApplicationPageReportSID = @ApplicationPageReportSID
