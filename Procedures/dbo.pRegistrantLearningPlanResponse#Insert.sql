...
GO
CREATE PROCEDURE [dbo].[pRegistrantLearningPlanResponse#Insert]
	 @RegistrantLearningPlanResponseSID int               = null output			-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : dbo.pRegistrantLearningPlanResponse#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the dbo.RegistrantLearningPlanResponse table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.RegistrantLearningPlanResponse table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vRegistrantLearningPlanResponse entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @RegistrantLearningPlanResponseSID = null														-- initialize output parameter
	...
	begin try
		...
		select
			...
			,@RegistrantLearningPlanResponseSID = scope_identity()							-- capture key value of new row
