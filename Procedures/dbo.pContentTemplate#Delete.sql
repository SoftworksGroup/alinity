...
GO
CREATE PROCEDURE [dbo].[pContentTemplate#Delete]
	 @ContentTemplateSID   int               = null -- required! id of row to delete - must be set in custom logic if not passed
	,@UpdateUser           nvarchar(75)      = null -- set to current application user unless "SystemUser" passed
	,@RowStamp             timestamp         = null -- row time stamp - pass for preemptive check for overwrites
	,@ContentTemplateSCD   varchar(15)       = null
...
as
/*********************************************************************************************************************************
Procedure : dbo.pContentTemplate#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.ContentTemplate table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.ContentTemplate table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pContentTemplate procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.ContentTemplate x where x.ContentTemplateSID = @ContentTemplateSID
