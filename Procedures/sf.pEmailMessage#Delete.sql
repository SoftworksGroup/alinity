...
GO
CREATE PROCEDURE [sf].[pEmailMessage#Delete]
	 @EmailMessageSID                  int               = null -- required! id of row to delete - must be set in custom logic if not passed
	,@UpdateUser                       nvarchar(75)      = null -- set to current application user unless "SystemUser" passed
	,@RowStamp                         timestamp         = null -- row time stamp - pass for preemptive check for overwrites
	,@SenderEmailAddress               varchar(150)      = null
	...
	,@FileTypeFileTypeSCD              varchar(8)        = null
	,@FileTypeLabel                    nvarchar(35)      = null
	,@MimeType                         varchar(255)      = null
	,@IsInline                         bit               = null
	,@FileTypeIsActive                 bit               = null
	,@FileTypeRowGUID                  uniqueidentifier  = null
	,@MessageLinkSCD                   varchar(30)       = null
	,@MessageLinkLabel                 nvarchar(35)      = null
	,@ApplicationPageSID               int               = null
	,@MessageLinkRowGUID               uniqueidentifier  = null
	,@ApplicationEntitySCD             varchar(50)       = null
	,@ApplicationEntityName            nvarchar(50)      = null
	,@IsMergeDataSource                bit               = null
	,@ApplicationEntityRowGUID         uniqueidentifier  = null
	,@ApplicationGrantSCD              varchar(30)       = null
	,@ApplicationGrantName             nvarchar(150)     = null
	,@ApplicationGrantIsDefault        bit               = null
	,@ApplicationGrantRowGUID          uniqueidentifier  = null
	,@PersonSID                        int               = null
	,@CultureSID                       int               = null
	...
	,@LinkURI                          varchar(150)      = null
	,@MessageStatusSCD                 varchar(10)       = null
	,@MessageStatusLabel               nvarchar(35)      = null
	,@RecipientCount                   int               = null
	,@NotReceivedCount                 int               = null
	,@IsQueued                         bit               = null
	,@IsSent                           bit               = null
	...
	,@SentTimeLast                     datetimeoffset(7) = null
	,@SentCount                        int               = null
	,@NotSentCount                     int               = null
	,@IsEditEnabled                    bit               = null
	,@IsLinkEmbedded                   bit               = null
	,@QueuingTime                      datetimeoffset(7) = null
	,@RecipientPersonSID               int               = null
as
/*********************************************************************************************************************************
Procedure : sf.pEmailMessage#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.EmailMessage table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.EmailMessage table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pEmailMessage procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.EmailMessage x where x.EmailMessageSID = @EmailMessageSID
		...
		update																																-- set audit details on sf.EmailMessageAttachment rows that will delete through CASCADE
		...
		update																																-- set audit details on sf.PersonEmailMessage rows that will delete through CASCADE
