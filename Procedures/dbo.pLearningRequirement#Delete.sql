...
GO
CREATE PROCEDURE [dbo].[pLearningRequirement#Delete]
	 @LearningRequirementSID          int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@UnitTypeLabel                   nvarchar(35)      = null
	,@LearningRequirementProrationSID int               = null
	,@CurrentRequiredUnits            decimal(5,2)      = null
	,@IsProrated                      bit               = null
as
/*********************************************************************************************************************************
Procedure : dbo.pLearningRequirement#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.LearningRequirement table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.LearningRequirement table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pLearningRequirement procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.LearningRequirement x where x.LearningRequirementSID = @LearningRequirementSID
