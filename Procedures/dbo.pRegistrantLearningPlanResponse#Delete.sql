...
GO
CREATE PROCEDURE [dbo].[pRegistrantLearningPlanResponse#Delete]
	 @RegistrantLearningPlanResponseSID int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@IsAssignee                        bit               = null
	,@FormOwnerRowGUID                  uniqueidentifier  = null
...
as
/*********************************************************************************************************************************
Procedure : dbo.pRegistrantLearningPlanResponse#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.RegistrantLearningPlanResponse table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.RegistrantLearningPlanResponse table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pRegistrantLearningPlanResponse procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.RegistrantLearningPlanResponse x where x.RegistrantLearningPlanResponseSID = @RegistrantLearningPlanResponseSID
