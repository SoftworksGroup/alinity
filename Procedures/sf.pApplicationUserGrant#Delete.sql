...
GO
CREATE PROCEDURE [sf].[pApplicationUserGrant#Delete]
	 @ApplicationUserGrantSID          int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@ModuleSCD                        varchar(30)       = null
as
/*********************************************************************************************************************************
Procedure : sf.pApplicationUserGrant#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.ApplicationUserGrant table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.ApplicationUserGrant table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pApplicationUserGrant procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.ApplicationUserGrant x where x.ApplicationUserGrantSID = @ApplicationUserGrantSID
    ...
    -- the deletion option based on the value returned from the IsDeleteEnabled function
		-- in the #Ext view.
    set @IsDeleteEnabled = sf.fApplicationUserGrant#IsDeleteEnabled(@ApplicationUserGrantSID)
