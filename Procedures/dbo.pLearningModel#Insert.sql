...
GO
CREATE PROCEDURE [dbo].[pLearningModel#Insert]
	 @LearningModelSID    int               = null output										-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : dbo.pLearningModel#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the dbo.LearningModel table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.LearningModel table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vLearningModel entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @LearningModelSID = null																						-- initialize output parameter
	...
	begin try
		...
		set @CycleLengthYears = isnull(@CycleLengthYears,(1))
		set @IsCycleStartedYear1 = isnull(@IsCycleStartedYear1,CONVERT(bit,(0)))
		...
		begin
			...
			select @recordSID = x.LearningModelSID from dbo.LearningModel x where x.IsDefault = @ON
		...
		select
			...
			,@LearningModelSID = scope_identity()																-- capture key value of new row
