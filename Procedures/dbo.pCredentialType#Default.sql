...
GO
CREATE PROCEDURE [dbo].[pCredentialType#Default]
...
as
/*********************************************************************************************************************************
Procedure : dbo.pCredentialType#Default
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : provides a blank row with default values for presentation in the UI for "new" dbo.CredentialType records
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.CredentialType table. When a new record is to be added from the UI, this procedure
...
columns of the vCredentialType entity view, however, only some values (as noted above) are eligible for default setting.  The other
...
product and applies to all client configurations. Client-specific customizations must be implemented in the ext.pCredentialType
procedure. The extended procedure is only called where it exists in database. The parameter "@Mode" is set to "default.pre" to
advise ext.pCredentialType of the context of the call. All other parameters are also passed, however, only those parameters eligible
...
begin
	...
	declare
		...
		,@credentialTypeSID      int               = -1												-- specific default required by EF - do not override
		,@credentialTypeLabel    nvarchar(35)      = null											-- no default provided from DB constraint - OK to override
		,@credentialTypeCategory nvarchar(65)      = null											-- no default provided from DB constraint - OK to override
		...
		,@credentialTypeXID      varchar(150)      = null											-- no default provided from DB constraint - OK to override
	...
	begin try
		...
		select
			...
			,@credentialTypeCategory  = isnull(context.node.value('@CredentialTypeCategory','nvarchar(65)' ),@credentialTypeCategory)
			...
			,@credentialTypeXID       = isnull(context.node.value('@CredentialTypeXID'     ,'varchar(150)' ),@credentialTypeXID)
