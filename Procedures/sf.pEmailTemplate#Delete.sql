...
GO
CREATE PROCEDURE [sf].[pEmailTemplate#Delete]
	 @EmailTemplateSID          int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@IsDefaultEmailTemplate    bit               = null
as
/*********************************************************************************************************************************
Procedure : sf.pEmailTemplate#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.EmailTemplate table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.EmailTemplate table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pEmailTemplate procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.EmailTemplate x where x.EmailTemplateSID = @EmailTemplateSID
		...
		update																																-- set audit details on sf.EmailTemplateAttachment rows that will delete through CASCADE
