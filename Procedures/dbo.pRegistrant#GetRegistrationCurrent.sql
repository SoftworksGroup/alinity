...
GO
CREATE PROCEDURE dbo.pRegistrant#GetRegistrationCurrent
...
as
/*********************************************************************************************************************************
Sproc    : Registrant - Get Registration Current
Notice   : Copyright © 2017 Softworks Group Inc.
Summary  : Returns current (active) registration record for the given registrant
----------------------------------------------------------------------------------------------------------------------------------
...
Comments	
--------
This procedure is a wrapper for the dbo.fRegistrant#RegistrationCurrent table function. See the function documentation for
details.
...
begin
	...
	exec dbo.pRegistrant#GetRegistrationCurrent
...
exec sf.pUnitTest#Execute
	 @ObjectName = 'dbo.pRegistrant#GetRegistrationCurrent'
	,@DefaultTestOnly = 1
------------------------------------------------------------------------------------------------------------------------------- */
...
begin
	...
	begin try
		...
		select
			--!<ColumnList DataSource="fRegistrant#RegistrationCurrent" Alias="r">
			 r.RegistrantSID
			,r.RegistrantNo
			,r.RegistrationSID
			,r.RegistrationNo
		...
		--!</ColumnList>
		from
			dbo.fRegistrant#RegistrationCurrent(@RegistrantSID) r;
