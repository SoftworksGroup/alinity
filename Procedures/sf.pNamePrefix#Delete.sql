...
GO
CREATE PROCEDURE [sf].[pNamePrefix#Delete]
	 @NamePrefixSID      int               = null -- required! id of row to delete - must be set in custom logic if not passed
...
as
/*********************************************************************************************************************************
Procedure : sf.pNamePrefix#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.NamePrefix table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.NamePrefix table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pNamePrefix procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.NamePrefix x where x.NamePrefixSID = @NamePrefixSID
    ...
    -- the deletion option based on the value returned from the IsDeleteEnabled function
		-- in the #Ext view.
    set @IsDeleteEnabled = sf.fNamePrefix#IsDeleteEnabled(@NamePrefixSID)
