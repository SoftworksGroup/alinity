...
GO
CREATE PROCEDURE [sf].[pPersonOtherName#Delete]
	 @PersonOtherNameSID     int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@OtherNameTypeLabel     nvarchar(35)      = null
	,@OtherNameTypeIsDefault bit               = null
	,@OtherNameTypeIsActive  bit               = null
	,@OtherNameTypeRowGUID   uniqueidentifier  = null
	,@GenderSID              int               = null
...
as
/*********************************************************************************************************************************
Procedure : sf.pPersonOtherName#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.PersonOtherName table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.PersonOtherName table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pPersonOtherName procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.PersonOtherName x where x.PersonOtherNameSID = @PersonOtherNameSID
