...
GO
CREATE PROCEDURE [sf].[pTextTemplate#Insert]
	 @TextTemplateSID           int               = null output							-- identity value assigned to the new record
	,@TextTemplateLabel         nvarchar(35)      = null										-- required! if not passed value must be set in custom logic prior to insert
...
as
/*********************************************************************************************************************************
Procedure : sf.pTextTemplate#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the sf.TextTemplate table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.TextTemplate table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vTextTemplate entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @TextTemplateSID = null																							-- initialize output parameter
	...
	begin try
		...
		select
			...
			,@TextTemplateSID = scope_identity()																-- capture key value of new row
