...
GO
CREATE PROCEDURE [dbo].[pRegistrantRenewalStatus#Insert]
	 @RegistrantRenewalStatusSID int               = null output						-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : dbo.pRegistrantRenewalStatus#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the dbo.RegistrantRenewalStatus table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.RegistrantRenewalStatus table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vRegistrantRenewalStatus entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @RegistrantRenewalStatusSID = null																	-- initialize output parameter
	...
	begin try
		...
		select
			...
			,@RegistrantRenewalStatusSID = scope_identity()											-- capture key value of new row
