...
GO
CREATE PROCEDURE [dbo].[pOrgContact#EFInsert]
...
as
/*********************************************************************************************************************************
Procedure : dbo.pOrgContact#EFInsert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : Alternate call syntax for pOrgContact#Insert for use with MS Entity Framework (does not declare PK output parameter)
-----------------------------------------------------------------------------------------------------------------------------------
...
begin
	...
	begin try
		...
		exec @errorNo = dbo.pOrgContact#Insert
			 @OrgSID                         = @OrgSID
			,@PersonSID                      = @PersonSID
