...
GO
CREATE PROCEDURE [sf].[pEmailTemplateAttachment#Insert]
	 @EmailTemplateAttachmentSID int               = null output						-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : sf.pEmailTemplateAttachment#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the sf.EmailTemplateAttachment table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.EmailTemplateAttachment table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vEmailTemplateAttachment entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @EmailTemplateAttachmentSID = null																	-- initialize output parameter
	...
	begin try
		...
		select
			...
			,@EmailTemplateAttachmentSID = scope_identity()											-- capture key value of new row
