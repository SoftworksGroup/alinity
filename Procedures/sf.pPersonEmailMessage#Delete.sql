...
GO
CREATE PROCEDURE [sf].[pPersonEmailMessage#Delete]
	 @PersonEmailMessageSID          int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@EmailMessageSubject            nvarchar(120)     = null
	,@EmailMessageFileTypeSCD        varchar(8)        = null
	,@EmailMessageFileTypeSID        int               = null
	,@IsApplicationUserRequired      bit               = null
	,@EmailMessageApplicationUserSID int               = null
	...
	,@EmailMessageCancelledTime      datetimeoffset(7) = null
	,@ArchivedTime                   datetimeoffset(7) = null
	,@PurgedTime                     datetimeoffset(7) = null
	,@EmailMessageRowGUID            uniqueidentifier  = null
	...
	,@EmailTriggerLabel              nvarchar(35)      = null
	,@EmailTemplateSID               int               = null
	,@QuerySID                       int               = null
	,@MinDaysToRepeat                int               = null
	,@EmailTriggerApplicationUserSID int               = null
	...
	,@EmailTriggerIsActive           bit               = null
	,@EmailTriggerRowGUID            uniqueidentifier  = null
	...
	,@IsReadGranted                  bit               = null
	,@SubjectSent                    nvarchar(120)     = null
	,@BodySent                       nvarchar(max)     = null
	...
	,@IsPurged                       bit               = null
	,@IsEmailOpenTracked             bit               = null
	,@IsNotReceived                  bit               = null
	,@FileAsName                     nvarchar(65)      = null
	,@FullName                       nvarchar(65)      = null
	,@DisplayName                    nvarchar(65)      = null
	,@AgeInYears                     int               = null
	,@CurrentEmailAddress            varchar(150)      = null
as
/*********************************************************************************************************************************
Procedure : sf.pPersonEmailMessage#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.PersonEmailMessage table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.PersonEmailMessage table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pPersonEmailMessage procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.PersonEmailMessage x where x.PersonEmailMessageSID = @PersonEmailMessageSID
