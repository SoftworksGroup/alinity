...
GO
CREATE PROCEDURE [dbo].[pExam#Insert]
	 @ExamSID                   int               = null output							-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : dbo.pExam#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the dbo.Exam table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.Exam table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vExam entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @ExamSID = null																											-- initialize output parameter
	...
	begin try
		...
		set @IsOnlineExam = isnull(@IsOnlineExam,CONVERT(bit,(0)))
		set @IsEnabledOnPortal = isnull(@IsEnabledOnPortal,CONVERT(bit,(0)))
		set @Sequence = isnull(@Sequence,(0))
		set @MinLagDaysBetweenAttempts = isnull(@MinLagDaysBetweenAttempts,(0))
		set @MaxAttemptsPerYear = isnull(@MaxAttemptsPerYear,(99))
		...
		select
			...
			,@ExamSID = scope_identity()																				-- capture key value of new row
