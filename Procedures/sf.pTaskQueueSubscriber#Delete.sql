...
GO
CREATE PROCEDURE [sf].[pTaskQueueSubscriber#Delete]
	 @TaskQueueSubscriberSID           int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@ApplicationUserDisplayName       nvarchar(65)      = null
as
/*********************************************************************************************************************************
Procedure : sf.pTaskQueueSubscriber#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.TaskQueueSubscriber table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.TaskQueueSubscriber table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pTaskQueueSubscriber procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.TaskQueueSubscriber x where x.TaskQueueSubscriberSID = @TaskQueueSubscriberSID
