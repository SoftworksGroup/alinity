...
GO
CREATE PROCEDURE dbo.pRegistrantAudit#ReviewReasons
...
as
/*********************************************************************************************************************************
Sproc    : Registrant Audit - Review Reasons
...
begin
	...
	exec dbo.pRegistrantAudit#ReviewReasons
		 @RegistrantAuditSID = -1
...
exec sf.pUnitTest#Execute
	@ObjectName = 'dbo.pRegistrantAudit#ReviewReasons'
 ,@DefaultTestOnly = 1
------------------------------------------------------------------------------------------------------------------------------- */
...
begin
	...
	begin try
		...
		select
			--!<ColumnList DataSource="dbo.fRegistrantAudit#ReviewReasons" Alias="rsn">
			 rsn.RegistrantAuditSID
			,rsn.ReasonSID
			,rsn.ReasonGroupSID
			,rsn.ReasonName
			,rsn.ReasonCode
		...
		--!</ColumnList>
		from
			dbo.fRegistrantAudit#ReviewReasons(@RegistrantAuditSID, @RegistrationYear) rsn;
