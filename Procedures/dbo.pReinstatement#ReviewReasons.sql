...
GO
CREATE PROCEDURE dbo.pReinstatement#ReviewReasons
...
as
/*********************************************************************************************************************************
Sproc    : Registrant Reinstatement - Review Reasons
...
begin
	...
	exec dbo.pReinstatement#ReviewReasons
		 @ReinstatementSID = -1
...
exec sf.pUnitTest#Execute
	@ObjectName = 'dbo.pReinstatement#ReviewReasons'
 ,@DefaultTestOnly = 1
------------------------------------------------------------------------------------------------------------------------------- */
...
begin
	...
	begin try
		...
		select
			--!<ColumnList DataSource="dbo.fReinstatement#ReviewReasons" Alias="rsn">
			 rsn.ReinstatementSID
			,rsn.ReasonSID
			,rsn.ReasonGroupSID
			,rsn.ReasonName
			,rsn.ReasonCode
		...
		--!</ColumnList>
		from
			dbo.fReinstatement#ReviewReasons(@ReinstatementSID, @RegistrationYear) rsn;
