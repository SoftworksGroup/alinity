...
GO
CREATE PROCEDURE dbo.pRegistrantApp#ReviewReasons
...
as
/*********************************************************************************************************************************
Sproc    : Registrant Application - Review Reasons
...
begin
	...
	exec dbo.pRegistrantApp#ReviewReasons
		 @RegistrantAppSID = -1
...
exec sf.pUnitTest#Execute
	@ObjectName = 'dbo.pRegistrantApp#ReviewReasons'
 ,@DefaultTestOnly = 1
------------------------------------------------------------------------------------------------------------------------------- */
...
begin
	...
	begin try
		...
		select
			--!<ColumnList DataSource="dbo.fRegistrantApp#ReviewReasons" Alias="rsn">
			 rsn.RegistrantAppSID
			,rsn.ReasonSID
			,rsn.ReasonGroupSID
			,rsn.ReasonName
			,rsn.ReasonCode
		...
		--!</ColumnList>
		from
			dbo.fRegistrantApp#ReviewReasons(@RegistrantAppSID, @RegistrationYear) rsn;
