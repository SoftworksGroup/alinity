...
GO
CREATE PROCEDURE [dbo].[pGLTransaction#Delete]
	 @GLTransactionSID            int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@PaymentGLPostingDate        date              = null
	...
	,@PaymentCancelledTime        datetimeoffset(7) = null
	,@PaymentReasonSID            int               = null
	,@PaymentRowGUID              uniqueidentifier  = null
	,@InvoiceSID                  int               = null
	,@InvoicePaymentPaymentSID    int               = null
	,@AmountApplied               decimal(11,2)     = null
	,@AppliedDate                 date              = null
	,@InvoicePaymentGLPostingDate date              = null
	,@InvoicePaymentCancelledTime datetimeoffset(7) = null
	,@InvoicePaymentReasonSID     int               = null
	,@InvoicePaymentRowGUID       uniqueidentifier  = null
	,@IsDeleteEnabled             bit               = null
	,@zContext                    xml               = null -- other values defining context for the delete (if any)
	,@IsEditEnabled               bit               = null
	,@FullDebitAccountLabel       nvarchar(86)      = null
	,@FullCreditAccountLabel      nvarchar(86)      = null
	,@IsReversing                 bit               = null
	,@IsReversed                  bit               = null
as
/*********************************************************************************************************************************
Procedure : dbo.pGLTransaction#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.GLTransaction table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.GLTransaction table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pGLTransaction procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.GLTransaction x where x.GLTransactionSID = @GLTransactionSID
