...
GO
CREATE PROCEDURE [sf].[pEmailTemplateAttachment#Delete]
	 @EmailTemplateAttachmentSID int               = null -- required! id of row to delete - must be set in custom logic if not passed
...
as
/*********************************************************************************************************************************
Procedure : sf.pEmailTemplateAttachment#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.EmailTemplateAttachment table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.EmailTemplateAttachment table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pEmailTemplateAttachment procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.EmailTemplateAttachment x where x.EmailTemplateAttachmentSID = @EmailTemplateAttachmentSID
