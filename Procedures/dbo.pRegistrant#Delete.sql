...
GO
CREATE PROCEDURE [dbo].[pRegistrant#Delete]
	 @RegistrantSID                  int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@IsSectionDisplayedOnLicense    bit               = null
	,@LicenseRegistrationYear        smallint          = null
	,@RenewalRegistrationYear        smallint          = null
	,@HasOpenAudit                   bit               = null
as
/*********************************************************************************************************************************
Procedure : dbo.pRegistrant#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.Registrant table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.Registrant table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pRegistrant procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.Registrant x where x.RegistrantSID = @RegistrantSID
		...
		update																																-- set audit details on dbo.RegistrantIdentifier rows that will delete through CASCADE
