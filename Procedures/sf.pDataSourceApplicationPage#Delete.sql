...
GO
CREATE PROCEDURE [sf].[pDataSourceApplicationPage#Delete]
	 @DataSourceApplicationPageSID int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@DataSourceLabel              nvarchar(35)      = null
	...
	,@DataSourceRowGUID            uniqueidentifier  = null
	,@IsDeleteEnabled              bit               = null
	,@zContext                     xml               = null -- other values defining context for the delete (if any)
as
/*********************************************************************************************************************************
Procedure : sf.pDataSourceApplicationPage#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.DataSourceApplicationPage table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.DataSourceApplicationPage table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pDataSourceApplicationPage procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.DataSourceApplicationPage x where x.DataSourceApplicationPageSID = @DataSourceApplicationPageSID
