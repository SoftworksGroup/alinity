...
GO
CREATE PROCEDURE [dbo].[pRegistrationSnapshot#Delete]
	 @RegistrationSnapshotSID           int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@RegistrationSnapshotTypeIsDefault bit               = null
	,@RegistrationSnapshotTypeIsActive  bit               = null
	,@RegistrationSnapshotTypeRowGUID   uniqueidentifier  = null
	,@JobSID                            int               = null
	...
	,@JobRunRowGUID                     uniqueidentifier  = null
	,@IsDeleteEnabled                   bit               = null
	,@zContext                          xml               = null -- other values defining context for the delete (if any)
	,@IsLocked                          bit               = null
	,@IsLockEnabled                     bit               = null
	,@IsUnlockEnabled                   bit               = null
	,@IsUpdateEnabled                   bit               = null
	,@ProfileCount                      int               = null
	,@InValidCount                      int               = null
	,@ModifiedCount                     int               = null
	,@QueuedDateCTZ                     date              = null
	,@QueuedTimeCTZ                     time(7)           = null
	,@QueuedDateTimeCTZ                 datetime          = null
	,@RegistrationYearLabel             varchar(25)       = null
	,@SnapshotStatusLabel               nvarchar(35)      = null
	,@LastCodeUpdateStatus              nvarchar(4000)    = null
	,@LastVerifiedStatus                nvarchar(4000)    = null
as
/*********************************************************************************************************************************
Procedure : dbo.pRegistrationSnapshot#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.RegistrationSnapshot table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.RegistrationSnapshot table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pRegistrationSnapshot procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.RegistrationSnapshot x where x.RegistrationSnapshotSID = @RegistrationSnapshotSID
		...
		update																																-- set audit details on dbo.RegistrationProfile rows that will delete through CASCADE
