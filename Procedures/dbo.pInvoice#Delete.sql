...
GO
CREATE PROCEDURE [dbo].[pInvoice#Delete]
	 @InvoiceSID                  int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@InvoiceLabel                nvarchar(4000)    = null
	,@InvoiceShortLabel           nvarchar(4000)    = null
	,@TotalBeforeTax              decimal(11,2)     = null
	,@Tax1Total                   decimal(11,2)     = null
	,@Tax2Total                   decimal(11,2)     = null
	,@Tax3Total                   decimal(11,2)     = null
	,@TotalAdjustment             decimal(11,2)     = null
	,@TotalAfterTax               decimal(11,2)     = null
	...
	,@IsOverPaid                  bit               = null
	,@IsOverDue                   bit               = null
	,@Tax1GLAccountLabel          nvarchar(35)      = null
	,@Tax1IsTaxAccount            bit               = null
	,@Tax2GLAccountLabel          nvarchar(35)      = null
	,@Tax2IsTaxAccount            bit               = null
	,@Tax3GLAccountLabel          nvarchar(35)      = null
	,@Tax3IsTaxAccount            bit               = null
	,@IsDeferred                  bit               = null
	,@IsCancelled                 bit               = null
	,@IsEditEnabled               bit               = null
	,@IsPAPSubscriber             bit               = null
	,@IsPAPEnabled                bit               = null
	,@AddressBlockForPrint        nvarchar(512)     = null
	,@AddressBlockForHTML         nvarchar(512)     = null
as
/*********************************************************************************************************************************
Procedure : dbo.pInvoice#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.Invoice table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.Invoice table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pInvoice procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.Invoice x where x.InvoiceSID = @InvoiceSID
		...
		update																																-- set audit details on dbo.InvoiceItem rows that will delete through CASCADE
			dbo.InvoiceItem
		set
