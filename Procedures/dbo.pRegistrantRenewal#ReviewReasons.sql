...
GO
CREATE PROCEDURE dbo.pRegistrantRenewal#ReviewReasons
...
as
/*********************************************************************************************************************************
Sproc    : Registrant Renewal - Review Reasons
...
begin
	...
	exec dbo.pRegistrantRenewal#ReviewReasons
		 @RegistrantRenewalSID = -1
...
exec sf.pUnitTest#Execute
	@ObjectName = 'dbo.pRegistrantRenewal#ReviewReasons'
 ,@DefaultTestOnly = 1
------------------------------------------------------------------------------------------------------------------------------- */
...
begin
	...
	begin try
		...
		select
			--!<ColumnList DataSource="dbo.fRegistrantRenewal#ReviewReasons" Alias="rsn">
			 rsn.RegistrantRenewalSID
			,rsn.ReasonSID
			,rsn.ReasonGroupSID
			,rsn.ReasonName
			,rsn.ReasonCode
		...
		--!</ColumnList>
		from
			dbo.fRegistrantRenewal#ReviewReasons(@RegistrantRenewalSID, @RegistrationYear) rsn;
