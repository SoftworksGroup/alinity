...
GO
CREATE PROCEDURE [sf].[pEmailTemplate#Insert]
	 @EmailTemplateSID          int               = null output							-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : sf.pEmailTemplate#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the sf.EmailTemplate table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.EmailTemplate table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vEmailTemplate entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @EmailTemplateSID = null																						-- initialize output parameter
	...
	begin try
		...
		select
			...
			,@EmailTemplateSID = scope_identity()																-- capture key value of new row
