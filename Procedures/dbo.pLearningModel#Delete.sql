...
GO
CREATE PROCEDURE [dbo].[pLearningModel#Delete]
	 @LearningModelSID    int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@UnitTypeIsDefault   bit               = null
	,@UnitTypeIsActive    bit               = null
	,@UnitTypeRowGUID     uniqueidentifier  = null
	,@IsDeleteEnabled     bit               = null
	,@zContext            xml               = null -- other values defining context for the delete (if any)
as
/*********************************************************************************************************************************
Procedure : dbo.pLearningModel#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.LearningModel table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.LearningModel table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pLearningModel procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.LearningModel x where x.LearningModelSID = @LearningModelSID
