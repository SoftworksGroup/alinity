...
GO
CREATE PROCEDURE [dbo].[pPAPSubscription#Delete]
	 @PAPSubscriptionSID     int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@IsActiveSubscription   bit               = null
	,@HasRejectedTrxs        bit               = null
	,@HasUnappliedAmount     bit               = null
	,@EmailAddress           varchar(150)      = null
	,@TrxCount               int               = null
	,@RejectedTrxCount       int               = null
	,@TotalUnapplied         decimal(38,2)     = null
as
/*********************************************************************************************************************************
Procedure : dbo.pPAPSubscription#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.PAPSubscription table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.PAPSubscription table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pPAPSubscription procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.PAPSubscription x where x.PAPSubscriptionSID = @PAPSubscriptionSID
