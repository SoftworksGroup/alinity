...
GO
CREATE PROCEDURE [dbo].[pTaxConfiguration#Insert]
	 @TaxConfigurationSID       int               = null output							-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : dbo.pTaxConfiguration#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the dbo.TaxConfiguration table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.TaxConfiguration table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vTaxConfiguration entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @TaxConfigurationSID = null																					-- initialize output parameter
	...
	begin try
		...
		select
			...
			,@TaxConfigurationSID = scope_identity()														-- capture key value of new row
