...
GO
CREATE PROCEDURE [dbo].[pExamQuestion#Delete]
	 @ExamQuestionSID          int               = null -- required! id of row to delete - must be set in custom logic if not passed
	,@UpdateUser               nvarchar(75)      = null -- set to current application user unless "SystemUser" passed
	,@RowStamp                 timestamp         = null -- row time stamp - pass for preemptive check for overwrites
	,@ExamSectionSID           int               = null
	...
	,@ExamSID                  int               = null
	,@ExamSectionSequence      smallint          = null
	...
	,@ExamSectionRowGUID       uniqueidentifier  = null
	,@KnowledgeDomainLabel     nvarchar(35)      = null
	,@KnowledgeDomainIsDefault bit               = null
	,@KnowledgeDomainIsActive  bit               = null
	,@KnowledgeDomainRowGUID   uniqueidentifier  = null
	,@IsDeleteEnabled          bit               = null
	,@zContext                 xml               = null -- other values defining context for the delete (if any)
as
/*********************************************************************************************************************************
Procedure : dbo.pExamQuestion#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.ExamQuestion table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.ExamQuestion table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pExamQuestion procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.ExamQuestion x where x.ExamQuestionSID = @ExamQuestionSID
