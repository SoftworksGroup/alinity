...
GO
CREATE PROCEDURE [dbo].[pRegistrantInactivePeriod#Delete]
	 @RegistrantInactivePeriodSID      int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@RegistrantInactiveReasonIsActive bit               = null
	,@RegistrantInactiveReasonRowGUID  uniqueidentifier  = null
	,@IsActive                         bit               = null
	,@IsPending                        bit               = null
...
as
/*********************************************************************************************************************************
Procedure : dbo.pRegistrantInactivePeriod#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.RegistrantInactivePeriod table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.RegistrantInactivePeriod table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pRegistrantInactivePeriod procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.RegistrantInactivePeriod x where x.RegistrantInactivePeriodSID = @RegistrantInactivePeriodSID
