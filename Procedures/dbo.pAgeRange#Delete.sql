...
GO
CREATE PROCEDURE [dbo].[pAgeRange#Delete]
	 @AgeRangeSID           int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@AgeRangeTypeIsDefault bit               = null
	,@AgeRangeTypeRowGUID   uniqueidentifier  = null
	,@IsDeleteEnabled       bit               = null
	,@zContext              xml               = null -- other values defining context for the delete (if any)
	,@DisplayOrder          bigint            = null
as
/*********************************************************************************************************************************
Procedure : dbo.pAgeRange#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.AgeRange table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.AgeRange table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pAgeRange procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.AgeRange x where x.AgeRangeSID = @AgeRangeSID
