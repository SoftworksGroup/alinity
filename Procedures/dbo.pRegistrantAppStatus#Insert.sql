...
GO
CREATE PROCEDURE [dbo].[pRegistrantAppStatus#Insert]
	 @RegistrantAppStatusSID     int               = null output						-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : dbo.pRegistrantAppStatus#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the dbo.RegistrantAppStatus table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.RegistrantAppStatus table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vRegistrantAppStatus entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @RegistrantAppStatusSID = null																			-- initialize output parameter
	...
	begin try
		...
		select
			...
			,@RegistrantAppStatusSID = scope_identity()													-- capture key value of new row
