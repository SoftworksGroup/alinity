...
GO
CREATE PROCEDURE [dbo].[pRecommendation#Delete]
	 @RecommendationSID          int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@RecommendationGroupRowGUID uniqueidentifier  = null
	,@IsDeleteEnabled            bit               = null
	,@zContext                   xml               = null -- other values defining context for the delete (if any)
as
/*********************************************************************************************************************************
Procedure : dbo.pRecommendation#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.Recommendation table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.Recommendation table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pRecommendation procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.Recommendation x where x.RecommendationSID = @RecommendationSID
