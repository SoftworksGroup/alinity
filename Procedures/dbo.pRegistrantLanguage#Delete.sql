...
GO
CREATE PROCEDURE [dbo].[pRegistrantLanguage#Delete]
	 @RegistrantLanguageSID          int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@LanguageLabel                  nvarchar(35)      = null
	,@LanguageIsDefault              bit               = null
	,@LanguageIsActive               bit               = null
	,@LanguageRowGUID                uniqueidentifier  = null
	,@PersonSID                      int               = null
...
as
/*********************************************************************************************************************************
Procedure : dbo.pRegistrantLanguage#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.RegistrantLanguage table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.RegistrantLanguage table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pRegistrantLanguage procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.RegistrantLanguage x where x.RegistrantLanguageSID = @RegistrantLanguageSID
