...
GO
CREATE PROCEDURE [dbo].[pLearningRequirementCompetenceType#Delete]
	 @LearningRequirementCompetenceTypeSID int               = null -- required! id of row to delete - must be set in custom logic if not passed
	,@UpdateUser                           nvarchar(75)      = null -- set to current application user unless "SystemUser" passed
	,@RowStamp                             timestamp         = null -- row time stamp - pass for preemptive check for overwrites
	,@LearningRequirementSID               int               = null
	...
	,@LearningRequirementRowGUID           uniqueidentifier  = null
	,@IsDeleteEnabled                      bit               = null
	,@zContext                             xml               = null -- other values defining context for the delete (if any)
as
/*********************************************************************************************************************************
Procedure : dbo.pLearningRequirementCompetenceType#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.LearningRequirementCompetenceType table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.LearningRequirementCompetenceType table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pLearningRequirementCompetenceType procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.LearningRequirementCompetenceType x where x.LearningRequirementCompetenceTypeSID = @LearningRequirementCompetenceTypeSID
