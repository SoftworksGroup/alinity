...
GO
CREATE PROCEDURE [dbo].[pComplaint#Delete]
	 @ComplaintSID                     int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@ComplainantTypeLabel             nvarchar(35)      = null
	,@ComplainantTypeCategory          nvarchar(65)      = null
	,@ComplainantTypeIsDefault         bit               = null
	,@ComplainantTypeIsActive          bit               = null
	,@ComplainantTypeRowGUID           uniqueidentifier  = null
	,@ComplaintSeverityLabel           nvarchar(35)      = null
	,@ComplaintSeverityCategory        nvarchar(65)      = null
	,@ComplaintSeverityIsDefault       bit               = null
	,@ComplaintSeverityIsActive        bit               = null
	,@ComplaintSeverityRowGUID         uniqueidentifier  = null
	,@ComplaintTypeLabel               nvarchar(35)      = null
	,@ComplaintTypeCategory            nvarchar(65)      = null
	,@ComplaintTypeIsDefault           bit               = null
	,@ComplaintTypeIsActive            bit               = null
	,@ComplaintTypeRowGUID             uniqueidentifier  = null
	...
	,@ComplaintLabel                   nvarchar(115)     = null
	,@IsDismissed                      bit               = null
	,@IsClosed                         bit               = null
	,@IsCloseEnabled                   bit               = null
	,@ComplaintProcessSID              int               = null
	,@ComplainantPersonSID             int               = null
	,@ComplaintStatusLabel             nvarchar(35)      = null
as
/*********************************************************************************************************************************
Procedure : dbo.pComplaint#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.Complaint table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.Complaint table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pComplaint procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.Complaint x where x.ComplaintSID = @ComplaintSID
