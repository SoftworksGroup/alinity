...
GO
CREATE PROCEDURE [sf].[pApplicationUserSessionProperty#EFInsert]
...
as
/*********************************************************************************************************************************
Procedure : sf.pApplicationUserSessionProperty#EFInsert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : Alternate call syntax for pApplicationUserSessionProperty#Insert for use with MS Entity Framework (does not declare PK output parameter)
-----------------------------------------------------------------------------------------------------------------------------------
...
begin
	...
	begin try
		...
		exec @errorNo = sf.pApplicationUserSessionProperty#Insert
