...
GO
CREATE PROCEDURE [sf].[pJobSchedule#Delete]
	 @JobScheduleSID        int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@StartTimeDateTime     datetime          = null
	,@EndTimeDateTime       datetime          = null
as
/*********************************************************************************************************************************
Procedure : sf.pJobSchedule#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.JobSchedule table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.JobSchedule table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pJobSchedule procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.JobSchedule x where x.JobScheduleSID = @JobScheduleSID
