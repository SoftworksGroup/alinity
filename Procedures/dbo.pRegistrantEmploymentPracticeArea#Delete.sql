...
GO
CREATE PROCEDURE [dbo].[pRegistrantEmploymentPracticeArea#Delete]
	 @RegistrantEmploymentPracticeAreaSID int               = null -- required! id of row to delete - must be set in custom logic if not passed
	,@UpdateUser                          nvarchar(75)      = null -- set to current application user unless "SystemUser" passed
	,@RowStamp                            timestamp         = null -- row time stamp - pass for preemptive check for overwrites
	,@RegistrantEmploymentSID             int               = null
	...
	,@PracticeAreaName                    nvarchar(50)      = null
	,@PracticeAreaCode                    varchar(20)       = null
	,@PracticeAreaCategory                nvarchar(65)      = null
	,@IsPracticeScopeRequired             bit               = null
	,@PracticeAreaIsDefault               bit               = null
	,@PracticeAreaIsActive                bit               = null
	,@PracticeAreaRowGUID                 uniqueidentifier  = null
	...
	,@RegistrantEmploymentRowGUID         uniqueidentifier  = null
	,@IsDeleteEnabled                     bit               = null
	,@zContext                            xml               = null -- other values defining context for the delete (if any)
as
/*********************************************************************************************************************************
Procedure : dbo.pRegistrantEmploymentPracticeArea#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.RegistrantEmploymentPracticeArea table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.RegistrantEmploymentPracticeArea table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pRegistrantEmploymentPracticeArea procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.RegistrantEmploymentPracticeArea x where x.RegistrantEmploymentPracticeAreaSID = @RegistrantEmploymentPracticeAreaSID
