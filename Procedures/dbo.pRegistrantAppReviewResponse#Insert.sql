...
GO
CREATE PROCEDURE [dbo].[pRegistrantAppReviewResponse#Insert]
	 @RegistrantAppReviewResponseSID int               = null output				-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : dbo.pRegistrantAppReviewResponse#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the dbo.RegistrantAppReviewResponse table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.RegistrantAppReviewResponse table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vRegistrantAppReviewResponse entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @RegistrantAppReviewResponseSID = null															-- initialize output parameter
	...
	begin try
		...
		select
			...
			,@RegistrantAppReviewResponseSID = scope_identity()									-- capture key value of new row
