...
GO
CREATE PROCEDURE [sf].[pTask#Delete]
	 @TaskSID                          int               = null -- required! id of row to delete - must be set in custom logic if not passed
	,@UpdateUser                       nvarchar(75)      = null -- set to current application user unless "SystemUser" passed
	,@RowStamp                         timestamp         = null -- row time stamp - pass for preemptive check for overwrites
	,@TaskTitle                        nvarchar(65)      = null
	...
	,@TaskStatusSCD                    varchar(10)       = null
	,@TaskStatusLabel                  nvarchar(35)      = null
	,@TaskStatusSequence               int               = null
	,@IsDerived                        bit               = null
	,@IsClosedStatus                   bit               = null
	,@TaskStatusIsActive               bit               = null
	,@TaskStatusIsDefault              bit               = null
	,@TaskStatusRowGUID                uniqueidentifier  = null
	,@TaskTriggerLabel                 nvarchar(35)      = null
	,@TaskTitleTemplate                nvarchar(65)      = null
	,@QuerySID                         int               = null
	,@TaskTriggerTaskQueueSID          int               = null
	,@TaskTriggerApplicationUserSID    int               = null
	,@TaskTriggerIsAlert               bit               = null
	,@TaskTriggerPriorityLevel         tinyint           = null
	...
	,@TaskTriggerIsActive              bit               = null
	,@TaskTriggerRowGUID               uniqueidentifier  = null
	,@ApplicationPageLabel             nvarchar(35)      = null
	,@ApplicationPageURI               varchar(150)      = null
	,@ApplicationRoute                 varchar(150)      = null
	,@IsSearchPage                     bit               = null
	,@ApplicationEntitySID             int               = null
	,@ApplicationPageRowGUID           uniqueidentifier  = null
	,@PersonSID                        int               = null
	,@CultureSID                       int               = null
	...
	,@IsClosed                         bit               = null
	,@IsTaskTakeOverEnabled            bit               = null
	,@IsCloseEnabled                   bit               = null
	,@IsUpdateEnabled                  bit               = null
	,@IsClosedWithinADay               bit               = null
	,@EntityLabel                      nvarchar(250)     = null
as
/*********************************************************************************************************************************
Procedure : sf.pTask#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.Task table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.Task table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pTask procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.Task x where x.TaskSID = @TaskSID
