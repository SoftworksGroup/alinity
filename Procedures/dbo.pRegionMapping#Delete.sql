...
GO
CREATE PROCEDURE [dbo].[pRegionMapping#Delete]
	 @RegionMappingSID   int               = null -- required! id of row to delete - must be set in custom logic if not passed
	,@UpdateUser         nvarchar(75)      = null -- set to current application user unless "SystemUser" passed
	,@RowStamp           timestamp         = null -- row time stamp - pass for preemptive check for overwrites
	,@PostalCodeMask     varchar(10)       = null
	,@RegionSID          int               = null
...
as
/*********************************************************************************************************************************
Procedure : dbo.pRegionMapping#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.RegionMapping table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.RegionMapping table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pRegionMapping procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.RegionMapping x where x.RegionMappingSID = @RegionMappingSID
