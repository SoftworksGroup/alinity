...
GO
CREATE PROCEDURE [dbo].[pPracticeRegisterChangeRequirement#Insert]
	 @PracticeRegisterChangeRequirementSID int               = null output	-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : dbo.pPracticeRegisterChangeRequirement#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the dbo.PracticeRegisterChangeRequirement table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.PracticeRegisterChangeRequirement table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vPracticeRegisterChangeRequirement entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @PracticeRegisterChangeRequirementSID = null												-- initialize output parameter
	...
	begin try
		...
		set @IsMandatory = isnull(@IsMandatory,CONVERT(bit,(0)))
		...
		--! <PreInsert>
		if @PracticeRegisterChangeSID is not null and isnull(@RequirementSequence, 10) = 10
		begin
			...
			if @RequirementSequence is null begin
		...
		(
			...
			,RequirementSequence
			,UserDefinedColumns
			,PracticeRegisterChangeRequirementXID
			,LegacyKey
			,CreateUser
			,UpdateUser
		)
		...
		select
			...
			,@PracticeRegisterChangeRequirementSID = scope_identity()						-- capture key value of new row
