...
GO
CREATE PROCEDURE [dbo].[pRegistrantAppReview#Delete]
	 @RegistrantAppReviewSID         int               = null -- required! id of row to delete - must be set in custom logic if not passed
	,@UpdateUser                     nvarchar(75)      = null -- set to current application user unless "SystemUser" passed
	,@RowStamp                       timestamp         = null -- row time stamp - pass for preemptive check for overwrites
	,@RegistrantAppSID               int               = null
	...
	,@OrgSID                         int               = null
	,@RegistrantAppLastValidateTime  datetimeoffset(7) = null
	,@NextFollowUp                   date              = null
	,@RegistrationEffective          date              = null
	,@IsAutoApprovalEnabled          bit               = null
	,@RegistrantAppReasonSID         int               = null
	,@InvoiceSID                     int               = null
	,@RegistrantAppRowGUID           uniqueidentifier  = null
	,@FormSID                        int               = null
	...
	,@RegistrantAppReviewStatusSID   int               = null
	,@RegistrantAppReviewStatusSCD   varchar(25)       = null
	,@RegistrantAppReviewStatusLabel nvarchar(35)      = null
...
as
/*********************************************************************************************************************************
Procedure : dbo.pRegistrantAppReview#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.RegistrantAppReview table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.RegistrantAppReview table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pRegistrantAppReview procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.RegistrantAppReview x where x.RegistrantAppReviewSID = @RegistrantAppReviewSID
		...
		update																																-- set audit details on dbo.RegistrantAppReviewResponse rows that will delete through CASCADE
		...
		update																																-- set audit details on dbo.RegistrantAppReviewStatus rows that will delete through CASCADE
