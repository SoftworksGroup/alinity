...
GO
CREATE PROCEDURE [dbo].[pPracticeRegisterSection#Delete]
	 @PracticeRegisterSectionSID          int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@PracticeRegisterSectionDisplayLabel nvarchar(71)      = null
	,@ApplicationFormVersionSID           int               = null
	,@AppVerificationFormVersionSID       int               = null
	,@RenewalFormVersionSID               int               = null
	,@IsApplicationFormDefined            bit               = null
	,@IsAppVerificationFormDefined        bit               = null
	,@IsRenewalFormDefined                bit               = null
as
/*********************************************************************************************************************************
Procedure : dbo.pPracticeRegisterSection#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.PracticeRegisterSection table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.PracticeRegisterSection table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pPracticeRegisterSection procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.PracticeRegisterSection x where x.PracticeRegisterSectionSID = @PracticeRegisterSectionSID
