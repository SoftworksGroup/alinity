...
GO
CREATE PROCEDURE [dbo].[pIdentifierType#EFInsert]
...
as
/*********************************************************************************************************************************
Procedure : dbo.pIdentifierType#EFInsert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : Alternate call syntax for pIdentifierType#Insert for use with MS Entity Framework (does not declare PK output parameter)
-----------------------------------------------------------------------------------------------------------------------------------
...
begin
	...
	begin try
		...
		exec @errorNo = dbo.pIdentifierType#Insert
			 @OrgSID                         = @OrgSID
