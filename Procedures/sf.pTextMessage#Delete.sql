...
GO
CREATE PROCEDURE [sf].[pTextMessage#Delete]
	 @TextMessageSID                   int               = null -- required! id of row to delete - must be set in custom logic if not passed
...
as
/*********************************************************************************************************************************
Procedure : sf.pTextMessage#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.TextMessage table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.TextMessage table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pTextMessage procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.TextMessage x where x.TextMessageSID = @TextMessageSID
		...
		update																																-- set audit details on sf.PersonTextMessage rows that will delete through CASCADE
