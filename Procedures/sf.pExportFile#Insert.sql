...
GO
CREATE PROCEDURE [sf].[pExportFile#Insert]
	 @ExportFileSID       int               = null output										-- identity value assigned to the new record
	,@ExportSourceGUID    uniqueidentifier  = null													-- required! if not passed value must be set in custom logic prior to insert
	...
	,@ExportSpecification xml               = null													-- required! if not passed value must be set in custom logic prior to insert
...
as
/*********************************************************************************************************************************
Procedure : sf.pExportFile#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the sf.ExportFile table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.ExportFile table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vExportFile entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @ExportFileSID = null																								-- initialize output parameter
	...
	begin try
		...
		select
			...
			,@ExportFileSID = scope_identity()																	-- capture key value of new row
