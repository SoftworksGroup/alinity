...
GO
CREATE PROCEDURE [dbo].[pEmploymentSupervisor#Delete]
	 @EmploymentSupervisorSID           int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@RegistrantEmploymentExpiryTime    datetime          = null
	,@Rank                              smallint          = null
	...
	,@SupervisorRegistrantLabel         nvarchar(75)      = null
	,@IsAgreementValid                  bit               = null
	,@AgreementStatusLabel              nvarchar(30)      = null
	,@SupervisorRegistrantSID           int               = null
	,@SupervisorRegistrantEmploymentSID int               = null
as
/*********************************************************************************************************************************
Procedure : dbo.pEmploymentSupervisor#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.EmploymentSupervisor table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.EmploymentSupervisor table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pEmploymentSupervisor procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.EmploymentSupervisor x where x.EmploymentSupervisorSID = @EmploymentSupervisorSID
