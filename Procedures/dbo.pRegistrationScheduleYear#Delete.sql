...
GO
CREATE PROCEDURE [dbo].[pRegistrationScheduleYear#Delete]
	 @RegistrationScheduleYearSID                int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@RenewalVerificationOpenTimeComponent       time(7)           = null
	,@RenewalGeneralOpenTimeComponent            time(7)           = null
	,@ReinstatementVerificationOpenTimeComponent time(7)           = null
	,@ReinstatementGeneralOpenTimeComponent      time(7)           = null
	,@YearStartTimeComponent                     time(7)           = null
	,@YearEndTimeComponent                       time(7)           = null
	,@RenewalLateFeeStartTimeComponent           time(7)           = null
	,@RenewalEndTimeComponent                    time(7)           = null
	,@ReinstatementEndTimeComponent              time(7)           = null
	,@PAPBlockStartTimeComponent                 time(7)           = null
	,@PAPBlockEndTimeComponent                   time(7)           = null
	,@IsEditEnabled                              bit               = null
as
/*********************************************************************************************************************************
Procedure : dbo.pRegistrationScheduleYear#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.RegistrationScheduleYear table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.RegistrationScheduleYear table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pRegistrationScheduleYear procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.RegistrationScheduleYear x where x.RegistrationScheduleYearSID = @RegistrationScheduleYearSID
