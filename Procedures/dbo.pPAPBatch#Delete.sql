...
GO
CREATE PROCEDURE [dbo].[pPAPBatch#Delete]
	 @PAPBatchSID           int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@TotalWithdrawalAmount decimal(38,2)     = null
	,@TotalPaid             decimal(38,2)     = null
	,@TotalUnapplied        decimal(38,2)     = null
as
/*********************************************************************************************************************************
Procedure : dbo.pPAPBatch#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.PAPBatch table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.PAPBatch table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pPAPBatch procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.PAPBatch x where x.PAPBatchSID = @PAPBatchSID
