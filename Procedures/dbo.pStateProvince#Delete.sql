...
GO
CREATE PROCEDURE [dbo].[pStateProvince#Delete]
	 @StateProvinceSID        int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@StateProvinceSearch     nvarchar(81)      = null
as
/*********************************************************************************************************************************
Procedure : dbo.pStateProvince#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.StateProvince table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.StateProvince table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pStateProvince procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.StateProvince x where x.StateProvinceSID = @StateProvinceSID
    ...
    -- Tim Edlund | Feb 2013
		...
		if exists (select 1 from dbo.StateProvince x where x.StateProvinceSID = @StateProvinceSID and x.IsDefault = cast(1 as bit))
		begin
