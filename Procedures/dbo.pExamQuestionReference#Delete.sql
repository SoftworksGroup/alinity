...
GO
CREATE PROCEDURE [dbo].[pExamQuestionReference#Delete]
	 @ExamQuestionReferenceSID int               = null -- required! id of row to delete - must be set in custom logic if not passed
...
as
/*********************************************************************************************************************************
Procedure : dbo.pExamQuestionReference#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.ExamQuestionReference table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.ExamQuestionReference table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pExamQuestionReference procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.ExamQuestionReference x where x.ExamQuestionReferenceSID = @ExamQuestionReferenceSID
