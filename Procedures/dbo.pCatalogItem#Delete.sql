...
GO
CREATE PROCEDURE [dbo].[pCatalogItem#Delete]
	 @CatalogItemSID            int               = null -- required! id of row to delete - must be set in custom logic if not passed
...
as
/*********************************************************************************************************************************
Procedure : dbo.pCatalogItem#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.CatalogItem table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.CatalogItem table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pCatalogItem procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.CatalogItem x where x.CatalogItemSID = @CatalogItemSID
		...
		update																																-- set audit details on dbo.CatalogItemPrice rows that will delete through CASCADE
