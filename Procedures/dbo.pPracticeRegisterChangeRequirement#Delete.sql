...
GO
CREATE PROCEDURE [dbo].[pPracticeRegisterChangeRequirement#Delete]
	 @PracticeRegisterChangeRequirementSID int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@PracticeRegisterChangeLabel          nvarchar(110)     = null
as
/*********************************************************************************************************************************
Procedure : dbo.pPracticeRegisterChangeRequirement#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.PracticeRegisterChangeRequirement table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.PracticeRegisterChangeRequirement table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pPracticeRegisterChangeRequirement procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.PracticeRegisterChangeRequirement x where x.PracticeRegisterChangeRequirementSID = @PracticeRegisterChangeRequirementSID
