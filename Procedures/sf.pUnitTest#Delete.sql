...
GO
CREATE PROCEDURE [sf].[pUnitTest#Delete]
	 @UnitTestSID        int               = null -- required! id of row to delete - must be set in custom logic if not passed
...
as
/*********************************************************************************************************************************
Procedure : sf.pUnitTest#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.UnitTest table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.UnitTest table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pUnitTest procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.UnitTest x where x.UnitTestSID = @UnitTestSID
		...
		update																																-- set audit details on sf.UnitTestAssertion rows that will delete through CASCADE
