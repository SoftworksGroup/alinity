...
GO
CREATE PROCEDURE [dbo].[pReinstatementResponse#Insert]
	 @ReinstatementResponseSID   int               = null output						-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : dbo.pReinstatementResponse#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the dbo.ReinstatementResponse table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.ReinstatementResponse table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vReinstatementResponse entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @ReinstatementResponseSID = null																		-- initialize output parameter
	...
	begin try
		...
		select
			...
			,@ReinstatementResponseSID = scope_identity()												-- capture key value of new row
