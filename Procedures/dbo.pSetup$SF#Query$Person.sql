...
GO
CREATE PROCEDURE dbo.[pSetup$SF#Query$Person]
	@SetupUser nvarchar(75) -- user assigned to audit columns
as
/*********************************************************************************************************************************
Sproc    : Setup Query for Person management
Notice   : Copyright © 2018 Softworks Group Inc.
Summary  : Synchronizes the sf.Query table for product queries used in management of Person records
----------------------------------------------------------------------------------------------------------------------------------
...
Comments  
--------
This procedure sets up product queries used to manage Person records.  The data is setup in the sf.Query table. Product queries
...
exec dbo.pSetup$SF#Query$Person
...
exec sf.pUnitTest#Execute
	 @ObjectName = 'dbo.pSetup$SF#Query$Person'
	,@DefaultTestOnly = 1
------------------------------------------------------------------------------------------------------------------------------- */
...
begin
	...
	begin try
		...
		select
		 ...
		 ,@dataQualityCategorySID				 = (case when qc.QueryCategoryCode = 'S!DATA.QUALITY' then qc.QueryCategorySID else @dataQualityCategorySID end)
		...
		values
		(
			@defaultCategorySID, 'S!PERSON.ALL', @parametersDoc, 'All', @OFF, N'Returns all registrations for the selected year'
		);
		...
		values
		(
			@defaultCategorySID, 'S!PERSON.ALL.ACTIVE', @parametersDoc, 'All active', @OFF, N'Returns all active-practice registrations for the selected year'
		);
		...
		values
		(
			@defaultCategorySID, 'S!PERSON.ALL.RENEWING', @parametersDoc, 'All renewing', @OFF
		...
		values
		(
			@defaultCategorySID, 'S!PERSON.ALL.TERM.BASED', @parametersDoc, 'All term-based', @OFF
		...
		values
		(
			@defaultCategorySID, 'S!PERSON.OPEN.FORMS', @parametersDoc, 'Open forms', @OFF, N'Returns open forms created in the selected year'
		);
		...
		values
		(
			@defaultCategorySID, 'S!PERSON.BY.STATUS', @parametersDoc, 'By status', @OFF, N'Returns records matching the selected status'
		);
		...
		values
		(
			@defaultCategorySID, 'S!PERSON.BY.REGISTER', @parametersDoc, 'By register', @OFF, N'Returns records matching the selected practice register'
		);
		...
		values
		(
			@defaultCategorySID, 'S!PERSON.FOLLOWUP', @parametersDoc, 'Follow-up due', @OFF
		...
		values
		(
			@defaultCategorySID, 'S!PERSON.ABANDONED', @parametersDoc, 'Abandoned', @OFF
		...
		values
		(
			@defaultCategorySID, 'S!PERSON.APPROVED', @parametersDoc, 'Approved', @OFF, N'Returns forms approved in a date range'
		);
		...
		values
		(
			@defaultCategorySID, 'S!PERSON.CARD.NOT.PRINTED', @parametersDoc, 'Card not printed', @OFF
		...
		values
		(
			@defaultCategorySID, 'S!PERSON.CARD.PRINTED', @parametersDoc, 'Card printed', @OFF
		...
		values
		(
			@defaultCategorySID, 'S!PERSON.EXPIRED', @parametersDoc, 'Expired license', @OFF
		...
		values
		(
			@defaultCategorySID, 'S!PERSON.FIND.BY.PHONE', @parametersDoc, 'Find by phone', @OFF
		...
		values
		(
			@defaultCategorySID, 'S!PERSON.FIND.BY.ADDRESS', @parametersDoc, 'Find by address', @OFF
		...
		values
		(
			@defaultCategorySID, 'S!PERSON.FIND.BY.LOCATION', @parametersDoc, 'Find by location', @OFF
		...
		values
		(
			@defaultCategorySID, 'S!PERSON.RECENTLY.UPDATED', @parametersDoc, 'Recently updated', @OFF
		...
		values
		(
			@renewalCategorySID, 'S!PERSON.RENEWAL.RVW.REQUIRED', @parametersDoc, 'Review required (renewal)', @OFF
		...
		values
		(
			@renewalCategorySID, 'S!PERSON.RENEWAL.NOT.STARTED', @parametersDoc, 'Not started', @OFF, N'Returns registrations where a renewal has not been started'
		);
		...
		values
		(
			@renewalCategorySID, 'S!PERSON.RENEWAL.IN.PROGRESS', @parametersDoc, 'In progress (renewal)', @OFF
		...
		values
		(
			@renewalCategorySID, 'S!PERSON.RENEWAL.NOT.PAID', @parametersDoc, 'Approved not paid (renewal)', @OFF
		 ,N'Returns renewal records that are approved but not paid'
		);

		----- Renewal paid via PAP with credit remaining  ------
		...
		values
		(
			@renewalCategorySID, 'S!PERSON.RENEWAL.PAP.UNAPPLIED', @parametersDoc, 'Paid with PAP (credit remaining)', @OFF
		...
		values
		(
			@renewalCategorySID, 'S!PERSON.NOT.RENEWED', @parametersDoc, 'Not renewed', @OFF, N'Returns renewal forms which are not complete'
		);
		...
		values
		(
			@renewalCategorySID, 'S!PERSON.RENEWAL.DONE', @parametersDoc, 'Complete (renewal)', @OFF, N'Returns renewals that are complete'
		);
		...
		values
		(
			@renewalCategorySID, 'S!PERSON.RENEWAL.REGCHANGE', @parametersDoc, 'Register change (renewal)', @OFF
		...
		values
		(
			@renewalCategorySID, 'S!PERSON.RENEWAL.BY.STATUS', @parametersDoc, 'By status (renewal)', @OFF, N'Returns renewals matching the selected status'
		);
		...
		values
		(
			@renewalCategorySID, 'S!PERSON.RENEWAL.ABANDONED', @parametersDoc, 'Abandoned (renewal)', @OFF
		...
		values
		(
			@renewalCategorySID, 'S!PERSON.RENEWAL.PAIDNOREG', @parametersDoc, 'Paid not renewed', @OFF
		...
		values
		(
			@renewalCategorySID, 'S!PERSON.RENEWAL.DIDNOT', @parametersDoc, 'Did not renew (reg changed)', @OFF
		...
		values
		(
			@applicationCategorySID, 'S!PERSON.APPLICATION.RVW.REQUIRED', @parametersDoc, 'Review required (application)', @OFF
		 ,N'Returns records matching the selected review (blocking) reason'
		);
		...
		values
		(
			@applicationCategorySID, 'S!PERSON.APPLICATION.IN.PROGRESS', @parametersDoc, 'In progress (application)', @OFF
		...
		values
		(
			@applicationCategorySID, 'S!PERSON.APPLICATION.NOT.PAID', @parametersDoc, 'Approved not paid (application)', @OFF
		...
		values
		(
			@applicationCategorySID, 'S!PERSON.APPLICATION.DONE', @parametersDoc, 'Complete (application)', @OFF, N'Returns forms that are completed in a date range'
		);
		...
		values
		(
			@applicationCategorySID, 'S!PERSON.APPLICATION.BY.STATUS', @parametersDoc, 'By status (application)', @OFF
		...
		values
		(
			@applicationCategorySID, 'S!PERSON.APPLICATION.ABANDONED', @parametersDoc, 'Abandoned (application)', @OFF
		...
		values
		(
			@applicationCategorySID, 'S!PERSON.APPLICATION.PAIDNOREG', @parametersDoc, 'Paid not registered', @OFF
		...
		exec sf.pQuery#CheckCodes
		 ...
		 ,@SchemaAndRoutineName = 'dbo.pQuery#Execute$Person'
