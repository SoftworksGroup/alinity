...
GO
CREATE PROCEDURE [sf].[pApplicationUserProfileProperty#Insert]
	 @ApplicationUserProfilePropertySID int               = null output			-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : sf.pApplicationUserProfileProperty#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the sf.ApplicationUserProfileProperty table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.ApplicationUserProfileProperty table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vApplicationUserProfileProperty entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @ApplicationUserProfilePropertySID = null														-- initialize output parameter
	...
	begin try
		...
		select
			...
			,@ApplicationUserProfilePropertySID = scope_identity()							-- capture key value of new row
