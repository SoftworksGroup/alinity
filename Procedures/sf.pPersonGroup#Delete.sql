...
GO
CREATE PROCEDURE [sf].[pPersonGroup#Delete]
	 @PersonGroupSID                   int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@ApplicationUserLastReviewTime    datetimeoffset(7) = null
	,@ApplicationUserLastReviewUser    nvarchar(75)      = null
	...
	,@IsSmartGroup                     bit               = null
	,@NextReviewDueDate                smalldatetime     = null
	,@TotalActive                      int               = null
	,@TotalPending                     int               = null
	,@TotalRequiringReplacement        int               = null
	,@IsNextReviewOverdue              bit               = null
as
/*********************************************************************************************************************************
Procedure : sf.pPersonGroup#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.PersonGroup table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.PersonGroup table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pPersonGroup procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.PersonGroup x where x.PersonGroupSID = @PersonGroupSID
		...
		update																																-- set audit details on sf.PersonGroupMember rows that will delete through CASCADE
