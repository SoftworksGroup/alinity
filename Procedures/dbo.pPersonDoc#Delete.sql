...
GO
CREATE PROCEDURE [dbo].[pPersonDoc#Delete]
	 @PersonDocSID              int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@IsDocReplaced             bit               = null
	,@IsReadGranted             bit               = null
	,@IsReportPending           bit               = null
	,@IsReportCancelled         bit               = null
	,@ApplicationEntitySID      int               = null
	,@EntitySID                 int               = null
	,@IsPrimary                 bit               = null
as
/*********************************************************************************************************************************
Procedure : dbo.pPersonDoc#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.PersonDoc table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.PersonDoc table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pPersonDoc procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.PersonDoc x where x.PersonDocSID = @PersonDocSID
