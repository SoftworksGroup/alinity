...
GO
CREATE PROCEDURE [sf].[pCulture#Delete]
	 @CultureSID         int               = null -- required! id of row to delete - must be set in custom logic if not passed
...
as
/*********************************************************************************************************************************
Procedure : sf.pCulture#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.Culture table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.Culture table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pCulture procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.Culture x where x.CultureSID = @CultureSID
