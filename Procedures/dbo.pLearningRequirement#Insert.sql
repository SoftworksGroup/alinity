...
GO
CREATE PROCEDURE [dbo].[pLearningRequirement#Insert]
	 @LearningRequirementSID          int               = null output				-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : dbo.pLearningRequirement#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the dbo.LearningRequirement table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.LearningRequirement table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vLearningRequirement entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @LearningRequirementSID = null																			-- initialize output parameter
	...
	begin try
		...
		set @StartingRegistrationYear = isnull(@StartingRegistrationYear,sf.fTodayYear())
		set @Minimum = isnull(@Minimum,(1.0))
		set @Maximum = isnull(@Maximum,(999.9))
		set @MaximumCarryOver = isnull(@MaximumCarryOver,(999.9))
		...
		(
			...
			,StartingRegistrationYear
			,Minimum
			,Maximum
			,MaximumCarryOver
			,UserDefinedColumns
			,LearningRequirementXID
			,LegacyKey
			,CreateUser
			,UpdateUser
		)
		...
		select
			...
			,@LearningRequirementSID = scope_identity()													-- capture key value of new row
