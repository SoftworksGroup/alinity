...
GO
CREATE PROCEDURE [sf].[pApplicationEntity#Insert]
	 @ApplicationEntitySID           int               = null output				-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : sf.pApplicationEntity#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the sf.ApplicationEntity table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.ApplicationEntity table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vApplicationEntity entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @ApplicationEntitySID = null																				-- initialize output parameter
	...
	begin try
		...
		set @IsMergeDataSource = isnull(@IsMergeDataSource,(0))
		...
		select
			...
			,@ApplicationEntitySID = scope_identity()														-- capture key value of new row
