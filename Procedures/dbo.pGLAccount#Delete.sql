...
GO
CREATE PROCEDURE [dbo].[pGLAccount#Delete]
	 @GLAccountSID              int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@FullAccountLabel          nvarchar(86)      = null
	,@FullDeferredAccountLabel  nvarchar(91)      = null
as
/*********************************************************************************************************************************
Procedure : dbo.pGLAccount#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.GLAccount table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.GLAccount table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pGLAccount procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.GLAccount x where x.GLAccountSID = @GLAccountSID
