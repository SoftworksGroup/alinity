...
GO
CREATE PROCEDURE [sf].[pConfigParam#Delete]
	 @ConfigParamSID     int               = null -- required! id of row to delete - must be set in custom logic if not passed
	,@UpdateUser         nvarchar(75)      = null -- set to current application user unless "SystemUser" passed
	,@RowStamp           timestamp         = null -- row time stamp - pass for preemptive check for overwrites
	,@ConfigParamSCD     varchar(25)       = null
	...
	,@ActiveParamValue   nvarchar(max)     = null
	,@IsUpdateEnabled    bit               = null
as
/*********************************************************************************************************************************
Procedure : sf.pConfigParam#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.ConfigParam table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.ConfigParam table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pConfigParam procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.ConfigParam x where x.ConfigParamSID = @ConfigParamSID
    ...
    -- the deletion option based on the value returned from the IsDeleteEnabled function
		-- in the #Ext view.
    set @IsDeleteEnabled = sf.fConfigParam#IsDeleteEnabled(@ConfigParamSID)
