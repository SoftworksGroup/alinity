...
GO
CREATE PROCEDURE [dbo].[pCity#Delete]
	 @CitySID                            int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@CitySearch                         nvarchar(112)     = null
as
/*********************************************************************************************************************************
Procedure : dbo.pCity#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.City table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.City table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pCity procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.City x where x.CitySID = @CitySID
