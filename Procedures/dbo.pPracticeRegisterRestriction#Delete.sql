...
GO
CREATE PROCEDURE [dbo].[pPracticeRegisterRestriction#Delete]
	 @PracticeRegisterRestrictionSID              int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@PracticeRegisterIsSupervisionRequired       bit               = null
	...
	,@PracticeRestrictionIsDisplayedOnLicense     bit               = null
	,@PracticeRestrictionIsActive                 bit               = null
	,@PracticeRestrictionIsSupervisionRequired    bit               = null
	,@PracticeRestrictionRowGUID                  uniqueidentifier  = null
	...
	,@PracticeRegisterSectionIsDisplayedOnLicense bit               = null
...
as
/*********************************************************************************************************************************
Procedure : dbo.pPracticeRegisterRestriction#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.PracticeRegisterRestriction table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.PracticeRegisterRestriction table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pPracticeRegisterRestriction procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.PracticeRegisterRestriction x where x.PracticeRegisterRestrictionSID = @PracticeRegisterRestrictionSID
