...
GO
CREATE PROCEDURE [sf].[pLicense#Delete]
	 @LicenseSID         int               = null -- required! id of row to delete - must be set in custom logic if not passed
...
as
/*********************************************************************************************************************************
Procedure : sf.pLicense#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.License table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.License table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pLicense procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.License x where x.LicenseSID = @LicenseSID
    ...
    -- the deletion option based on the value returned from the IsDeleteEnabled function
		-- in the #Ext view.
    set @IsDeleteEnabled = sf.fLicense#IsDeleteEnabled(@LicenseSID)
    ...
    begin
      ...
      exec sf.pMessage#Get
        ...
        ,@MessageText   = @errorText output
        ,@DefaultText   = N'Deletion of this %1 record is not allowed on license information.'
        ,@Arg1          = N'license'
