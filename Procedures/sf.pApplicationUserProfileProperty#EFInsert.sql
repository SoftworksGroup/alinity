...
GO
CREATE PROCEDURE [sf].[pApplicationUserProfileProperty#EFInsert]
...
as
/*********************************************************************************************************************************
Procedure : sf.pApplicationUserProfileProperty#EFInsert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : Alternate call syntax for pApplicationUserProfileProperty#Insert for use with MS Entity Framework (does not declare PK output parameter)
-----------------------------------------------------------------------------------------------------------------------------------
...
begin
	...
	begin try
		...
		exec @errorNo = sf.pApplicationUserProfileProperty#Insert
