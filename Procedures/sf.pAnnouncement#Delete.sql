...
GO
CREATE PROCEDURE [sf].[pAnnouncement#Delete]
	 @AnnouncementSID       int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@IsClearedOrExpired    bit               = null
	,@IsNew                 bit               = null
	,@ApplicationGrantSCD   varchar(30)       = null
as
/*********************************************************************************************************************************
Procedure : sf.pAnnouncement#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.Announcement table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.Announcement table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pAnnouncement procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.Announcement x where x.AnnouncementSID = @AnnouncementSID
		...
		update																																-- set audit details on sf.AnnouncementApplicationGrant rows that will delete through CASCADE
