...
GO
CREATE PROCEDURE [dbo].[pRegistrantAuditReviewStatus#Insert]
	 @RegistrantAuditReviewStatusSID int               = null output				-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : dbo.pRegistrantAuditReviewStatus#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the dbo.RegistrantAuditReviewStatus table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.RegistrantAuditReviewStatus table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vRegistrantAuditReviewStatus entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @RegistrantAuditReviewStatusSID = null															-- initialize output parameter
	...
	begin try
		...
		select
			...
			,@RegistrantAuditReviewStatusSID = scope_identity()									-- capture key value of new row
