...
GO
CREATE PROCEDURE [sf].[pRecordAudit#EFInsert]
...
as
/*********************************************************************************************************************************
Procedure : sf.pRecordAudit#EFInsert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : Alternate call syntax for pRecordAudit#Insert for use with MS Entity Framework (does not declare PK output parameter)
-----------------------------------------------------------------------------------------------------------------------------------
...
begin
	...
	begin try
		...
		exec @errorNo = sf.pRecordAudit#Insert
