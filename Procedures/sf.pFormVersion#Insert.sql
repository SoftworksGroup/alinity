...
GO
CREATE PROCEDURE [sf].[pFormVersion#Insert]
	 @FormVersionSID     int               = null output										-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : sf.pFormVersion#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the sf.FormVersion table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.FormVersion table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vFormVersion entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @FormVersionSID = null																							-- initialize output parameter
	...
	begin try
		...
		set @VersionNo = isnull(@VersionNo,(0))
		set @RevisionNo = isnull(@RevisionNo,(1001))
		set @IsSaveDisplayed = isnull(@IsSaveDisplayed,CONVERT(bit,(1)))
		...
		select
			...
			,@FormVersionSID = scope_identity()																	-- capture key value of new row
