...
GO
CREATE PROCEDURE [dbo].[pPersonGroupFolder#Insert]
	 @PersonGroupFolderSID       int               = null output						-- identity value assigned to the new record
	...
	,@FolderName                 nvarchar(35)      = null										-- required! if not passed value must be set in custom logic prior to insert
...
as
/*********************************************************************************************************************************
Procedure : dbo.pPersonGroupFolder#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the dbo.PersonGroupFolder table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.PersonGroupFolder table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vPersonGroupFolder entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @PersonGroupFolderSID = null																				-- initialize output parameter
	...
	begin try
		...
		(
			 ParentPersonGroupFolderSID
			,PersonGroupSID
			,FolderName
			,IsRoot
			,UserDefinedColumns
			,PersonGroupFolderXID
			,LegacyKey
			,CreateUser
			,UpdateUser
		)
		...
		select
			...
			,@PersonGroupFolderSID = scope_identity()														-- capture key value of new row
