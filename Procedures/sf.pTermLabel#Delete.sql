...
GO
CREATE PROCEDURE [sf].[pTermLabel#Delete]
	 @TermLabelSID           int               = null -- required! id of row to delete - must be set in custom logic if not passed
	,@UpdateUser             nvarchar(75)      = null -- set to current application user unless "SystemUser" passed
	,@RowStamp               timestamp         = null -- row time stamp - pass for preemptive check for overwrites
	,@TermLabelSCD           varchar(35)       = null
...
as
/*********************************************************************************************************************************
Procedure : sf.pTermLabel#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.TermLabel table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.TermLabel table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pTermLabel procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.TermLabel x where x.TermLabelSID = @TermLabelSID
    ...
    -- the deletion option based on the value returned from the IsDeleteEnabled function
		-- in the #Ext view.
    set @IsDeleteEnabled = sf.fTermLabel#IsDeleteEnabled(@TermLabelSID)

    if isnull(@IsDeleteEnabled, cast(0 as bit)) = cast(0 as bit)
 begin      exec sf.pMessage#Get
