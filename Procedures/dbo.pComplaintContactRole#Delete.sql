...
GO
CREATE PROCEDURE [dbo].[pComplaintContactRole#Delete]
	 @ComplaintContactRoleSID  int               = null -- required! id of row to delete - must be set in custom logic if not passed
...
as
/*********************************************************************************************************************************
Procedure : dbo.pComplaintContactRole#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.ComplaintContactRole table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.ComplaintContactRole table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pComplaintContactRole procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.ComplaintContactRole x where x.ComplaintContactRoleSID = @ComplaintContactRoleSID
