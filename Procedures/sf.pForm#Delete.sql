...
GO
CREATE PROCEDURE [sf].[pForm#Delete]
	 @FormSID                          int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@FormTypeSCD                      varchar(25)       = null
	,@FormTypeLabel                    nvarchar(35)      = null
	,@FormOwnerSID                     int               = null
	,@FormTypeIsDefault                bit               = null
	,@FormTypeRowGUID                  uniqueidentifier  = null
	,@IsDeleteEnabled                  bit               = null
	,@zContext                         xml               = null -- other values defining context for the delete (if any)
	,@LatestVersionNo                  smallint          = null
	,@LatestRevisionNo                 smallint          = null
	,@LatestVersionFormVersionSID      int               = null
	,@LatestRevisionFormVersionSID     int               = null
as
/*********************************************************************************************************************************
Procedure : sf.pForm#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.Form table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.Form table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pForm procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.Form x where x.FormSID = @FormSID
		...
		update																																-- set audit details on sf.FormVersion rows that will delete through CASCADE
			sf.FormVersion
		set
