...
GO
CREATE PROCEDURE dbo.pRegistrant#GetRegistrationForYear
 ...
 ,@RegistrationYear smallint		-- the registration year to return registration for
as
/*********************************************************************************************************************************
Sproc    : Registrant - Get Registration ForYear
Notice   : Copyright © 2017 Softworks Group Inc.
Summary  : Returns last registration record for a given registrant and registration year
----------------------------------------------------------------------------------------------------------------------------------
...
Comments	
--------
This procedure is a wrapper for the dbo.fRegistrant#RegistrationForYear table function. See the function documentation for
details.
...
select top (1)
 ...
 ,@RegistrationYear = rl.RegistrationYear
from
	dbo.Registration rl
order by
	newid();
...
begin
	...
	exec dbo.pRegistrant#GetRegistrationForYear
...
exec sf.pUnitTest#Execute
	 @ObjectName = 'dbo.pRegistrant#GetRegistrationForYear'
	,@DefaultTestOnly = 1
------------------------------------------------------------------------------------------------------------------------------- */
...
begin
	...
	begin try
		...
		select
			--!<ColumnList DataSource="fRegistrant#RegistrationForYear" Alias="r">
			 r.RegistrantSID
			,r.RegistrantNo
			,r.RegistrationSID
			,r.RegistrationNo
		...
		--!</ColumnList>
		from
			dbo.fRegistrant#RegistrationForYear(@RegistrantSID, @RegistrationYear) r;
