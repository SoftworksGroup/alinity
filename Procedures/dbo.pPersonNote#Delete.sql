...
GO
CREATE PROCEDURE [dbo].[pPersonNote#Delete]
	 @PersonNoteSID             int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@PersonNoteTypeLabel       nvarchar(35)      = null
	,@PersonNoteTypeCategory    nvarchar(65)      = null
	,@PersonNoteTypeIsDefault   bit               = null
	,@PersonNoteTypeIsActive    bit               = null
	,@PersonNoteTypeRowGUID     uniqueidentifier  = null
	,@GenderSID                 int               = null
	...
	,@NoteDisplayTitle          nvarchar(65)      = null
as
/*********************************************************************************************************************************
Procedure : dbo.pPersonNote#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.PersonNote table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.PersonNote table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pPersonNote procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.PersonNote x where x.PersonNoteSID = @PersonNoteSID
