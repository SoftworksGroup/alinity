...
GO
CREATE PROCEDURE [sf].[pDefaultEmailTemplate#Delete]
	 @DefaultEmailTemplateSID   int               = null -- required! id of row to delete - must be set in custom logic if not passed
	,@UpdateUser                nvarchar(75)      = null -- set to current application user unless "SystemUser" passed
	,@RowStamp                  timestamp         = null -- row time stamp - pass for preemptive check for overwrites
	,@DefaultEmailTemplateSCD   varchar(10)       = null
...
as
/*********************************************************************************************************************************
Procedure : sf.pDefaultEmailTemplate#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the sf.DefaultEmailTemplate table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.DefaultEmailTemplate table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pDefaultEmailTemplate procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from sf.DefaultEmailTemplate x where x.DefaultEmailTemplateSID = @DefaultEmailTemplateSID
