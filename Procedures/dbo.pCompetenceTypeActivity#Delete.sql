...
GO
CREATE PROCEDURE [dbo].[pCompetenceTypeActivity#Delete]
	 @CompetenceTypeActivitySID  int               = null -- required! id of row to delete - must be set in custom logic if not passed
	...
	,@CompetenceActivityLabel    nvarchar(35)      = null
	,@CompetenceActivityName     nvarchar(65)      = null
	,@UnitValue                  decimal(5,2)      = null
	,@CompetenceActivityIsActive bit               = null
	,@CompetenceActivityRowGUID  uniqueidentifier  = null
	,@CompetenceTypeLabel        nvarchar(35)      = null
	,@CompetenceTypeCategory     nvarchar(65)      = null
	,@CompetenceTypeIsDefault    bit               = null
	,@CompetenceTypeIsActive     bit               = null
	,@CompetenceTypeRowGUID      uniqueidentifier  = null
	,@IsActive                   bit               = null
	,@IsPending                  bit               = null
...
as
/*********************************************************************************************************************************
Procedure : dbo.pCompetenceTypeActivity#Delete
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : deletes 1 row in the dbo.CompetenceTypeActivity table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.CompetenceTypeActivity table. The procedure requires a primary key value to locate the record
to delete.
...
and in the ext.pCompetenceTypeActivity procedure for client-specific deletion rules.
...
begin
	...
	begin try
		...
		if @RowStamp is null select @RowStamp = x.RowStamp from dbo.CompetenceTypeActivity x where x.CompetenceTypeActivitySID = @CompetenceTypeActivitySID
