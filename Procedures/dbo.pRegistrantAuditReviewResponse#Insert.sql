...
GO
CREATE PROCEDURE [dbo].[pRegistrantAuditReviewResponse#Insert]
	 @RegistrantAuditReviewResponseSID int               = null output			-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : dbo.pRegistrantAuditReviewResponse#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the dbo.RegistrantAuditReviewResponse table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the dbo.RegistrantAuditReviewResponse table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vRegistrantAuditReviewResponse entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @RegistrantAuditReviewResponseSID = null														-- initialize output parameter
	...
	begin try
		...
		select
			...
			,@RegistrantAuditReviewResponseSID = scope_identity()								-- capture key value of new row
