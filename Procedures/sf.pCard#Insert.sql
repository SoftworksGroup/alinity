...
GO
CREATE PROCEDURE [sf].[pCard#Insert]
	 @CardSID               int               = null output									-- identity value assigned to the new record
...
as
/*********************************************************************************************************************************
Procedure : sf.pCard#Insert
Notice    : Copyright © 2019 Softworks Group Inc.
Summary   : inserts 1 row into the sf.Card table
-----------------------------------------------------------------------------------------------------------------------------------
...
Comments
--------
This procedure is used in maintenance of the sf.Card table with parameter values represent columns of the table. Additional
parameters are provided for all columns in the vCard entity view, however, the base logic of the procedure inserts the
...
begin
	...
	set @CardSID = null																											-- initialize output parameter
	...
	begin try
		...
		set @CardContext = isnull(@CardContext,'DEFAULT')
		set @CSSDefinition = isnull(@CSSDefinition,'col-xs-12 col-sm-6 col-md-6 col-lg-4')
		...
		select
			...
			,@CardSID = scope_identity()																				-- capture key value of new row
