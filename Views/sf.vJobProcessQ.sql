...
GO
CREATE VIEW [sf].[vJobProcessQ]
as
/*********************************************************************************************************************************
View    : Job Process Q
Notice  : Copyright © 2014 Softworks Group Inc.
Summary	: Returns information about the sf.JobProcessQ service broker queue
----------------------------------------------------------------------------------------------------------------------------------
...
Comments	
--------
This view returns information about the SQL Service Broker Queue "sf.JobProcessQ". The view reports status of messages including
