...
GO
CREATE VIEW dbo.vRegistrant#EmployerDirectoryEntry
/*********************************************************************************************************************************
View			: Registrant - Employer Directory Entry
Notice		: Copyright © 2018 Softworks Group Inc.
Summary		: Returns a list of registrant records for viewing by employers (not the public) on the client portal registry
...
Comments	
--------
This view returns a list of registrant records for viewing by employers (not the public) on the client portal registry. The employer
...
IsOnPublicRegistry and IsOnemployerRegistry are required in any ext view.

Separate product versions of the view are create for "Public" and "Member" directories.

This view excludes employment information where the employer is NOT in active-practice.
	...
	<Test Name="One" Description="returns 1 record at random from the view">
		<SQLScript>
			...
			select
			  x.*
			from
				dbo.vRegistrant#EmployerDirectoryEntry x
			where
				x.RowGUID = @RowGUID
...
exec sf.pUnitTest#Execute
  @ObjectName = 'dbo.vRegistrant#EmployerDirectoryEntry'
 ,@DefaultTestOnly = 1
 ...
 -- specific examples to review in the UI
	...
	from
		dbo.vRegistrant#EmployerDirectoryEntry rde
	--where
